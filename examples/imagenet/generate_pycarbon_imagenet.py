...
pycarbon dataset (Carbon format).
...
def imagenet_directory_to_pycarbon_dataset(imagenet_path, output_url, spark_master=None, carbon_files_count=100,
                                           noun_id_to_text=None):
  """Converts a directory with imagenet data into a pycarbon dataset.
