...
def train_and_test(dataset_url, training_iterations, batch_size, evaluation_interval):
    ...
    :return:
    """
    with make_carbon_reader(os.path.join(dataset_url, 'train'), num_epochs=None) as train_reader:
        with make_carbon_reader(os.path.join(dataset_url, 'test'), num_epochs=None) as test_reader:
