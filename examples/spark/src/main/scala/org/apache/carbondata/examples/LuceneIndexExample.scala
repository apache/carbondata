...
object LuceneIndexExample {
  ...
  def exampleBody(spark : SparkSession): Unit = {
    ...
    // scalastyle:off
    println("time for query on table with lucene index table:" + time_with_lucenedatamap.toString)
    println("time for query on table without lucene index table:" + time_without_lucenedatamap.toString)
    // scalastyle:on
