...
public class MolapAggregateSurrogateGeneratorMeta extends BaseStepMeta
    ...
    public void initialize() {
        factMeasure = factMeasureString.split(MolapCommonConstants.AMPERSAND_SPC_CHARACTER);
        factLevels = factLevelsString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        aggregateLevels = aggregateLevelsString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        aggregateMeasures = aggregateMeasuresString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        aggregateMeasuresColumnName =
                aggregateMeasuresColumnNameString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        String[] aggDimeLensStringArray =
                aggDimeLensString.split(MolapCommonConstants.COMA_SPC_CHARACTER);
        ...
        aggregators = aggregatorString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        String[] dimLensStringArray =
                factDimLensString.split(MolapCommonConstants.COMA_SPC_CHARACTER);
    ...
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
        ...
        return new MolapAggregateSurrogateGeneratorStep(stepMeta, stepDataInterface, copyNr,
                transMeta, trans);
    }
