...
public class ConsumerThread implements Callable<Void> {
   ...
   * @param counter
   */
  public ConsumerThread(List<Container> producerContainer, int readBufferSize, Container container,
      int counter, int mdKeyIndex) {
  ...
  private void createRecordHolderQueue(RecordIterator[] iterators) {
    ...
    this.recordHolderHeap =
        new PriorityQueue<RecordIterator>(iterators.length, new Comparator<RecordIterator>() {
