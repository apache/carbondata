...
public class MolapUnComressedSortTempFileReader extends AbstractSortTempFileReader {
     ...
     * @param type
     */
    public MolapUnComressedSortTempFileReader(int measureCount, int mdKeyLenght,
