...
public class CarbonUnComressedSortTempFileReader extends AbstractSortTempFileReader {
   ...
   * @param type
   */
  public CarbonUnComressedSortTempFileReader(int measureCount, int mdKeyLenght,
