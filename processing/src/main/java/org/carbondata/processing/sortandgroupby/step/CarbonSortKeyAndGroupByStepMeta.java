...
public class CarbonSortKeyAndGroupByStepMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() {
    ...
    strBuffValue.append("    ").append(XMLHandler.addTagValue("factStorePath", this.factStorePath));
    strBuffValue.append("    ")
        .append(XMLHandler.addTagValue("aggregateMeasuresString", this.aggregateMeasuresString));
    strBuffValue.append("    ")
    ...
    strBuffValue.append("    ").append(XMLHandler.addTagValue("heirAndKeySize", heirAndKeySize));
    strBuffValue.append("    ").append(XMLHandler.addTagValue("heirAndDimLens", heirAndDimLens));
    strBuffValue.append("    ")
  ...
  public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters)
    ...
    try {
      ...
      this.aggregateMeasuresString = XMLHandler.getTagValue(stepnode, "aggregateMeasuresString");
  ...
  public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep)
    ...
    try {
      ...
      rep.saveStepAttribute(idTransformation, idStep, "factMeasureString", this.factMeasureString);
  ...
  public void readRep(Repository rep, ObjectId idStep, List<DatabaseMeta> databases,
    ...
    try {
      ...
      this.aggregateMeasuresString = rep.getStepAttributeString(idStep, "aggregateMeasuresString");
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
    ...
    return new CarbonSortKeyAndGroupByStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
  }
