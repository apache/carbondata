...
public class CarbonColumnarSliceMerger implements CarbonSliceMerger {
    ...
    public boolean fullMerge(int currentRestructNumber) throws SliceMergerException {
        ...
        String localStore = CarbonProperties.getInstance()
                .getProperty(CarbonCommonConstants.STORE_LOCATION,
                        CarbonCommonConstants.STORE_LOCATION_DEFAULT_VAL) + '/' + schema.name + '/'
                + cube.name;
        ...
        startMerge(slicesFromHDFS,
                CarbonUtil.readSliceMetaDataFile(hdfsLocation, restrctFolderCount),
    ...
    public void mergerSlice(List<CarbonSliceAndFiles> slicesFromHDFS, SliceMetaData sliceMetaData,
        ...
        for (int i = 0; i < sliceLocation.length; i++) {
            ...
            int[] cardinality = CarbonMergerUtil
        ...
        if (existingSliceCompressionModel.size() > 0) {
            ...
            int[] maxCardinality = CarbonMergerUtil
