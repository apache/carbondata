...
public class CarbonAutoAggGroupByExtended extends CarbonAutoAggGroupBy {

  /**
   * CarbonAutoAggGroupByExtended Constructor
   *
   * @param aggType
   * @param aggClassName
   * @param schemaName
   ...
   * @param factDims
   */
  public CarbonAutoAggGroupByExtended(String[] aggType, String[] aggClassName, String schemaName,
