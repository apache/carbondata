...
public class CsvInputMeta extends BaseStepMeta
    ...
    private void readData(Node stepnode) throws KettleXMLException {
        try {
            ...
            includingFilename = "Y".equalsIgnoreCase(
                    XMLHandler.getTagValue(stepnode, getXmlCode("INCLUDE_FILENAME")));
            ...
            escapeEnclosure = "Y".equalsIgnoreCase(
                    XMLHandler.getTagValue(stepnode, getXmlCode("ESACAPE_ENCLOSURE")));
            bufferSize = XMLHandler.getTagValue(stepnode, getXmlCode("BUFFERSIZE"));
            headerPresent = "Y".equalsIgnoreCase(
                    XMLHandler.getTagValue(stepnode, getXmlCode("HEADER_PRESENT")));
            lazyConversionActive = "Y".equalsIgnoreCase(
                    XMLHandler.getTagValue(stepnode, getXmlCode("LAZY_CONVERSION")));
            isaddresult = "Y".equalsIgnoreCase(
                    XMLHandler.getTagValue(stepnode, getXmlCode("ADD_FILENAME_RESULT")));
            runningInParallel =
            ...
            for (int i = 0; i < nrfields; i++) {
                ...
                inputFields[i].setType(
                        ValueMeta.getType(XMLHandler.getTagValue(fnode, getXmlCode("FIELD_TYPE"))));
                inputFields[i].setFormat(XMLHandler.getTagValue(fnode, getXmlCode("FIELD_FORMAT")));
                inputFields[i].setCurrencySymbol(
                        XMLHandler.getTagValue(fnode, getXmlCode("FIELD_CURRENCY")));
                inputFields[i].setDecimalSymbol(
                        XMLHandler.getTagValue(fnode, getXmlCode("FIELD_DECIMAL")));
                inputFields[i]
                        .setGroupSymbol(XMLHandler.getTagValue(fnode, getXmlCode("FIELD_GROUP")));
                inputFields[i].setLength(
                        Const.toInt(XMLHandler.getTagValue(fnode, getXmlCode("FIELD_LENGTH")), -1));
                inputFields[i].setPrecision(
                        Const.toInt(XMLHandler.getTagValue(fnode, getXmlCode("FIELD_PRECISION")),
                                -1));
                inputFields[i].setTrimType(ValueMeta.getTrimTypeByCode(
                        XMLHandler.getTagValue(fnode, getXmlCode("FIELD_TRIM_TYPE"))));
            }
        } catch (Exception e) {
    ...
    public String getXML() {
        ...
        retval.append("    ")
                .append(XMLHandler.addTagValue(getXmlCode("ROW_NUM_FIELD"), rowNumField));
        retval.append("    ")
        ...
        retval.append("    ").append(XMLHandler
                .addTagValue(getXmlCode("LAZY_CONVERSION"), lazyConversionActive));
        retval.append("    ")
                .append(XMLHandler.addTagValue(getXmlCode("ADD_FILENAME_RESULT"), isaddresult));
        retval.append("    ")
                .append(XMLHandler.addTagValue(getXmlCode("PARALLEL"), runningInParallel));
        retval.append("    ").append(XMLHandler
                .addTagValue(getXmlCode("NEWLINE_POSSIBLE"), newlinePossibleInFields));
        ...
        for (int i = 0; i < inputFields.length; i++) {
            ...
            retval.append("      ").append(XMLHandler.openTag(getXmlCode("FIELD")))
                    .append(Const.CR);
            retval.append("        ")
                    .append(XMLHandler.addTagValue(getXmlCode("FIELD_NAME"), field.getName()));
            retval.append("        ").append(XMLHandler
                    .addTagValue(getXmlCode("FIELD_TYPE"), ValueMeta.getTypeDesc(field.getType())));
            retval.append("        ")
                    .append(XMLHandler.addTagValue(getXmlCode("FIELD_FORMAT"), field.getFormat()));
            retval.append("        ").append(XMLHandler
                    .addTagValue(getXmlCode("FIELD_CURRENCY"), field.getCurrencySymbol()));
            retval.append("        ").append(XMLHandler
                    .addTagValue(getXmlCode("FIELD_DECIMAL"), field.getDecimalSymbol()));
            retval.append("        ").append(XMLHandler
                    .addTagValue(getXmlCode("FIELD_GROUP"), field.getGroupSymbol()));
            retval.append("        ")
                    .append(XMLHandler.addTagValue(getXmlCode("FIELD_LENGTH"), field.getLength()));
            retval.append("        ").append(XMLHandler
                    .addTagValue(getXmlCode("FIELD_PRECISION"), field.getPrecision()));
            retval.append("        ").append(XMLHandler.addTagValue(getXmlCode("FIELD_TRIM_TYPE"),
                    ValueMeta.getTrimTypeCode(field.getTrimType())));
            retval.append("      ").append(XMLHandler.closeTag(getXmlCode("FIELD")))
                    .append(Const.CR);
        }
    ...
    public void readRep(Repository rep, ObjectId idStep, List<DatabaseMeta> databases,
        ...
        try {
            ...
            lazyConversionActive =
                    rep.getStepAttributeBoolean(idStep, getRepCode("LAZY_CONVERSION"));
            ...
            for (int i = 0; i < nrfields; i++) {
                ...
                inputFields[i]
                        .setName(rep.getStepAttributeString(idStep, i, getRepCode("FIELD_NAME")));
                inputFields[i].setType(ValueMeta
                        .getType(rep.getStepAttributeString(idStep, i, getRepCode("FIELD_TYPE"))));
                inputFields[i].setFormat(
                        rep.getStepAttributeString(idStep, i, getRepCode("FIELD_FORMAT")));
                inputFields[i].setCurrencySymbol(
                        rep.getStepAttributeString(idStep, i, getRepCode("FIELD_CURRENCY")));
                inputFields[i].setDecimalSymbol(
                        rep.getStepAttributeString(idStep, i, getRepCode("FIELD_DECIMAL")));
                inputFields[i].setGroupSymbol(
                        rep.getStepAttributeString(idStep, i, getRepCode("FIELD_GROUP")));
                inputFields[i].setLength(
                        (int) rep.getStepAttributeInteger(idStep, i, getRepCode("FIELD_LENGTH")));
                inputFields[i].setPrecision((int) rep
                        .getStepAttributeInteger(idStep, i, getRepCode("FIELD_PRECISION")));
                inputFields[i].setTrimType(ValueMeta.getTrimTypeByCode(
    ...
    public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep)
        ...
        try {
            ...
            rep.saveStepAttribute(idTransformation, idStep, getRepCode("FILENAME_FIELD"),
                    filenameField);
            rep.saveStepAttribute(idTransformation, idStep, getRepCode("ROW_NUM_FIELD"),
                    rowNumField);
            ...
            rep.saveStepAttribute(idTransformation, idStep, getRepCode("HEADER_PRESENT"),
                    headerPresent);
            ...
            rep.saveStepAttribute(idTransformation, idStep, getRepCode("ADD_FILENAME_RESULT"),
                    isaddresult);
            rep.saveStepAttribute(idTransformation, idStep, getRepCode("PARALLEL"),
                    runningInParallel);
    ...
    public void getFields(RowMetaInterface rowMeta, String origin, RowMetaInterface[] info,
        ...
        for (int i = 0; i < inputFields.length; i++) {
            ...
            storageMetadata.setLength(-1,
                    -1); // we don't really know the lengths of the strings read in advance.
        ...
        if (!Const.isEmpty(rowNumField)) {
            ValueMetaInterface rowNumMeta =
                    new ValueMeta(rowNumField, ValueMetaInterface.TYPE_INTEGER);
    ...
    public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepinfo,
        ...
        if (input.length > 0) {
            ...
            cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages
                    .getString(PKG, "CsvInputMeta.CheckResult.NoInputReceivedFromOtherSteps"),
                    stepinfo); //$NON-NLS-1$
            remarks.add(cr);
        }
    }
    ...
    public List<ResourceReference> getResourceDependencies(TransMeta transMeta, StepMeta stepInfo) {
        ...
        if (!Const.isEmpty(filename)) {
            ...
            // step meta data.
            //
            reference.getEntries().add(new ResourceEntry(transMeta.environmentSubstitute(filename),
                    ResourceType.FILE));
        }
        return references;
    }
                    ...
                    for (int row = 0; row < inputFieldEntries.size(); row++) {
                        ...
                        for (int i = 0; i < fieldAttributes.size(); i++) {
                            ...
                            KettleAttributeInterface fieldAttr =
                                    findAttribute(fieldAttribute.getKey());
                            ...
                            if ("FIELD_NAME".equals(fieldAttributeKey)) {
                                ...
                                inputField.setLength(attributeValue == null ?
                                        -1 :
                                        Integer.parseInt(attributeValue));
                            } else if ("FIELD_PRECISION".equals(fieldAttributeKey)) {
                                inputField.setPrecision(attributeValue == null ?
                                        -1 :
                                        Integer.parseInt(attributeValue));
                                ...
                                throw new RuntimeException(
                                        "Unhandled metadata injection of attribute: " + fieldAttr
                                                .toString() + " - " + fieldAttr.getDescription());
                            }
                        }
