...
public class BlockDataHandler {
    ...
    protected boolean openFile(StepMetaInterface smi, StepDataInterface sdi, TransMeta transMeta, BlockDetails blockDetails) throws KettleException {
        try {
            ...
            if (conversionExceptions != null && conversionExceptions.size() > 0) {
                ...
                throw new KettleConversionException(
                        "There were " + conversionExceptions.size() + " conversion errors on line "
                                , conversionExceptions, exceptionFields,
                        outputRowData);
            }
