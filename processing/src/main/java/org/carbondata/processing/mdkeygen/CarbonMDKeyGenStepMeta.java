...
public class CarbonMDKeyGenStepMeta extends BaseStepMeta implements StepMetaInterface, Cloneable {
    /**
     * for i18n purposes
     */
    private static Class<?> pkg = CarbonMDKeyGenStepMeta.class; // for i18n
    // purposes
    ...
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
        ...
        return new CarbonMDKeyGenStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }

    @Override
    public StepDataInterface getStepData() {
        return new CarbonMDKeyGenStepData();
    }
