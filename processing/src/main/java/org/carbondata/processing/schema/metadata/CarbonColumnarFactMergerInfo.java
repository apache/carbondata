...
public class CarbonColumnarFactMergerInfo {
  ...
  private List<CarbonSliceAndFiles> slicesFromHDFS;
   ...
   */
  public List<CarbonSliceAndFiles> getSlicesFromHDFS() {
   ...
   */
  public void setSlicesFromHDFS(List<CarbonSliceAndFiles> slicesFromHDFS) {
