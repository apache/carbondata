...
public class CarbonFactReaderMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() {
    ...
    retval.append("    ")
        .append(XMLHandler.addTagValue("modificationOrDeletionTime", modificationOrDeletionTime));
  ...
  @Override public void readRep(Repository rep, ObjectId idStep, List<DatabaseMeta> databases,
    ...
    try {
      ...
      modificationOrDeletionTime = rep.getStepAttributeString(idStep, "modificationOrDeletionTime");
    } catch (Exception e) {
  ...
  @Override public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep)
    ...
    try {
      ...
      rep.saveStepAttribute(idTransformation, idStep, "loadNames", loadNames);
