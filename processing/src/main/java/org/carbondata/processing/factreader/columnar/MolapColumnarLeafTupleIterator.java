...
public class MolapColumnarLeafTupleIterator implements MolapIterator<MolapSurrogateTupleHolder> {
     ...
     */
    public MolapColumnarLeafTupleIterator(String sliceLocation, MolapFile[] factFiles,
        ...
        this.leafNodeIterator =
                new MolapColumnarLeafNodeIterator(factFiles, mdkeyLength, compressionModel,
                        factItreatorInfo);
    ...
    public MolapColumnarLeafTupleIterator(String loadPath, MolapFile[] factFiles,
            FactReaderInfo factReaderInfo, int mdKeySize,
        ...
        this.uniqueValue = compressionModel.getUniqueValue();
        this.leafNodeIterator =
                new MolapColumnarLeafNodeIterator(factFiles, mdKeySize, compressionModel,
