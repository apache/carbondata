 ...
 */
public class MolapDataWriterStepMeta extends BaseStepMeta implements StepMetaInterface, Cloneable {
    ...
    @Override public void readRep(Repository rep, ObjectId idStep, List<DatabaseMeta> databases,
        ...
        try {
            ...
            throw new KettleException(BaseMessages.getString(pkg,
                    "MolapDataWriterStepMeta.Exception.UnexpectedErrorInReadingStepInfo"), ex3);
        }
