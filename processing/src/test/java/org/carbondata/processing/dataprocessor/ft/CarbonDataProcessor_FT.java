...
public class CarbonDataProcessor_FT extends TestCase {
    ...
    @Test
    public void test_CarbonDataProcessor_DataLoading_Form_DB_Output_CarbonStoreFiles() {
        Trans trans = null;
        File file = new File("");
        String graphFile = file.getAbsolutePath() + File.separator + "test" + File.separator
                + "src/test/resources" + File.separator + "DATA_FACT_SMALL1.ktr";
        ...
        trans.setVariable("csvInputFilePath",
                file.getAbsolutePath() + File.separator + "test" + File.separator
                        + "src/test/resources" + File.separator + "DATA_FACT_SMALL.csv");
    ...
    @Test
    public void test_CarbonDataProcessor_DataLoading_Form_DB_Output_CarbonStoreFiles_Merger() {
        Trans trans = null;
        File file = new File("");
        String graphFile = file.getAbsolutePath() + File.separator + "test" + File.separator
                + "src/test/resources" + File.separator + "CSV.ktr";
        TransMeta transMeta = null;
        try {
            transMeta = new TransMeta(graphFile);
        } catch (KettleXMLException e) {
