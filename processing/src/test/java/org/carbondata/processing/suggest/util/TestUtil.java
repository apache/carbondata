...
public class TestUtil {
  ...
  public static CarbonDataLoadSchema readMetaData(String metaDataPath, String schemaName,
      String tableName) {
    try {
      ...
      if (FileFactory.isFileExist(metaDataPath, fileType)) {
        ...
        org.carbondata.core.carbon.metadata.schema.table.TableInfo wrappedTableInfo =
            converter.fromExternalToWrapperTableInfo(tableInfo, schemaName, tableName);
        org.carbondata.core.carbon.metadata.CarbonMetadata.getInstance()
            .loadTableMetadata(wrappedTableInfo);
        CarbonDataLoadSchema carbonDataLoadSchema = new CarbonDataLoadSchema(
            org.carbondata.core.carbon.metadata.CarbonMetadata.getInstance()
                .getCarbonTable(tableName));
