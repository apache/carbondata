...
public class DataStatsAggregateServiceTest {
  ...
  @Test public void testDataStats_distinctRelNotSerialized_getDimensions() {
  ...
  @Test public void testDataStats_distinctRelNotSerialized_getScript() {
  ...
  @Test public void testGetAggregateDimensions_throwsException() {
    ...
    try {
      ...
      new MockUp<QueryDistinctData>() {
        ...
        @Mock public Level[] queryDistinctData(String partitionId) throws AggSuggestException {
  ...
  @Test public void testNoVisibleLevel() {
    new MockUp<AggCombinationGeneratorUtil>() {

      @Mock public Level[] getVisibleLevels(Level[] aggLevels, CarbonDef.Cube cube) {
        return new Level[0];
      }
  ...
  @Test public void testSetCalculatedLoads() {
    new MockUp<DriverDistinctData>() {

      @Mock public List<String> getLoads() {
