...
public class CommonUtilTest {
  ...
  @Test public void testsetListOfValidSlices_updateLoad() {
    new MockUp<LoadMetadataDetails>() {

      @Mock public String getLoadStatus() {
  ...
  @Test public void testsetListOfValidSlices_partitalSuccess() {
    new MockUp<LoadMetadataDetails>() {
  ...
  @Test public void testsetListOfValidSlices_throwException() {
  ...
  @Test public void testsetListOfValidSlices_IOException() {
  ...
  @Test public void testReadMetaData_FileNotExist() {

    Assert.assertNull(CommonUtil.readMetaData("test/resource"));
  }

  @Test public void testReadMetaData_nullSource() {
    Assert.assertNull(CommonUtil.readMetaData(null));
  }

  @Test public void testReadMetaData_throwIOException() {
    new MockUp<java.io.DataInputStream>() {

      @Mock public void readFully(byte[] b) throws IOException {
        throw new IOException();
      }
  ...
  @Test public void testReadMetaData_throwXOMException() {
    new MockUp<CommonUtil>() {

      @Mock public CarbonDef.Schema parseStringToSchema(String schema) throws XOMException {
