...
public class AggregateUtilTest {
  @Test public void testGetDataType_Double() {
  ...
  @Test public void testGetDataType_Long() {
    Type type = Type.LONG;
    DataType dataType = DataStatsUtil.getDataType(type);
    Assert.assertEquals(dataType, DataType.LongType);
  }

  @Test public void testGetDataType_Boolean() {
    Type type = Type.BOOLEAN;
    DataType dataType = DataStatsUtil.getDataType(type);
    Assert.assertEquals(dataType, DataType.BooleanType);
  }

  @Test public void testGetDataType_Default() {
    Type type = Type.TIMESTAMP;
    DataType dataType = DataStatsUtil.getDataType(type);
    Assert.assertEquals(dataType, DataType.IntegerType);
  }

  @Test public void testSerializeObject_InvalidPath_throwIOException() {
  ...
  @Test public void testSerializeObject_InvalidPath_DirectoryCreationFailed() {
  ...
  @Test public void testSerializeObject_ErrorGettingDataOutputStream() {

    new MockUp<FileFactory>() {

      @Mock public DataOutputStream getDataOutputStream(String path, FileFactory.FileType fileType)
          throws IOException {
        throw new IOException();
      }
  ...
  @Test public void testSerializeObject_ErrorGettingObjectOutputStream() {

    new MockUp<ObjectOutputStream>() {

      @Mock public void writeObject(Object object) throws IOException {
        throw new IOException();
      }
  ...
  @Test public void testreadSerializedFile_FileDoesnotExist() {
  ...
  @Test public void testreadSerializedFile_ErrorGettingDataOutputStream() {
  ...
  @Test public void testreadSerializedFile_ErrorGettingObjectInputStream() {
    ...
    new MockUp<ObjectInputStream>() {
      ...
      @Mock public Object readObject() throws IOException {
        throw new IOException();
      }
