 ...
 *
 */
public class CarbonDataWriterStep_FT extends TestCase {
    ...
    //        }
    //
    //        copyFile(storeLocationPath + File.separator + CarbonCommonConstants.MEASURE_METADATA_FILE_NAME + tableName,
    ...
    //
    //    @Test
    //    public void test_CarbonDataWriterStep_InterMediateFile_Output_Intermediate_File_PresentIn_Store_Location()
    //    {
    ...
    //        StepMeta carbonMDKeyStep = getCarbonDataWriterStep();
    ...
    //            assertTrue(false);
    //        }
    //        List<RowMetaAndData> inputList = createCarbonDataWriterInputData();
    ...
    //
    //    @Test
    //    public void test_CarbonDataWriterStep_InterMediateFile_Output_Intermediate_File_ContainsProper_LeafNode_MetaData()
    //    {
    //        TransMeta transMeta = new TransMeta();
    //        transMeta.setName("sortrowstest");
    //
    ...
    //            int fileNameByteArrayLength = read(CarbonCommonConstants.INT_SIZE_IN_BYTE, channel, offset)
    //                    .getInt();
    ...
    //            long leafOffset = read(CarbonCommonConstants.LONG_SIZE_IN_BYTE, channel,
    //                    offset)
    //                    .getLong();
    //            offset+=CarbonCommonConstants.LONG_SIZE_IN_BYTE;
    ...
    //
    //    @Test
    //    public void test_CarbonDataWriterStep_LeafNodeFile_Output_LeafNode_File_PresentIn_Store_Location()
    //    {
    //        TransMeta transMeta = new TransMeta();
    //        transMeta.setName("sortrowstest");
    //
    ...
    //    }
    //    @Test
    //    public void test_CarbonDataWriterStep_LeafNodeFile_Output_LeafNode_File_Contains_Proper_LeafNodeData()
    //    {
    //        TransMeta transMeta = new TransMeta();
    //        transMeta.setName("sortrowstest");
    //
    ...
    //        offset+=offset+CarbonCommonConstants.INT_SIZE_IN_BYTE;
    ...
    //        return buffer;
    //    }
    //    private StepMeta getCarbonDataWriterStep()
    //    {
    //        CarbonDataWriterStepMeta carbonDataWriter = new CarbonDataWriterStepMeta();
    //        carbonDataWriter.setMaxLeafNode("100");
    //        carbonDataWriter.setLeafNodeSize("8192");
    //        carbonDataWriter.setTabelName(tableName);
    //        carbonDataWriter.setStoreLocation(storeLocation);
    //        StepMeta stepMeta = new StepMeta(GraphGeneratorConstants.CARBON_DATA_WRITER,
    //                (StepMetaInterface)carbonDataWriter);
    //        stepMeta.setName("CarbonDataWriter");
    //        stepMeta.setStepID("CarbonDataWriter");
    //        stepMeta.setDescription("Carbon Data to file: " + GraphGeneratorConstants.CARBON_DATA_WRITER);
    //
    //        return stepMeta;
    //    }
    ...
    //        return rm;
    //    }
    //    private List<RowMetaAndData> createCarbonDataWriterInputData()
    //    {
