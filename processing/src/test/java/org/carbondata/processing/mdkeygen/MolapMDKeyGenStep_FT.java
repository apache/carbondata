 ...
 *
 */
public class MolapMDKeyGenStep_FT extends TestCase
{
...
//    }
//
//    public void test_MolapMdkeyGenStep_MeasureMetaFile_Output_MeasureMetaFile_With_Max_Min_DecimalValue()
//    {
...
//        StepMeta molapMDKeyStep = getMolapMDKeyStep();
...
//    }
//
//    public void test_MolapMdkeyGenStep_Validate_MeasureMetaFile_Output_MeasureMetaFile_With_Proper_Max_Min_DecimalLength_Values()
//    {
//        TransMeta transMeta = new TransMeta();
//        transMeta.setName("sortrowstest");
//
...
//        delete(file1);
//    }
//    public void test_MolapMdkeyGenStep_Validate_Output_MDkeyGenStep_Generating_Proper_MDkey_For_Input_Surrogate_Keys()
//    {
//        TransMeta transMeta = new TransMeta();
//        transMeta.setName("sortrowstest");
//
...
//        int currentIndex = 0;
//        int totalSize = measureCount * MolapCommonConstants.DOUBLE_SIZE_IN_BYTE * 2 + measureCount
...
//    }
//
//    private StepMeta getMolapMDKeyStep()
//    {
//        MolapMDKeyGenStepMeta molapMdKey = new MolapMDKeyGenStepMeta();
//        molapMdKey.setNumberOfCores("2");
//        molapMdKey.setTableName(tableName);
//        molapMdKey.setStoreLocation(storeLocation);
//        molapMdKey.setAggregateLevels(aggLevels);
//        StepMeta mdkeyStepMeta = new StepMeta(GraphGeneratorConstants.MOLAP_MDKEY_GENERATOR,
//                (StepMetaInterface)molapMdKey);
//        mdkeyStepMeta.setName("MolapMDKeyGen");
//        mdkeyStepMeta.setStepID("MolapMDKeyGen");
//        mdkeyStepMeta.setDescription("Generate MDKey For Table Data: " + GraphGeneratorConstants.MOLAP_MDKEY_GENERATOR);
//
