...
import org.apache.carbondata.core.datamap.dev.fgindex.FineGrainIndex;
...
public class LuceneFineGrainIndexFactory extends LuceneIndexFactoryBase<FineGrainIndex> {
   ...
   */
  @Override
  public List<FineGrainIndex> getIndexes(IndexDistributable distributable)
      throws IOException {
    List<FineGrainIndex> lstDataMap = new ArrayList<>();
    FineGrainIndex dataMap = new LuceneFineGrainIndex(analyzer, getDataMapSchema());
    String indexPath = ((LuceneIndexDistributable) distributable).getIndexPath();
