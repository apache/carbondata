...
/**
 * implementation for min max blocklet.
 */
public class MinMaxIndex extends CoarseGrainIndex {

  private static final Logger LOGGER =
      LogServiceFactory.getLogService(org.apache.carbondata.datamap.examples.MinMaxIndex.class.getName());

  private String[] indexFilePath;

  private org.apache.carbondata.datamap.examples.MinMaxIndexBlockDetails[][] readMinMaxDataMap;

  @Override
  public void init(IndexModel model) throws IOException {
