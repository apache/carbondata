...
public class CarbonWriterBuilder {
  ...
  private CarbonWriterUtil carbonWriterUtil = CarbonWriterUtil.getInstance();
  ...
  public CarbonWriter buildWriterForCSVInput(Schema schema)
    ...
    Objects.requireNonNull(path, "path should not be null");
    this.schema = schema;
    CarbonLoadModel loadModel = carbonWriterUtil
        .createLoadModel(path, persistSchemaFile, UUID, taskNo, options, schema, blockSize,
            blockletSize, sortColumns, isTransactionalTable);
