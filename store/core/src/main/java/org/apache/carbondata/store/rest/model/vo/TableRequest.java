...
public class TableRequest {
  ...
  public TableRequest(boolean ifNotExists, String databaseName, String tableName,
  ...
  public Table convertToDto() {
    ...
    return new Table(ifNotExists, databaseName, tableName, schema, properties, comment);
  }
