...
public class CSVWriter implements Closeable, Flushable {
    ...
    */      //CHECKSTYLE:OFF    Approval No:Approval-V1R2C10_00
   ...
   private static final LogService LOGGER = LogServiceFactory
           .getLogService(CSVWriter.class.getName());
   ...
   private boolean stringContainsSpecialCharacters(String line) {
      return line.indexOf(quotechar) != -1 || line.indexOf(escapechar) != -1 || line.indexOf(separator) != -1 || line.contains(DEFAULT_LINE_END) || line.contains(CARRIAGE_RETURN);
   }
