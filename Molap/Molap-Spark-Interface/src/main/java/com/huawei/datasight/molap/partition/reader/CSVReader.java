...
public class CSVReader implements Closeable, Iterable<String[]> {
    ...
    private String[] readSingleLine() throws IOException
    {
        ...
        catch(IOException e)
        {
            ...
            {
            	badRecordslogger.addBadRecordsToBilder(new String[]{nextLine}, 1, "Un-terminated quoted field at end of CSV line", null);
            	LOGGER.info(MolapSparkInterFaceLogEvent.UNIBI_MOLAP_SPARK_INTERFACE_MSG,"Found Un-terminated quote @ line ["+this.lineNum+"] : Skipping Line : "+nextLine);
//                System.out.println("Found Un-terminated quote @ line ["+this.lineNum+"] : Skipping Line : "+nextLine);
        ...
        if(null == nextLine)
        {
        	LOGGER.info(MolapSparkInterFaceLogEvent.UNIBI_MOLAP_SPARK_INTERFACE_MSG,"Total Number of Lines : "+ --this.lineNum);
        	LOGGER.info(MolapSparkInterFaceLogEvent.UNIBI_MOLAP_SPARK_INTERFACE_MSG,"Number of Lines Skipped: "+ this.skippedLines);
...
//                System.out.println("Number of Lines Skipped: "+ this.skippedLines);
            ...
            {             
                ...
                {
                	LOGGER.info(MolapSparkInterFaceLogEvent.UNIBI_MOLAP_SPARK_INTERFACE_MSG,"Un-terminated quoted field found after 10000 characters in MultiLine (No. Of Line searched : "+linesread+" ) starting from Line :"+(this.lineNum - linesread + 1));
                	LOGGER.info(MolapSparkInterFaceLogEvent.UNIBI_MOLAP_SPARK_INTERFACE_MSG,"Skipped Line Info : " + firstLine);
//                    System.out.println("Un-terminated quoted field found after 10000 characters in MultiLine (No. Of Line searched : "+linesread+" ) starting from Line :"+(this.lineNum - linesread + 1));
//                    System.out.println("Skipped Line Info : " + firstLine);
                    ...
                    badRecordslogger.addBadRecordsToBilder(result, resLength, "Un-terminated quoted field after 10000 characters", null);
                    result = readNext();
                }
                else
                {
