...
QO/t7BD/103tJwD/OyEW+IeD643ZPTymMXfJDx35Y/Xrk07wB2QS4MqGVIVw0RePTYUKVdDv
qf0RjbZXM/0lVPPzzDv9cgOjtlKkWspz32CQKOsqj5KXWGY7WND/MIOJ4w9kEw==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 *
 * Copyright Notice
...
//    private boolean isColumnar;
    ...
    @Override
    public void executeDimensionCount(Dimension dimension, MolapResultHolder hIterator) throws IOException
    {
        LOGGER.error(MolapEngineLogEvent.UNIBI_MOLAPENGINE_MSG, "UNSUPPORT Operation");
    ...
    @Override
    public void executeDimension(String hName, Dimension dim, final int[] dims, Map<Dimension, MolapFilterInfo> constraints,
