...
public class MolapFactReaderMeta extends BaseStepMeta implements StepMetaInterface
{
     ...
     * for i18n purposes
     */
    private static Class<?> pkg = MolapFactReaderMeta.class; // for i18n
    ...
    {
        String[] dimLensStringArray = dimLensString.split(MolapCommonConstants.COMA_SPC_CHARACTER);
        ...
        String[] globalDimLensStringArray = globalDimLensString.split(MolapCommonConstants.COMA_SPC_CHARACTER);
        ...
        this.aggType=aggTypeString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
        String[] split = blockIndexString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
    ...
    {
        return new MolapFactReaderStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    ...
    {
        return new MolapFactReaderData();
    }
    ...
    public String getXML()
    {
        ...
        retval.append("    ").append(XMLHandler.addTagValue("measureCountString", measureCountString));
        retval.append("    ").append(XMLHandler.addTagValue("dimLensString", dimLensString));
        retval.append("    ").append(XMLHandler.addTagValue("readOnlyInProgress", readOnlyInProgress));
        ...
        retval.append("    ").append(XMLHandler.addTagValue("aggregateTableName", aggregateTableName));
        retval.append("    ").append(XMLHandler.addTagValue("globalDimLensString", globalDimLensString));
            ...
            throws KettleException
    {
        ...
        try
        {
            ...
            rep.saveStepAttribute(idTransformation, idStep, "readOnlyInProgress", readOnlyInProgress);
            ...
            rep.saveStepAttribute(idTransformation, idStep, "aggregateTableName", aggregateTableName);
            rep.saveStepAttribute(idTransformation, idStep, "globalDimLensString", globalDimLensString);
        }
        catch(Exception e)
        {
            throw new KettleException(BaseMessages.getString(pkg,
