...
aRAl/r0PofBxOMtTFqRDIyC5BN7P4eIhvdK4lwQMoaOgc7agihC/NZhQmvFMwnMM3sQ10eq6
VyXq8UGnMfmNHBA5S1w8tkZaHPyvaLXMme9+o7M29eSTcqjvrfaqh7YJL0+OMA==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 *
 * Copyright Notice
        ...
        StepMetaInterface,Cloneable
{
     ...
     * for i18n purposes
     */
    private final Class<?> pkg = MolapDataWriterStepMeta.class;
     ...
     * 
     */
    public MolapDataWriterStepMeta()
    {
        super();
    }
    ...
    public String getXML()
    {
        ...
        retval.append("    ").append(
                XMLHandler.addTagValue("LeafNodeSize", leafNodeSize));
        retval.append("    ").append(
                XMLHandler.addTagValue("MaxLeafInFile", maxLeafNode));
        retval.append("    ").append(
        ...
        retval.append("    ").append(
                XMLHandler.addTagValue("isFactMDkeyInInputRow", isFactMDkeyInInputRow));
        retval.append("    ").append(
                XMLHandler.addTagValue("factMdkeyLength", factMdkeyLength));
        retval.append("    ").append(
                XMLHandler.addTagValue("isUpdateMemberRequest", updateMemberRequest));
        retval.append("    ").append(
        		XMLHandler.addTagValue("aggregateLevelsString", aggregateLevelsString));
        retval.append("    ").append(
            ...
            ObjectId idStep) throws KettleException
    {
        ...
        { 
            ...
            rep.saveStepAttribute(idTransformation, idStep, "LeafNodeSize",
                    leafNodeSize);
            //
            rep.saveStepAttribute(idTransformation, idStep, "MaxLeafInFile",
                    maxLeafNode);
            ...
            rep.saveStepAttribute(idTransformation, idStep, "factMdkeyLength",
                    factMdkeyLength);
            ...
            rep.saveStepAttribute(idTransformation, idStep, "factLevelsString",
            		factLevelsString);
            rep.saveStepAttribute(idTransformation, idStep, "mdkeyLength",
            		mdkeyLength);
            ...
            throws KettleException
    {
        ...
        { 
        	 ...
        	 schemaName = rep
                     .getStepAttributeString(idStep, "schemaName");
             cubeName = rep
                     .getStepAttributeString(idStep, "cubeName");
   ...
   /**
	...
	{
		return this.factLevelsString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
	}
	
	public String[] getAggregateLevels()
	{
		return this.aggregateLevelsString.split(MolapCommonConstants.HASH_SPC_CHARACTER);
	}
