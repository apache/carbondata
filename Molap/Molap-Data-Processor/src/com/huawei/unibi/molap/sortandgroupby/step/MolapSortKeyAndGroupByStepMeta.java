...
public class MolapSortKeyAndGroupByStepMeta extends BaseStepMeta implements StepMetaInterface
{
     ...
     * PKG
     */
    private static final Class<?> PKG = MolapSortKeyAndGroupByStepMeta.class;
...
//        }
    ...
    public String getXML()
    {
        ...
        strBuffValue.append("    ").append(XMLHandler.addTagValue("outputRowSize", this.outputRowSize));
        strBuffValue.append("    ").append(XMLHandler.addTagValue("isAutoAggRequest", this.autoAggRequest));
        strBuffValue.append("    ").append(XMLHandler.addTagValue("measureCount", this.measureCount));
        strBuffValue.append("    ").append(XMLHandler.addTagValue("isMDkeyInInputRow", this.isFactMDkeyInInputRow));
        strBuffValue.append("    ").append(XMLHandler.addTagValue("isUpdateMemberRequest", this.updateMemberRequest));
        strBuffValue.append("    ").append(
                XMLHandler.addTagValue("factStorePath", this.factStorePath));
        strBuffValue.append("    ").append(
                XMLHandler.addTagValue("aggregateMeasuresString",
                        this.aggregateMeasuresString));
        strBuffValue.append("    ").append(
                XMLHandler.addTagValue("factMeasureString",
            ...
            throws KettleXMLException
    {
        try
        {
            ...
            this.factTableName = XMLHandler.getTagValue(stepnode,
                    "factTableName");
            this.factStorePath = XMLHandler.getTagValue(stepnode,
                    "factStorePath");
            this.aggregateMeasuresString = XMLHandler.getTagValue(stepnode,
                    "aggregateMeasuresString");
            this.factMeasureString = XMLHandler.getTagValue(stepnode,
                    "factMeasureString");
    ...
    public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep) throws KettleException
    {
        try
        {
            ...
            rep.saveStepAttribute(idTransformation, idStep, "factDimLensString",
            		factDimLensString);
            rep.saveStepAttribute(idTransformation, idStep, "outputRowSize", this.outputRowSize); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "cubeName", this.cubeName);
            rep.saveStepAttribute(idTransformation, idStep, "schemaName", this.schemaName); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "isAutoAggRequest", this.autoAggRequest); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "measureCount", this.measureCount); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "isMDkeyInInputRow", this.isFactMDkeyInInputRow); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "isUpdateMemberRequest", this.updateMemberRequest); //$NON-NLS-1$
            rep.saveStepAttribute(idTransformation, idStep, "factTableName",
                    this.factTableName);
            rep.saveStepAttribute(idTransformation, idStep, "factStorePath",
                    this.factStorePath);
            rep.saveStepAttribute(idTransformation, idStep,
                    "aggregateMeasuresString", this.aggregateMeasuresString);
            rep.saveStepAttribute(idTransformation, idStep,
                    "factMeasureString", this.factMeasureString);
            rep.saveStepAttribute(idTransformation, idStep,
                    "aggregateMeasuresColumnNameString",
                    aggregateMeasuresColumnNameString);
            rep.saveStepAttribute(idTransformation, idStep,
            ...
            throws KettleException
    {
        try
        {
            ...
            this.aggregatorClassString = rep.getStepAttributeString(idStep, "aggregatorClassString");
            ...
            this.factTableName = rep.getStepAttributeString(idStep,
                    "factTableName");
            this.factStorePath = rep.getStepAttributeString(idStep,
                    "factStorePath");
            this.aggregateMeasuresString = rep.getStepAttributeString(idStep,
                    "aggregateMeasuresString");
            this.factMeasureString = rep.getStepAttributeString(idStep,
                    "factMeasureString");
        ...
        {
            throw new KettleException(BaseMessages.getString(PKG,
                    "MolapDataWriterStepMeta.Exception.UnexpectedErrorInReadingStepInfo", new String[0]), e);
        }
    }
    ...
    {
        return new MolapSortKeyAndGroupByStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    ...
    {
        return new MolapSortKeyAndGroupByStepData();
    }
