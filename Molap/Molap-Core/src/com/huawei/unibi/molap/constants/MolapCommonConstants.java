 ...
 * FileName :MolapCommonConstants.java 
 * Class Description :MolapCommonConstants 
 * Version 1.0
 */
...
//    public static final String MOLAP_PROPERTIES_FILE_PATH = "../unibi-solutions/system/molap/molap.properties";
    ...
    public static final String MOLAP_REALTIMEDATA_MAPPER_FILE_PATH = "../unibi-solutions/system/molap/realtimedata.properties";
     ...
     */
    public static final String MOLAP_BADRECORDS_LOC_DEFAULT_VAL = "../unibi-solutions/system/molap/badRecords";
     ...
     *DATA_LOAD_Q_SIZE 
     */
    public static final String MOLAP_MEMBERUPDATE_DATA_LOAD_Q_SIZE = "molap.memberupdate.dataloader.queuesize";
     ...
     */
    public static final String MOLAP_MEMBERUPDATE_DATA_LOAD_CONC_EXE_SIZE = "molap.memberupdate.dataload.concurrent.execution.size";
     ...
     * MOLAP_Realtime_data
     */
    public static final String MOLAP_REALTIMEDATA_FILE = "../unibi-solutions/system/molap/realtimedata.properties";
  ...
  /**
     ...
     */
    public static final String PAGINATED_INTERNAL_MERGE_SIZE_LIMIT = "molap.paginated.internal.merge.size.limit";
     ...
     * PAGINATED Internal merge size limit
     */
    public static final String PAGINATED_INTERNAL_FILE_ROW_LIMIT = "molap.paginated.internal.file.row.limit";
     ...
     */
    public static final String SORT_INTERMEDIATE_FILES_LIMIT = "molap.sort.intermediate.files.limit";
     ...
     */
    public static final String MOLAP_SORT_FILE_WRITE_BUFFER_SIZE="molap.sort.file.write.buffer.size";
     ...
     */
    public static final String NUMBER_OF_THERADS_FOR_INTERMEDIATE_MERGING="molap.sort.intermedaite.number.of.threads";
     ...
     */
    public static final String MOLAP_CHECKPOINT_QUEUE_THRESHOLD = "molap.checkpoint.queue.threshold";
     ...
     */
    public static final String MOLAP_CHECKPOINT_QUEUE_INITIAL_CAPACITY = "molap.checkpoint.queue.initial.capacity";
    
    /**
     * MOLAP_CHECKPOINT_TOCOPY_FROM_QUEUE
     */
    public static final String MOLAP_CHECKPOINT_TOCOPY_FROM_QUEUE = "molap.checkpoint.tocopy.from.queue";
     ...
     */
    public static final String IS_PRODUCERCONSUMER_BASED_SORTING="molap.is.producer.consumer.based.sorting";
     ...
     */
    public static final String BACKGROUND_MERGER_TIME_INTERVAL_IN_MINUTE="molap.background.merger.time.interval";
     ...
     */
    public static final String MOLAP_SEQ_GEN_INMEMORY_LRU_CACHE_SIZE = "molap.seqgen.inmemory.lru.cache.size";
     ...
     */
    public static final String MOLAP_SEQ_GEN_INMEMORY_LRU_CACHE_ENABLED = "molap.seqgen.inmemory.lru.cache.enabled";
     ...
     */
    public static final String MOLAP_SEQ_GEN_INMEMORY_LRU_CACHE_FLUSH_INTERVAL_INHOUR = "molap.seqgen.inmemory.lru.cache.flush.interval.in.minute";

    /**
     * MOLAP_SEQ_GEN_INMEMORY_LRU_CACHE_FLUSH_INTERVAL_INHOUR_DEFAULTVALUE
     */
    public static final String MOLAP_SEQ_GEN_INMEMORY_LRU_CACHE_FLUSH_INTERVAL_INHOUR_DEFAULTVALUE = "300";
     ...
     */
    public static final String MOLAP_AUTOAGGREGATION_NO_OF_PARALLEL_AGGREGATETABLE_GENERATION = "molap.autoaggregation.no.of.parallel.aggregatetable.generation";
    
    /**
     * MOLAP_AUTOAGGREGATION_NO_OF_PARALLEL_AGGREGATETABLE_GENERATION_DEFAULT
     */
    public static final String MOLAP_AUTOAGGREGATION_NO_OF_PARALLEL_AGGREGATETABLE_GENERATION_DEFAULT = "1";
     ...
     */
    public static final String MOLAP_SEND_LOAD_SIGNAL_TO_ENGINE="molap.send.load.signal.to.engine";
     ...
     */
    public static final String IS_SORT_TEMP_FILE_COMPRESSION_ENABLED="molap.is.sort.temp.file.compression.enabled";
     ...
     */
    public static final String SORT_TEMP_FILE_NO_OF_RECORDS_FOR_COMPRESSION="molap.sort.temp.file.no.of.records.for.compression";
     ...
     */
    public static final String MOLAP_BACKGROUND_MERGER_FILE_SIZE ="molap.background.merge.file.size";
     ...
     */
    public static final String MOLAP_DATALOAD_VALID_CSVFILE_SIZE = "molap.dataload.valid.csvfile.size(in GB)";
     ...
     * MOLAP_DATALOAD_VALID_CSVFILE_SIZE
     */
    public static final String MOLAP_DATALOAD_VALID_NUMBAER_OF_CSVFILE = "molap.dataload.csv.filecount";
     ...
     */
    public static final String MOLAP_IS_LOAD_FACT_TABLE_IN_MEMORY="molap.is.load.facttable.in.memory";
     ...
     */
    public static final String MOLAP_READ_ONLY_UNPROCESSED_LOAD_FOLDER="molap.read.only.unprocessed.load.folder";
     ...
     * MOLAP_READ_ONLY_UNPROCESSED_LOAD_FOLER
     */
    public static final String MOLAP_PARALLEL_AGGREGATE_CREATION_FROM_FACT="molap.parallel.aggregate.creation.from.fact";
     ...
     * IS_PRODUCERCONSUMER_BASED_SORTING
     */
    public static final String IS_PRODUCERCONSUMER_BASED_SORTING_IN_AGG="molap.is.producer.consumer.based.sorting.in.agg";
     ...
     */
    public static final String DIMENSION_SPLIT_VALUE_IN_COLUMNAR="molap.dimension.split.value.in.columnar";
    ...
    */
     ...
     * NUMBER_OF_TRIES_FOR_LOAD_METADATA_LOCK
     */
    public static final String NUMBER_OF_TRIES_FOR_LOAD_METADATA_LOCK = "molap.load.metadata.lock.retries";

    /**
     * MAX_TIMEOUT_FOR_LOAD_METADATA_LOCK
     */
    public static final String MAX_TIMEOUT_FOR_LOAD_METADATA_LOCK = "molap.load.metadata.lock.retry.timeout.sec";
