...
@SuppressWarnings("deprecation") public final class MolapMetadata {
  ...
  public void loadCube(MolapDef.Schema schema, String orginalSchemaName, String orginalCubeName,
    ...
    HashMap<String, Measure> measuresMap =
        new HashMap<String, MolapMetadata.Measure>(MolapCommonConstants.DEFAULT_COLLECTION_SIZE);
  ...
  private void updateMeasureAndDimensions(String table, Cube cube, MolapDef.Schema schema,
    ...
    // Handle dimensions
      ...
      formDimensions(cube, levelList, levelNormalizedList, levelToColumnMap, metaFactTableCols, nd,
          factTableName, ((MolapDef.Dimension) nd).name);
      ...
      formDimensions(cube, levelList, levelNormalizedList, levelToColumnMap, metaFactTableCols,
          dimension, factTableName, ((MolapDef.DimensionUsage) nd).name);
    }
    // Handle measures
      ...
      Measure measure2 =
          new Measure(measure.column, ordinal, measure.aggregator, measure.aggClass, measure.name,
              MolapMetadata.makeSQLDataTye(measure.datatype), cube, isSurrogateGenerated);
  ...
  private void checkAndHandleNormalizedDim(ArrayList<LevelNormalizedProps> levelNormalizedList,
      int indexNormalized, List<MolapMetadata.Dimension> normalizedDimList, Dimension dimension) {
  ...
  public static class Cube implements Serializable {
    ...
    private Map<String, List<Dimension>> hierarchiesMapping =
        new LinkedHashMap<String, List<Dimension>>(MolapCommonConstants.DEFAULT_COLLECTION_SIZE);
