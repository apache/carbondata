...
public final class ValueCompressionUtil {
   ...
   * @see
   */
  private static CompressionFinder getCompressionType(double maxValue, double minValue, int decimal,
  ...
  public static MeasureMetaDataModel readMeasureMetaDataFile(String measureMetaDataFileLocation,
    ...
    try {
      ...
      LOGGER.error(MolapCoreLogEvent.UNIBI_MOLAPCORE_MSG, "@@@ msrMetadata File is missing @@@ ",
          f.getMessage());
