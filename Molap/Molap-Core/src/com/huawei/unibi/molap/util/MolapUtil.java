...
public final class MolapUtil {
    ...
    Arrays.sort(fileArray, new Comparator<File>() {
      public int compare(File o1, File o2) {
        try {
          ...
          LOGGER.error(MolapCoreLogEvent.UNIBI_MOLAPCORE_MSG, e, "Error while getSortedFile");
          return 0;
        }
      }
    });
   ...
   * related to leaf file
   */
  public static List<LeafNodeInfoColumnar> getLeafNodeInfoColumnar(MolapFile file, int measureCount,
      int mdKeySize) {
    List<LeafNodeInfoColumnar> listOfNodeInfo =
        new ArrayList<LeafNodeInfoColumnar>(MolapCommonConstants.CONSTANT_SIZE_TEN);
    String filesLocation = file.getAbsolutePath();
  ...
  public static short[] getUnCompressColumnIndex(int totalLength, byte[] columnIndexData) {
    ...
    short[] indexMap =
        new short[(totalLength - indexDataLength - MolapCommonConstants.INT_SIZE_IN_BYTE) / 2];
    int counter = 0;
  ...
  public static int[] getUnCompressColumnIndex(int totalLength, byte[] columnIndexData,
    ...
    try {
      ...
      LOGGER.error(MolapCoreLogEvent.UNIBI_MOLAPCORE_MSG, "Error while compressColumn Index ", e,
          e.getMessage());
    }
  ...
  public static String getRSPath(String schemaName, String cubeName, String tableName,
    ...
    String hdfsLoadedTable =
        hdfsStoreLocation + File.separator + MolapCommonConstants.RESTRUCTRE_FOLDER + rsCounter
            + "/" + tableName;
  ...
  public static int getRestructureNumber(String location, String factTableName) {
    ...
    String restructNumber =
        restructName.substring(MolapCommonConstants.RESTRUCTRE_FOLDER.length(), factTableIndex);
