 ...
 * <p>This class was generated from XOM model 'molap' on Sun Jul 05 15:54:12 IST 2015
 */
public class MolapDef {
    ...
    public Schema(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
      try {
        org.eigenbase.xom.DOMElementParser _parser =
            new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
  ...
  public static abstract class CubeDimension extends org.eigenbase.xom.ElementDef {
    ...
    public CubeDimension(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
      try {
        ...
        highCardinality =
            (Boolean) _parser.getAttribute("highCardinality", "Boolean", "false", null, false);
        annotations = (Annotations) _parser.getElement(Annotations.class, false);
      } catch (org.eigenbase.xom.XOMException _ex) {
        throw new org.eigenbase.xom.XOMException("In " + getName() + ": " + _ex.getMessage());
      }
    ...
    public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
      ...
      _diff = _diff && displayAttributeDiff("foreignKey", foreignKey, _cother.foreignKey, _out,
          _indent + 1);
      _diff =
          _diff && displayAttributeDiff("highCardinality", highCardinality, _cother.highCardinality,
              _out, _indent + 1);
      _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations, _out,
          _indent + 1);
      return _diff;
    ...
    public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
      _out.beginTag("Dimension",
          new org.eigenbase.xom.XMLAttrVector().add("type", type).add("usagePrefix", usagePrefix)
              ...
              .add("highCardinality", highCardinality).add("name", name).add("caption", caption)
              .add("description", description));
      displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
    ...
    public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
      _out.beginTag("Level",
          new org.eigenbase.xom.XMLAttrVector().add("approxRowCount", approxRowCount)
              ...
              .add("formatter", formatter).add("isParent", isParent).add("caption", caption)
              .add("description", description).add("captionColumn", captionColumn));
      displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
