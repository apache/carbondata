...
public class MolapDef {
    ...
    public static class Schema extends org.eigenbase.xom.ElementDef
    {
        ...
        {
            try {
                org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
    ...
    public static class Cube extends org.eigenbase.xom.ElementDef
    {
            ...
            throws org.eigenbase.xom.XOMException
        {
            try {
                ...
                autoAggregationType = (String)_parser.getAttribute("autoAggregationType", "String", "NONE", null, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent)
        {
            _out.beginTag("Cube", new org.eigenbase.xom.XMLAttrVector()
                ...
                .add("cache", cache)
                .add("enabled", enabled)
                .add("autoAggregationType", autoAggregationType)
                .add("mode", mode)
                );
            displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
        {
            ...
            _diff = _diff && displayAttributeDiff("autoAggregationType", autoAggregationType, _cother.autoAggregationType, _out, _indent+1);
...
// implement CubeDimension
    ...
    {    /**
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
        {
            ...
            _diff = _diff && displayAttributeDiff("normalized", normalized, _cother.normalized, _out, _indent+1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations, _out, _indent+1);
    ...
    {    
            ...
            throws org.eigenbase.xom.XOMException
        {
            try {
                ...
                levelCardinality = (Integer)_parser.getAttribute("levelCardinality", "Integer", "-1", null, false);
                ordinalColumnIndex = (Integer)_parser.getAttribute("ordinalColumnIndex", "Integer", "-1", null, false);
                nameColumnIndex = (Integer)_parser.getAttribute("nameColumnIndex", "Integer", "-1", null, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent)
        {
            _out.beginTag("Level", new org.eigenbase.xom.XMLAttrVector()
                ...
                .add("nameColumnIndex", nameColumnIndex)
                .add("table", table)
                .add("column", column)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
        {
            ...
            _diff = _diff && displayAttributeDiff("levelCardinality", levelCardinality, _cother.levelCardinality, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("ordinalColumnIndex", ordinalColumnIndex, _cother.ordinalColumnIndex, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("nameColumnIndex", nameColumnIndex, _cother.nameColumnIndex, _out, _indent+1);
...
public Expression getKeyExp() {
    ...
    { 
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
        {
            ...
            _diff = _diff && displayAttributeDiff("dataTypeClass", dataTypeClass, _cother.dataTypeClass, _out, _indent+1);
            ...
            _diff = _diff && displayAttributeDiff("aggClass", aggClass, _cother.aggClass, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("formatter", formatter, _cother.formatter, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("caption", caption, _cother.caption, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("description", description, _cother.description, _out, _indent+1);
            _diff = _diff && displayAttributeDiff("visible", visible, _cother.visible, _out, _indent+1);
...
/** Convenience constructor. */
    ...
    { 
        ...
        public void display(java.io.PrintWriter _out, int _indent)
        {
            ...
            displayElement(_out, "dataRetention", (org.eigenbase.xom.ElementDef) dataRetention, _indent+1);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
        {
            ...
            _diff = _diff && displayElementDiff("dataRetention", dataRetention, _cother.dataRetention, _out, _indent+1);
...
public String getNameAttribute() {
    ...
    { 
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent)
        {
            _out.beginTag("DataRetentionPolicy", new org.eigenbase.xom.XMLAttrVector()
                .add("unit", unit)
                .add("period", period)
                );
