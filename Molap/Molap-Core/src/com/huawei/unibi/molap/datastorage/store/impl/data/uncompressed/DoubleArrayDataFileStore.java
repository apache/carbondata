        ...
        if (cols != null) {
            for (int i = 0; i < cols.length; i++) {
                ...
                unComp[cols[i]].setValueInBytes(fileHolder
                        .readByteArray(fileName, measuresOffsetsArray[cols[i]],
            ...
            for (int i = 0; i < unComp.length; i++) {
                ...
                unComp[i].setValueInBytes(fileHolder
                        .readByteArray(fileName, measuresOffsetsArray[i], measuresLengthArray[i]));
                vals[i] = unComp[i].getValues(compressionModel.getDecimal()[i],
