...
public class CompressedColumnarFileKeyStore extends AbstractColumnarKeyStore
{
            ...
            FileHolder fileHolder, int[] blockIndex,boolean[] needCompressedData)
    {
        ...
        for(int i = 0;i < columnarKeyStoreDataHolders.length;i++)
        {
            ...
            columnarKeyBlockData = COMPRESSOR.unCompress(fileHolder.readByteArray(
                ...
                .unCompress(
                        fileHolder.readByteArray(
                                columnarStoreInfo
                                        .getFilePath(),
                                columnarStoreInfo
                                        .getDataIndexMapOffsets()[mapOfAggDataIndex.get(blockIndex[i])],
                                columnarStoreInfo
                                        .getDataIndexMapLength()[mapOfAggDataIndex.get(blockIndex[i])]));
            ...
            boolean needCompressedData)
    {
        ...
        int[] dataIndex = null;
        boolean isUnCompressed=true;
        columnarKeyBlockData = COMPRESSOR
