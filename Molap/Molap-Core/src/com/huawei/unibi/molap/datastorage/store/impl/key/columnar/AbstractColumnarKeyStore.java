...
public abstract class AbstractColumnarKeyStore implements ColumnarKeyStore {
    ...
    public AbstractColumnarKeyStore(ColumnarKeyStoreInfo columnarStoreInfo, boolean isInMemory,
        ...
        if (isInMemory) {
            ...
            this.columnarKeyBlockDataIndex =
                    new byte[this.mapOfColumnIndexAndColumnBlockIndex.size()][];
            ...
            for (int i = 0; i < columnarStoreInfo.getSizeOfEachBlock().length; i++) {
                ...
                if (!this.columnarStoreInfo.getIsSorted()[i]) {
                    this.columnarKeyBlockDataIndex[mapOfColumnIndexAndColumnBlockIndex.get(i)] =
                            fileHolder.readByteArray(columnarStoreInfo.getFilePath(),
                                    columnarStoreInfo
                                            .getKeyBlockIndexOffsets()[mapOfColumnIndexAndColumnBlockIndex
                                            .get(i)], columnarStoreInfo
                                            .getKeyBlockIndexLength()[mapOfColumnIndexAndColumnBlockIndex
                                            .get(i)]);
                }
