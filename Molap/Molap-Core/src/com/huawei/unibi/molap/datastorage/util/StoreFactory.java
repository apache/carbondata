...
public final class StoreFactory {
  ...
  static {
    String keytype = MolapProperties.getInstance().getProperty(MolapCommonConstants.KEYSTORE_TYPE,
  ...
  public static NodeKeyStore createKeyStore(int size, int elementSize, boolean isLeaf,
    ...
    default:
      ...
      if (isLeaf) {
        if (isFileStore) {
          return new CompressedSingleArrayKeyFileStore(size, elementSize, offset, fileName, length);
        } else {
