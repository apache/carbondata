...
public class FilterExpressionResolverTest {
	...
	public void testConditionalResolver() {
		ColumnExpression columnExpression = new ColumnExpression("imei",
				DataType.StringType);
		LiteralExpression literalExpression = new LiteralExpression("1A001",
				DataType.StringType);
		EqualToExpression equalsToExpression=new EqualToExpression(columnExpression,literalExpression);
		ConditionalFilterResolverImpl condResolverImpl=new ConditionalFilterResolverImpl(equalsToExpression,false,true);
