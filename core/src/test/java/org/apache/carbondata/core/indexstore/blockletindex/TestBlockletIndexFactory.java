...
public class TestBlockletIndexFactory {
  ...
  @Test public void addIndexToCache()
  ...
  @Test public void getValidDistributables() throws IOException {
    BlockletIndexDistributable blockletDataMapDistributable = new BlockletIndexDistributable(
    ...
    BlockletIndexDistributable blockletDataMapDistributable1 = new BlockletIndexDistributable(
    ...
    List<IndexDistributable> indexDistributables = new ArrayList<>(2);
    indexDistributables.add(blockletDataMapDistributable);
    indexDistributables.add(blockletDataMapDistributable1);
    ...
    List<IndexDistributable> validDistributables =
        blockletIndexFactory.getAllUncachedDistributables(indexDistributables);
