...
public class PrimitiveQueryTypeTest {
  ...
  @BeforeClass public static void setUp() {
    ...
    primitiveQueryType =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.STRING,
            isDirectDictionary);
    primitiveQueryTypeForInt =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.INT,
            isDirectDictionary);
    primitiveQueryTypeForDouble =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.DOUBLE,
            isDirectDictionary);
    primitiveQueryTypeForLong =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.LONG,
            isDirectDictionary);
    primitiveQueryTypeForBoolean =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.BOOLEAN,
            isDirectDictionary);
    primitiveQueryTypeForTimeStamp =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.TIMESTAMP,
            isDirectDictionary);
    primitiveQueryTypeForTimeStampForIsDictionaryFalse =
        new PrimitiveQueryType(name, parentName, blockIndex, DataTypes.TIMESTAMP, false);
  }
