...
public class QueryStasticsRecorderImplTest {
  ...
  @BeforeClass public static void setUp() {
    QueryStatistic queryStatisticWithLOAD_BLOCKS_EXECUTOR = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithSCAN_BLOCKS_TIME = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithSCAN_BLOCKS_NUM = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithLOAD_DICTIONARY = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithRESULT_SIZE = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithEXECUTOR_PART = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithTOTAL_BLOCKLET_NUM = new QueryStatistic();
    ...
    QueryStatistic queryStatisticWithVALID_SCAN_BLOCKLET_NUM = new QueryStatistic();
