...
public class AndFilterExecuterImplTest {
    static AndFilterExecuterImpl andFilterExecuter;
    ...
    public static void setUp(){
        ...
        byte val = 6;
        final MultiDimKeyVarLengthEquiSplitGenerator multiDimKeyVarLengthEquiSplitGenerator = new MultiDimKeyVarLengthEquiSplitGenerator(arr,val);
        ...
        IncludeFilterExecuterImpl leftExecuter = new IncludeFilterExecuterImpl(dimColumnResolvedFilterInfo,segmentProperties);
        IncludeFilterExecuterImpl rightExecuter = new IncludeFilterExecuterImpl(dimColumnResolvedFilterInfo,segmentProperties);;

        andFilterExecuter = new AndFilterExecuterImpl(leftExecuter,rightExecuter);
    ...
    public void testApplyFilter() throws Exception{
        ...
        expected.flip(0);
        expected.flip(1);
        BitSet result = andFilterExecuter.applyFilter(blocksChunkHolder);
    ...
    public void testIsScanRequired(){
        ...
        expected.flip(0);
        expected.flip(1);
        BitSet result = andFilterExecuter.isScanRequired(byteArr,byteArr);
        assertEquals(expected,result);
    }
