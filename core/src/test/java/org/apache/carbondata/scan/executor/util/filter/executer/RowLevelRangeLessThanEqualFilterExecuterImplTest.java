...
public class RowLevelRangeLessThanEqualFilterExecuterImplTest {
  static RowLevelRangeLessThanEqualFilterExecuterImpl rowLevelRangeLessThanEqualFilterExecuterImpl;
  ...
  @BeforeClass public static void setUp() {
    ...
    carbonDimension.hasEncoding(Encoding.INVERTED_INDEX);
    ...
    rowLevelRangeLessThanEqualFilterExecuterImpl =
        new RowLevelRangeLessThanEqualFilterExecuterImpl(dimColumnResolvedFilterInfoList,
    ...
    new MockUp<ColumnGroupDimensionDataChunk>() {
      ...
      byte[] bytArr = { 1, 2, 3, 4, 5 };

      @SuppressWarnings("unused") @Mock public byte[] getChunkData(int columnIndex) {
        return bytArr;
      }

      @SuppressWarnings("unused") @Mock public byte[] getCompleteDataChunk() {
        return bytArr;
      }

      //DimensionChunkAttributes dimensionChunkAttribute = new DimensionChunkAttributes();

      @SuppressWarnings("unused") @Mock public DimensionChunkAttributes getAttributes() {
        return dimensionChunkAttributes;
      }

    };

    new MockUp<DimensionChunkAttributes>() {
      int[] intArr = { 1, 2, 3, 4, 5, 6 };

      @SuppressWarnings("unused") @Mock public int[] getInvertedIndexes() {
        return intArr;
      }
    };
  ...
  @Test public void testIsScanRequired() {
    ...
    expected.flip(0);
    BitSet result = rowLevelRangeLessThanEqualFilterExecuterImpl.isScanRequired(maxValue, minValue);
  ...
  @Test public void testApplyFilter() throws Exception {
    ...
    BitSet result = rowLevelRangeLessThanEqualFilterExecuterImpl.applyFilter(blocksChunkHolder);
    int expected = 2;
