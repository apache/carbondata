...
public class ExcludeFilterExecuterImplTest {
  ...
  @Test public void testApplyFilter() {
    ...
    excludeFilterExecuter =
        new ExcludeFilterExecuterImpl(dimColumnResolvedFilterInfo, segmentProperties);
  ...
  @Test public void testApplyFilterWithVariableLengthDimensionI() {
    ...
    columnSchema3.setEncodingList(Collections.<Encoding>emptyList());
    CarbonDimension carbonDimension = new CarbonDimension(columnSchema3, 0, -1, -1, -1);
  ...
  @Test public void testApplyFilterWithFixedLengthDimensionI() {
    ...
    columnSchema4.setEncodingList(Collections.<Encoding>emptyList());
    CarbonDimension carbonDimension = new CarbonDimension(columnSchema4, 0, -1, -1, -1);
