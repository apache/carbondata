...
public final class FilterUtil {
   ...
   */
  private static org.apache.carbondata.scan.filter.executer.FilterExecuter createFilterExecuterTree(
      ...
      switch (filterExecuterType) {
        ...
        case EXCLUDE:
          return getExcludeFilterExecuter(
              filterExpressionResolverTree.getDimColResolvedFilterInfo(), segmentProperties);
        case OR:
          return new org.apache.carbondata.scan.filter.executer.OrFilterExecuterImpl(
        ...
        case AND:
          return new AndFilterExecuterImpl(
              ...
              createFilterExecuterTree(filterExpressionResolverTree.getRight(), segmentProperties,
                  complexDimensionInfoMap));
        case RESTRUCTURE:
          return new org.apache.carbondata.scan.filter.executer.RestructureFilterExecuterImpl(
        ...
        case ROWLEVEL:
        default:
          return new org.apache.carbondata.scan.filter.executer.RowLevelFilterExecuterImpl(
   ...
   * @return
   */
  private static org.apache.carbondata.scan.filter.executer.FilterExecuter getIncludeFilterExecuter(
    ...
    if (dimColResolvedFilterInfo.getDimension().isColumnar()) {
      return new org.apache.carbondata.scan.filter.executer
          .IncludeFilterExecuterImpl(dimColResolvedFilterInfo, segmentProperties);
    } else {
      return new org.apache.carbondata.scan.filter.executer
          .IncludeColGroupFilterExecuterImpl(dimColResolvedFilterInfo, segmentProperties);
    }
  }
   ...
   * @return
   */
  private static org.apache.carbondata.scan.filter.executer.FilterExecuter getExcludeFilterExecuter(
      DimColumnResolvedFilterInfo dimColResolvedFilterInfo, SegmentProperties segmentProperties) {
  ...
  public static DimColumnFilterInfo getFilterValues(AbsoluteTableIdentifier tableIdentifier,
                                                    ...
                                                    List<String> evaluateResultList,
  ...
  public static DimColumnFilterInfo getFilterListForRS(Expression expression,
                                                       ColumnExpression columnExpression,
                                                       String defaultValues, int defaultSurrogate)
      throws FilterUnsupportedException {
  ...
  private static long getMaxValue(AbsoluteTableIdentifier tableIdentifier,
                                  CarbonDimension carbonDimension, int[] dimCarinality)
      throws QueryExecutionException {
  ...
  public static IndexKey createIndexKeyFromResolvedFilterVal(long[] startOrEndKey,
                                                             KeyGenerator keyGenerator,
                                                             byte[] startOrEndKeyForNoDictDimension)
  {
   ...
   * @return
   */
  public static org.apache.carbondata.scan.filter.executer.FilterExecuter getFilterExecuterTree(
      FilterResolverIntf filterExpressionResolverTree, SegmentProperties segmentProperties,
      Map<Integer, GenericQueryType> complexDimensionInfoMap) {
  ...
  public static void traverseResolverTreeAndGetStartAndEndKey(SegmentProperties segmentProperties,
                                                            ...
                                                            List<IndexKey> listOfStartEndKeys)
      throws QueryExecutionException {
