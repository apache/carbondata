...
public class StartsWithExpression extends BinaryConditionalExpression {
  ...
  public StartsWithExpression(Expression left, Expression right, boolean isNull) {
    super(left, right);
    this.isNull = isNull;
  }
  ...
  @Override public ExpressionResult evaluate(RowIntf value)
    ...
    switch (val1.getDataType()) {
      case STRING:
        result = val1.getString().startsWith(val2.getString());
        break;
      case SHORT:
        result = val1.getShort().toString().startsWith(val2.getShort().toString());
        break;
      case INT:
        result = val1.getInt().toString().startsWith(val2.getInt().toString());
        break;
      case DOUBLE:
        result = val1.getDouble().toString().startsWith(val2.getDouble().toString());
        break;
      case TIMESTAMP:
        result = val1.getTime().toString().startsWith(val2.getTime().toString());
        break;
      case LONG:
        result = val1.getLong().toString().startsWith(val2.getLong().toString());
        break;
      case DECIMAL:
        result = val1.getDecimal().toEngineeringString()
         .startsWith(val2.getDecimal().toEngineeringString());
        break;
      default:
