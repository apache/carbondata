...
public abstract class IndexExprWrapper implements Serializable {
  ...
  /**
   * It get the blocklets from each leaf node and apply expressions on the blocklets
   ...
   * @throws IOException
   */
  public abstract List<ExtendedBlocklet> prune(IndexDistributable distributable,
      List<PartitionSpec> partitionsToPrune) throws IOException;
   ...
   * @throws IOException
   */
  public abstract List<IndexDistributableWrapper> toDistributable(List<Segment> segments)
      throws IOException;
