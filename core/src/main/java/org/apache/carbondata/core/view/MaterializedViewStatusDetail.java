...
public class MaterializedViewStatusDetail implements Serializable {
  ...
  MaterializedViewStatusDetail(RelationIdentifier identifier, MaterializedViewStatus status) {
  ...
  public MaterializedViewStatus getStatus() {
    return status;
  }

  public boolean isEnabled() {
    return status == MaterializedViewStatus.ENABLED;
  }
