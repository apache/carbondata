...
public class PartitionStatistic {
  ...
  public void setPartitionIdToRowCountMap(int partitionId, int rowCount) {
    this.partitionIdToRowCountMap.put(partitionId, rowCount);
  }

  public int getPartitionRowCount(int partitionId) {
    return partitionIdToRowCountMap.get(partitionId);
  }
}
