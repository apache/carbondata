...
/**
 * Responsible for storing long array data to memory.
 * memory can be on heap or offheap based on the user configuration
 */
public class LongMeasureChunkStore extends AbstractMeasureDataChunkStore<long[]> {

  public LongMeasureChunkStore(int numberOfRows) {
    super(numberOfRows);
  }
