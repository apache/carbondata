...
package org.apache.carbondata.core.datamap.dev.cgindex;
 ...
 *  1. Any filter query which hits the table with index will call prune method of CG index.
 *  2. The prune method of CG index return list Blocklet , these blocklets contain the
