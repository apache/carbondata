...
public class CarbonTable implements Serializable {
  ...
  private Map<String, PartitionStatistic> tablePartitionStatMap;
  ...
  public CarbonTable() {
    ...
    this.tablePartitionStatMap = new HashMap<>();
  ...
  public PartitionStatistic getPartitionStatistic(String tableName) {
    return tablePartitionStatMap.get(tableName);
  }
  ...
  /**
   * get actual partition count for this table
   */
  public int getPartitionCount() {
    return tablePartitionStatMap
        .get(absoluteTableIdentifier.getCarbonTableIdentifier().getTableName())
