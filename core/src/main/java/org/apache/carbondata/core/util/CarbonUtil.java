...
public final class CarbonUtil {
  ...
  public static int nextGreaterValueToTarget(int currentIndex,
                                             FixedLengthDimensionDataChunk dimColumnDataChunk,
                                             byte[] compareValue, int numerOfRows) {
   ...
   * @return
   */
  public static org.apache.carbondata.format.DataType fromWrapperToExternalDataType(DataType
                                                                                        dataType) {
   ...
   * @return
   */
  public static DataType fromExternalToWrapperDataType(org.apache.carbondata.format.DataType
                                                           dataType) {
    if (null == dataType) {
      return null;
    }
