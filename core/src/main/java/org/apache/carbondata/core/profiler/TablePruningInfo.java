    ...
    if (showPruningInfo) {
      ...
      if (cgIndex != null) {
        ...
        builder
            ...
            .append("    - name: ").append(cgIndex.getDataMapWrapperName()).append("\n")
            .append("    - provider: ").append(cgIndex.getDataMapWrapperProvider()).append("\n")
            .append("    - skipped: ").append(skipBlocks).append(" blocks, ")
            .append(skipBlocklets).append(" blocklets").append("\n");
      }
      if (fgIndex != null) {
        ...
        builder
            ...
            .append("    - name: ").append(fgIndex.getDataMapWrapperName()).append("\n")
            .append("    - provider: ").append(fgIndex.getDataMapWrapperProvider()).append("\n")
            .append("    - skipped: ").append(skipBlocks).append(" blocks, ")
            .append(skipBlocklets).append(" blocklets").append("\n");
      }
