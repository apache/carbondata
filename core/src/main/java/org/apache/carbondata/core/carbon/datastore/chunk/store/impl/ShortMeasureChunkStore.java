...
/**
 * Responsible for storing short array data to memory.
 * memory can be on heap or offheap based on the user configuration
 */
public class ShortMeasureChunkStore extends AbstractMeasureDataChunkStore<short[]> {

  public ShortMeasureChunkStore(int numberOfRows) {
    super(numberOfRows);
  }
