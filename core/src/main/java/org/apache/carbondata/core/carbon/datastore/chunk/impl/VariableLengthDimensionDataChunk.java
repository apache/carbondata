...
import org.apache.carbondata.core.carbon.datastore.chunk.store.impl.VariableLengthDimesionDataChunkStore;
...
public class VariableLengthDimensionDataChunk extends AbstractDimensionDataChunk {
  ...
  public VariableLengthDimensionDataChunk(byte[] dataChunks, int[] invertedIndex,
    ...
    dataChunkStore =
        new VariableLengthDimesionDataChunkStore(dataChunks.length, null != invertedIndex,
            numberOfRows);
