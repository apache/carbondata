...
public class CarbonDataReaderFactory {
  ...
  public DimensionColumnChunkReader getDimensionColumnChunkReader(ColumnarFormatVersion version,
    ...
    switch (version) {
      case V1:
        return new CompressedDimensionChunkFileBasedReaderV1(blockletInfo, filePath);
      case V2:
        return new CompressedDimensionChunkFileBasedReaderV2(blockletInfo, filePath);
      case V3:
        if (readPagebyPage) {
          return new CompressedDimChunkFileBasedPageLevelReaderV3(blockletInfo, filePath);
        } else {
          return new CompressedDimensionChunkFileBasedReaderV3(blockletInfo, filePath);
        }
      default:
