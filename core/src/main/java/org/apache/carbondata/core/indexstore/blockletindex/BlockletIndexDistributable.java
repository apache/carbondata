 ...
 * one index task.
 */
public class BlockletIndexDistributable extends IndexDistributable {
  ...
  public BlockletIndexDistributable() {

  }

  public BlockletIndexDistributable(String indexFilePath) {
