...
/**
 * Responsible for storing double array data to memory.
 * memory can be on heap or offheap based on the user configuration
 */
public class DoubleMeasureChunkStore extends AbstractMeasureDataChunkStore<double[]> {

  public DoubleMeasureChunkStore(int numberOfRows) {
    super(numberOfRows);
  }
