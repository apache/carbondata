...
public interface DataMapWriter {
   ...
   */
  void onBlockStart(String blockId) throws IOException;

  /**
   * End of block notification
   */
  void onBlockEnd(String blockId) throws IOException;
   ...
   */
  void onPageAdded(int blockletId, int pageId, ColumnPage[] pages) throws IOException;
