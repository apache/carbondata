 ...
 * <p>
 * {@code
 *  CREATE INDEX dm ON table
 *  AS 'short-name-of-the-index'
 * }
...
public class IndexRegistry {
  ...
  public static IndexFactory<? extends Index> getIndexFactoryByShortName(
    ...
    try {
      registerIndex(
          IndexProviderName.get(providerName).getClassName(),
          IndexProviderName.get(providerName).getShortName());
