...
public interface CacheableIndex {
   ...
   * @return
   */
  List<IndexDistributable> getAllUncachedDistributables(List<IndexDistributable> distributables)
      throws IOException;

  List<IndexDistributable> getAllUncachedDistributables(
      List<Segment> segments, IndexExprWrapper indexExprWrapper) throws IOException;

  void updateSegmentIndex(Map<String, Set<TableBlockIndexUniqueIdentifier>> indexUniqueIdentifier);
}