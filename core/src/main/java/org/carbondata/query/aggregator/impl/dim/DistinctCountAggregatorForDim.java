 ...
 *
 */
package org.carbondata.query.aggregator.impl.dim;
...
public class DistinctCountAggregatorForDim implements MeasureAggregator {
    ...
    private HashSet<ByteArrayWrapper> valueSetForDim =
            new HashSet<ByteArrayWrapper>(MolapCommonConstants.DEFAULT_COLLECTION_SIZE);
