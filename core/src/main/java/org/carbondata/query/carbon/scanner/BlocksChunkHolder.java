...
public class BlocksChunkHolder {
	...
	public BlocksChunkHolder(int numberOfDimensionBlock,
			int numberOfMeasureBlock) {
	...
	/**
	 * @param dimensionDataChunk
	 *            the dimensionDataChunk to set
	 */
	public void setDimensionDataChunk(
			DimensionColumnDataChunk[] dimensionDataChunk) {
	...
	/**
	 * @param measureDataChunk
	 *            the measureDataChunk to set
	 */
