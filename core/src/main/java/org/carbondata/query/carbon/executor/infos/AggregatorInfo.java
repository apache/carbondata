...
public class AggregatorInfo {
	...
	/**
	 * In carbon there are three type of aggregation (dimension aggregation, expression aggregation and measure aggregation)
	 * Below index will be used to set the start position of expression in measures aggregator array  
	 */
	private int expressionAggregatorStartIndex;
	
	/**
	 * In carbon there are three type of aggregation (dimension aggregation, expression aggregation and measure aggregation)
	 * Below index will be used to set the start position of measures in measures aggregator array  
	 */
