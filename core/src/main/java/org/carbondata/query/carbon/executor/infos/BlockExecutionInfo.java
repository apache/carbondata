...
public class BlockExecutionInfo {
	...
	/**
	 * @param isFixedKeyUpdateRequired
	...
	/**
	 * @param aggregatorInfo
	 *            the aggregatorInfos to set
	 */
	...
	/**
	 * @param customAggregateExpression
	...
	/**
	 * @param maskedByteForBlock
	 *            the maskedByteForBlock to set
	 */
	...
	/**
	 * @param totalNumberDimensionBlock
	 *            the totalNumberDimensionBlock to set
	 */
	...
	/**
	 * @param totalNumberOfMeasureBlock
	 *            the totalNumberOfMeasureBlock to set
	 */
	...
	/**
	 * @param allSelectedDimensionBlocksIndexes
	 *            the allSelectedDimensionBlocksIndexes to set
	 */
	public void setAllSelectedDimensionBlocksIndexes(
	 ...
	 *            the allSelectedMeasureBlocksIndexes to set
	 */
	public void setAllSelectedMeasureBlocksIndexes(
	...
	/**
	 * @param restructureInfos
	 *            the restructureInfos to set
	 */
	...
	/**
	 * @param scannedResultProcessor
	 *            the scannedResultProcessor to set
	 */
	public void setScannedResultProcessor(
	...
	/**
	 * @param tableBlockKeyGenerator
	 *            the tableBlockKeyGenerator to set
	 */
	...
	/**
	 * @param dimensionAggregator
	 *            the dimensionAggregator to set
	 */
	public void setDimensionAggregator(
			List<DimensionDataAggregator> dimensionAggregator) {
	 ...
	 *            the eachColumnValueSize to set
	 */
	...
	/**
	 * @param dictionaryColumnBlockIndex
	 *            the dictionaryColumnBlockIndex to set
	 */
	...
	/**
	 * @param noDictionaryBlockIndexes
	...
	/**
	 * @param measureColumnStartIndex
	 *            the measureColumnStartIndex to set
	 */
	...
	/**
	 * @param expressionStartIndex
	 *            the expressionStartIndex to set
	 */
	...
	/**
	 * @param columnGroupToKeyStructureInfo
	 *            the columnGroupToKeyStructureInfo to set
	 */
	...
	/**
	 * @param columnIdToDcitionaryMapping
	 *            the columnIdToDcitionaryMapping to set
	 */
	public void setColumnIdToDcitionaryMapping(
			Map<String, Dictionary> columnIdToDcitionaryMapping) {
