...
public class RestructureUtil {
	...
	public static List<CarbonDimension> getUpdatedQueryDimension(
		...
		List<CarbonDimension> presentDimension = new ArrayList<CarbonDimension>(
	 ...
	 * 
	 * @param queryDimensions
	 * 			current query dimensions
	 * @param tableBlockDimensions
	 * 			dimensions which is present in the table block 
	 ...
	 * 			current block measures 
	 * @return aggregator info
	 */
	public static AggregatorInfo getAggregatorInfos(
