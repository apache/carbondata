...
public class MolapSegmentArrayQuerySpec //extends SegmentArrayQuerySpec
{
    ...
    //     */
    //    MolapSegmentArrayQuerySpec(GroupingSetsList groupingSetsList, List<StarPredicate> compoundPredicateList)
    //    {
    //        super(groupingSetsList, compoundPredicateList);
