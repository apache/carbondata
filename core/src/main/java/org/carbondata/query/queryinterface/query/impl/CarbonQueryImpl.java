...
public class CarbonQueryImpl implements CarbonQuery {
     ...
     */
    @Override
    public void addDimensionLevel(CarbonDimensionLevel dimensionLevel,
     ...
     */
    @Override
    public void addMeasure(CarbonMeasure measure, List<CarbonMeasureFilter> filters,
            SortType sortType) {
        sortType = sortType == null ? SortType.NONE : sortType;
     ...
     */
    @Override
    public void addSlice(CarbonDimensionLevel dimensionLevel, CarbonDimensionLevelFilter filter) {
     ...
     */
    @Override
    public void addSlice(CarbonMeasure measure, List<CarbonMeasureFilter> filters) {
     ...
     */
    @Override
    public void addTopCount(CarbonDimensionLevel dimensionLevel, CarbonMeasure measure, int count) {
     ...
     */
    @Override
    public void addBottomCount(CarbonDimensionLevel dimensionLevel, CarbonMeasure measure,
            int count) {
