...
public class MolapLevelHolder implements Serializable {
     ...
     * sortType
     */
    private MolapQuery.SortType sortType;
     ...
     * @param sortType
     */
    public MolapLevelHolder(MolapLevel level, MolapQuery.SortType sortType) {
        super();
        this.level = level;
     ...
     * @return the sortType
     */
    public MolapQuery.SortType getSortType() {
        return sortType;
    }
     ...
     */
    public void setSortType(MolapQuery.SortType sortType) {
        this.sortType = sortType;
    }
