...
public class MolapFilterInfo implements Serializable {
     ...
     */
    public MolapFilterInfo(List<String> exludedMembers, List<String> includedMembers) {
        super();
    ...
    @Override public boolean equals(Object obj) {
        if (obj instanceof MolapFilterInfo) {

            if (this == obj) {
                return true;
            }

            MolapFilterInfo info = (MolapFilterInfo) obj;
