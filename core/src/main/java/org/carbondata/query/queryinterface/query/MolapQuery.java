...
import org.carbondata.query.queryinterface.query.metadata.MolapDimensionLevel;
import org.carbondata.query.queryinterface.query.metadata.MolapDimensionLevelFilter;
import org.carbondata.query.queryinterface.query.metadata.MolapMeasure;
import org.carbondata.query.queryinterface.query.metadata.MolapMeasureFilter;
...
public interface MolapQuery extends Serializable {
     ...
     * @param axis
     */
    void addDimensionLevel(MolapDimensionLevel dimensionLevel, MolapDimensionLevelFilter filter,
