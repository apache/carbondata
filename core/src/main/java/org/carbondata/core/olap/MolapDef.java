...
public class MolapDef {
    ...
    public static String[] _elements =
            { "Schema", "CubeDimension", "Cube", "VirtualCube", "CubeUsages", "CubeUsage",
                    "VirtualCubeDimension", "VirtualCubeMeasure", "DimensionUsage", "Dimension",
                    "Hierarchy", "Level", "Closure", "Property", "Measure", "CalculatedMember",
                    ...
                    "AggIgnoreColumn", "AggForeignKey", "AggLevel", "DataRetentionPolicy",
                    ...
                    "UserDefinedFunction", "Parameter", "Annotations", "Annotation", "Script",
                    "CellFormatter", "MemberFormatter", "PropertyFormatter" };
    ...
    public static class Schema extends org.eigenbase.xom.ElementDef {
        ...
        public Schema(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                measuresCaption = (String) _parser
                        .getAttribute("measuresCaption", "String", null, null, false);
                defaultRole =
                        (String) _parser.getAttribute("defaultRole", "String", null, null, false);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("caption", caption, _cother.caption, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("measuresCaption", measuresCaption,
                    _cother.measuresCaption, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("defaultRole", defaultRole, _cother.defaultRole,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("parameters", parameters, _cother.parameters,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("dimensions", dimensions, _cother.dimensions,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("cubes", cubes, _cother.cubes, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("virtualCubes", virtualCubes,
                    _cother.virtualCubes, _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("namedSets", namedSets, _cother.namedSets,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("roles", roles, _cother.roles, _out,
                    _indent + 1);
    ...
    public static abstract class CubeDimension extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("caption", caption, _cother.caption, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("visible", visible, _cother.visible, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
    ...
    public static class Cube extends org.eigenbase.xom.ElementDef {
        ...
        public Cube(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                description =
                        (String) _parser.getAttribute("description", "String", null, null, false);
                defaultMeasure = (String) _parser
                        .getAttribute("defaultMeasure", "String", null, null, false);
                ...
                autoAggregationType = (String) _parser
                        .getAttribute("autoAggregationType", "String", "NONE", null, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Cube",
                    new org.eigenbase.xom.XMLAttrVector().add("name", name).add("caption", caption)
                            ...
                            .add("enabled", enabled).add("autoAggregationType", autoAggregationType)
                            .add("mode", mode));
            displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("defaultMeasure", defaultMeasure,
                    _cother.defaultMeasure, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("cache", cache, _cother.cache, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("enabled", enabled, _cother.enabled, _out,
                    _indent + 1);
    ...
    public static class VirtualCube extends org.eigenbase.xom.ElementDef {
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("VirtualCube",
                    new org.eigenbase.xom.XMLAttrVector().add("enabled", enabled).add("name", name)
                            .add("defaultMeasure", defaultMeasure).add("caption", caption)
                            .add("visible", visible).add("description", description));
            displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("enabled", enabled, _cother.enabled, _out, _indent + 1);
            ...
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("cubeUsage", cubeUsage, _cother.cubeUsage, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("dimensions", dimensions, _cother.dimensions,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("measures", measures, _cother.measures, _out,
    ...
    public static class CubeUsages extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("cubeUsages", cubeUsages, _cother.cubeUsages, _out,
                            _indent + 1);
            return _diff;
        }
    }
    ...
    public static class CubeUsage extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("ignoreUnrelatedDimensions",
    ...
    public static class VirtualCubeMeasure extends org.eigenbase.xom.ElementDef {
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("VirtualCubeMeasure",
                    new org.eigenbase.xom.XMLAttrVector().add("cubeName", cubeName)
                            .add("name", name).add("visible", visible));
            displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
    ...
    public static class DimensionUsage extends CubeDimension {
        ...
        public DimensionUsage(org.eigenbase.xom.DOMWrapper _def)
            ...
            try {
                ...
                usagePrefix =
                        (String) _parser.getAttribute("usagePrefix", "String", null, null, false);
                name = (String) _parser.getAttribute("name", "String", null, null, true);
                caption = (String) _parser.getAttribute("caption", "String", null, null, false);
                visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true", null, false);
                description =
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("source", source, _cother.source, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("level", level, _cother.level, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("usagePrefix", usagePrefix, _cother.usagePrefix,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            return _diff;
    ...
    public static class Dimension extends CubeDimension {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("hierarchies", hierarchies,
    ...
    public static class Hierarchy extends org.eigenbase.xom.ElementDef {
        ...
        public Hierarchy(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                allMemberName =
                        (String) _parser.getAttribute("allMemberName", "String", null, null, false);
                allMemberCaption = (String) _parser
                        .getAttribute("allMemberCaption", "String", null, null, false);
                allLevelName =
                        (String) _parser.getAttribute("allLevelName", "String", null, null, false);
                primaryKey =
                        (String) _parser.getAttribute("primaryKey", "String", null, null, false);
                primaryKeyTable = (String) _parser
                        .getAttribute("primaryKeyTable", "String", null, null, false);
                defaultMember =
                        (String) _parser.getAttribute("defaultMember", "String", null, null, false);
                memberReaderClass = (String) _parser
                        .getAttribute("memberReaderClass", "String", null, null, false);
                caption = (String) _parser.getAttribute("caption", "String", null, null, false);
                description =
                        (String) _parser.getAttribute("description", "String", null, null, false);
                uniqueKeyLevelName = (String) _parser
                        .getAttribute("uniqueKeyLevelName", "String", null, null, false);
                normalized = (Boolean) _parser
                        .getAttribute("normalized", "Boolean", "false", null, false);
                annotations = (Annotations) _parser.getElement(Annotations.class, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Hierarchy",
                    new org.eigenbase.xom.XMLAttrVector().add("name", name).add("visible", visible)
                            ...
                            .add("memberReaderClass", memberReaderClass).add("caption", caption)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("visible", visible, _cother.visible, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("hasAll", hasAll, _cother.hasAll, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("allMemberName", allMemberName,
            ...
            _diff = _diff && displayAttributeDiff("allLevelName", allLevelName,
                    _cother.allLevelName, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("primaryKey", primaryKey, _cother.primaryKey,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("primaryKeyTable", primaryKeyTable,
                    _cother.primaryKeyTable, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("defaultMember", defaultMember,
            ...
            _diff = _diff && displayAttributeDiff("normalized", normalized, _cother.normalized,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("relation", relation, _cother.relation, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("levels", levels, _cother.levels, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("memberReaderParameters",
                    memberReaderParameters, _cother.memberReaderParameters, _out, _indent + 1);
            return _diff;
        }
    }
    ...
    public static class Level extends org.eigenbase.xom.ElementDef {
        ...
        public static final String[] _levelType_values =
                { "Regular", "TimeYears", "TimeHalfYears", "TimeHalfYear", "TimeQuarters",
                        "TimeMonths", "TimeWeeks", "TimeDays", "TimeHours", "TimeMinutes",
                        "TimeSeconds", "TimeUndefined" };
        /**
        ...
        public Level(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                org.eigenbase.xom.NodeDef[] _tempArray;
                approxRowCount = (String) _parser
                        .getAttribute("approxRowCount", "String", null, null, false);
                name = (String) _parser.getAttribute("name", "String", null, null, false);
                parentname =
                        (String) _parser.getAttribute("parentname", "String", null, null, false);
                visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true", null, false);
                columnIndex =
                        (Integer) _parser.getAttribute("columnIndex", "Integer", "-1", null, false);
                keyOrdinal =
                        (Integer) _parser.getAttribute("keyOrdinal", "Integer", "-1", null, false);
                levelCardinality = (Integer) _parser
                        .getAttribute("levelCardinality", "Integer", "-1", null, false);
                ordinalColumnIndex = (Integer) _parser
                        .getAttribute("ordinalColumnIndex", "Integer", "-1", null, false);
                nameColumnIndex = (Integer) _parser
                        .getAttribute("nameColumnIndex", "Integer", "-1", null, false);
                ...
                nameColumn =
                        (String) _parser.getAttribute("nameColumn", "String", null, null, false);
                ordinalColumn =
                        (String) _parser.getAttribute("ordinalColumn", "String", null, null, false);
                parentColumn =
                        (String) _parser.getAttribute("parentColumn", "String", null, null, false);
                nullParentValue = (String) _parser
                        .getAttribute("nullParentValue", "String", null, null, false);
                type = (String) _parser
                        .getAttribute("type", "String", "String", _type_values, false);
                ...
                columnar =
                        (Boolean) _parser.getAttribute("columnar", "Boolean", "false", null, true);
                levelType = (String) _parser
                        .getAttribute("levelType", "String", "Regular", _levelType_values, false);
                hideMemberIf = (String) _parser
                        .getAttribute("hideMemberIf", "String", "Never", _hideMemberIf_values,
                                false);
                formatter = (String) _parser.getAttribute("formatter", "String", null, null, false);
                isParent =
                        (Boolean) _parser.getAttribute("isParent", "Boolean", "true", null, false);
                caption = (String) _parser.getAttribute("caption", "String", null, null, false);
                description =
                        (String) _parser.getAttribute("description", "String", null, null, false);
                captionColumn =
                        (String) _parser.getAttribute("captionColumn", "String", null, null, false);
                annotations = (Annotations) _parser.getElement(Annotations.class, false);
                ...
                memberFormatter =
                        (MemberFormatter) _parser.getElement(MemberFormatter.class, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Level",
                    new org.eigenbase.xom.XMLAttrVector().add("approxRowCount", approxRowCount)
                            ...
                            .add("ordinalColumnIndex", ordinalColumnIndex)
                            .add("nameColumnIndex", nameColumnIndex).add("table", table)
                            ...
                            .add("isParent", isParent).add("caption", caption)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("approxRowCount", approxRowCount, _cother.approxRowCount,
                            _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("name", name, _cother.name, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("parentname", parentname, _cother.parentname,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("visible", visible, _cother.visible, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("columnIndex", columnIndex, _cother.columnIndex,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("keyOrdinal", keyOrdinal, _cother.keyOrdinal,
                    _out, _indent + 1);
            ...
            _diff = _diff && displayAttributeDiff("nameColumnIndex", nameColumnIndex,
                    _cother.nameColumnIndex, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("table", table, _cother.table, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("column", column, _cother.column, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("nameColumn", nameColumn, _cother.nameColumn,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("ordinalColumn", ordinalColumn,
                    _cother.ordinalColumn, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("parentColumn", parentColumn,
                    _cother.parentColumn, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("nullParentValue", nullParentValue,
            ...
            _diff = _diff && displayAttributeDiff("columnar", columnar, _cother.columnar, _out,
                    _indent + 1);
            ...
            _diff = _diff && displayAttributeDiff("formatter", formatter, _cother.formatter, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("isParent", isParent, _cother.isParent, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("caption", caption, _cother.caption, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("captionColumn", captionColumn,
                    _cother.captionColumn, _out, _indent + 1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("keyExp", keyExp, _cother.keyExp, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("nameExp", nameExp, _cother.nameExp, _out,
                    _indent + 1);
            ...
            _diff = _diff && displayElementDiff("ordinalExp", ordinalExp, _cother.ordinalExp, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("parentExp", parentExp, _cother.parentExp, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("memberFormatter", memberFormatter,
                    _cother.memberFormatter, _out, _indent + 1);
            _diff = _diff && displayElementDiff("closure", closure, _cother.closure, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("properties", properties, _cother.properties,
                    _out, _indent + 1);
            return _diff;
        }
    ...
    public static class Closure extends org.eigenbase.xom.ElementDef {
        ...
        public Closure(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                parentColumn =
                        (String) _parser.getAttribute("parentColumn", "String", null, null, true);
                childColumn =
                        (String) _parser.getAttribute("childColumn", "String", null, null, true);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("parentColumn", parentColumn, _cother.parentColumn, _out,
                            _indent + 1);
            _diff = _diff && displayAttributeDiff("childColumn", childColumn, _cother.childColumn,
                    _out, _indent + 1);
    ...
    public static class Property extends org.eigenbase.xom.ElementDef {
        ...
        public Property(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                columnIndex =
                        (Integer) _parser.getAttribute("columnIndex", "Integer", "-1", null, false);
                dependsOnLevelValue = (Boolean) _parser
                        .getAttribute("dependsOnLevelValue", "Boolean", null, null, false);
                propertyFormatter =
                        (PropertyFormatter) _parser.getElement(PropertyFormatter.class, false);
            } catch (org.eigenbase.xom.XOMException _ex) {
                throw new org.eigenbase.xom.XOMException(
                        "In " + getName() + ": " + _ex.getMessage());
            }
    ...
    public static class Measure extends org.eigenbase.xom.ElementDef {
        ...
        public Measure(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                name = (String) _parser.getAttribute("name", "String", null, null, true);
                column = (String) _parser.getAttribute("column", "String", null, null, false);
                datatype = (String) _parser
                        .getAttribute("datatype", "String", null, _datatype_values, false);
                dataTypeClass =
                        (String) _parser.getAttribute("dataTypeClass", "String", null, null, false);
                formatString =
                        (String) _parser.getAttribute("formatString", "String", null, null, false);
                columnIndex =
                        (Integer) _parser.getAttribute("columnIndex", "Integer", null, null, false);
                aggregator =
                        (String) _parser.getAttribute("aggregator", "String", null, null, true);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Measure",
                    new org.eigenbase.xom.XMLAttrVector().add("name", name).add("column", column)
                            ...
                            .add("aggregator", aggregator).add("aggClass", aggClass)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("column", column, _cother.column, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("datatype", datatype, _cother.datatype, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("dataTypeClass", dataTypeClass,
                    _cother.dataTypeClass, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("formatString", formatString,
                    _cother.formatString, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("columnIndex", columnIndex, _cother.columnIndex,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("aggregator", aggregator, _cother.aggregator,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("aggClass", aggClass, _cother.aggClass, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("formatter", formatter, _cother.formatter, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("caption", caption, _cother.caption, _out,
            ...
            _diff = _diff && displayElementDiff("measureExp", measureExp, _cother.measureExp, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("cellFormatter", cellFormatter,
    ...
    public static class CalculatedMember extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("formula", formula, _cother.formula, _out,
                    _indent + 1);
            ...
            _diff = _diff && displayAttributeDiff("hierarchy", hierarchy, _cother.hierarchy, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("parent", parent, _cother.parent, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("visible", visible, _cother.visible, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementDiff("formulaElement", formulaElement,
    ...
    public static class CalculatedMemberProperty extends org.eigenbase.xom.ElementDef {
        ...
        public CalculatedMemberProperty(org.eigenbase.xom.DOMWrapper _def)
            ...
            try {
                ...
                description =
                        (String) _parser.getAttribute("description", "String", null, null, false);
                expression =
                        (String) _parser.getAttribute("expression", "String", null, null, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("CalculatedMemberProperty",
                    new org.eigenbase.xom.XMLAttrVector().add("name", name).add("caption", caption)
                            .add("description", description).add("expression", expression)
                            .add("value", value));
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("expression", expression, _cother.expression,
                    _out, _indent + 1);
    ...
    public static class View extends Relation {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayElementArrayDiff("selects", selects, _cother.selects, _out,
                    _indent + 1);
            return _diff;
        }
    ...
    public static class SQL extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("dialect", dialect, _cother.dialect, _out, _indent + 1);
    ...
    public static class Join extends RelationOrJoin {
        ...
        public Join(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                rightAlias =
                        (String) _parser.getAttribute("rightAlias", "String", null, null, false);
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Join", new org.eigenbase.xom.XMLAttrVector().add("leftAlias", leftAlias)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("leftAlias", leftAlias, _cother.leftAlias, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("leftKey", leftKey, _cother.leftKey, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("rightAlias", rightAlias, _cother.rightAlias,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("rightKey", rightKey, _cother.rightKey, _out,
                    _indent + 1);
    ...
    public static class Table extends Relation {
        ...
        public Table(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                dataRetention =
                        (DataRetentionPolicy) _parser.getElement(DataRetentionPolicy.class, false);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("name", name, _cother.name, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("schema", schema, _cother.schema, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("alias", alias, _cother.alias, _out, _indent + 1);
            _diff = _diff && displayElementDiff("filter", filter, _cother.filter, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("dataRetention", dataRetention,
                    _cother.dataRetention, _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("aggExcludes", aggExcludes,
                    _cother.aggExcludes, _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("aggTables", aggTables, _cother.aggTables,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("tableHints", tableHints, _cother.tableHints,
                    _out, _indent + 1);
            return _diff;
        }
    ...
    public static class ColumnDefs extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("array", array, _cother.array, _out, _indent + 1);
            return _diff;
        }
    }
    ...
    public static class Row extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("values", values, _cother.values, _out, _indent + 1);
            return _diff;
        }
    }
    ...
    public static abstract class AggTable extends org.eigenbase.xom.ElementDef {
        ...
        public AggTable(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                org.eigenbase.xom.NodeDef[] _tempArray;
                ignorecase = (Boolean) _parser
                        .getAttribute("ignorecase", "Boolean", "true", null, false);
                dataRetention =
                        (DataRetentionPolicy) _parser.getElement(DataRetentionPolicy.class, false);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("ignorecase", ignorecase, _cother.ignorecase, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("dataRetention", dataRetention,
                    _cother.dataRetention, _out, _indent + 1);
            _diff = _diff && displayElementDiff("factcount", factcount, _cother.factcount, _out,
                    _indent + 1);
            _diff = _diff && displayElementArrayDiff("ignoreColumns", ignoreColumns,
                    _cother.ignoreColumns, _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("foreignKeys", foreignKeys,
    ...
    public static class AggName extends AggTable {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("name", name, _cother.name, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("approxRowCount", approxRowCount,
    ...
    public static class AggPattern extends AggTable {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("pattern", pattern, _cother.pattern, _out, _indent + 1);
            _diff = _diff && displayElementDiff("dataRetention", dataRetention,
                    _cother.dataRetention, _out, _indent + 1);
            _diff = _diff && displayElementDiff("factcount", factcount, _cother.factcount, _out,
                    _indent + 1);
    ...
    public static class AggExclude extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("pattern", pattern, _cother.pattern, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("name", name, _cother.name, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("ignorecase", ignorecase, _cother.ignorecase,
                    _out, _indent + 1);
            return _diff;
        }
    ...
    public static class AggForeignKey extends org.eigenbase.xom.ElementDef {
        ...
        public AggForeignKey(org.eigenbase.xom.DOMWrapper _def)
            ...
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                factColumn =
                        (String) _parser.getAttribute("factColumn", "String", null, null, true);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("factColumn", factColumn, _cother.factColumn, _out,
                    _indent + 1);
    ...
    public static class DataRetentionPolicy extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("period", period, _cother.period, _out,
                    _indent + 1);
            return _diff;
        }
    ...
    public static abstract class ExpressionView extends org.eigenbase.xom.ElementDef
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("expressions", expressions, _cother.expressions, _out,
                            _indent + 1);
            return _diff;
        }
    ...
    public static class Role extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayElementDiff("annotations", annotations, _cother.annotations,
                    _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("schemaGrants", schemaGrants,
    ...
    public static class SchemaGrant extends org.eigenbase.xom.ElementDef implements Grant {
        ...
        public SchemaGrant(org.eigenbase.xom.DOMWrapper _def)
            ...
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                org.eigenbase.xom.NodeDef[] _tempArray;
                access = (String) _parser
                        .getAttribute("access", "String", null, _access_values, true);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("cubeGrants", cubeGrants, _cother.cubeGrants, _out,
                            _indent + 1);
            return _diff;
        }
    }
    ...
    public static class DimensionGrant extends org.eigenbase.xom.ElementDef implements Grant {
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("DimensionGrant",
                    new org.eigenbase.xom.XMLAttrVector().add("dimension", dimension)
                            .add("access", access));
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("dimension", dimension, _cother.dimension, _out,
                    _indent + 1);
            return _diff;
        }
    }
    ...
    public static class HierarchyGrant extends org.eigenbase.xom.ElementDef implements Grant {
        ...
        public HierarchyGrant(org.eigenbase.xom.DOMWrapper _def)
            ...
            try {
                ...
                bottomLevel =
                        (String) _parser.getAttribute("bottomLevel", "String", null, null, false);
                rollupPolicy =
                        (String) _parser.getAttribute("rollupPolicy", "String", null, null, false);
                access = (String) _parser
                        .getAttribute("access", "String", null, _access_values, true);
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("hierarchy", hierarchy, _cother.hierarchy, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("topLevel", topLevel, _cother.topLevel, _out,
                    _indent + 1);
            _diff = _diff && displayAttributeDiff("bottomLevel", bottomLevel, _cother.bottomLevel,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("rollupPolicy", rollupPolicy,
                    _cother.rollupPolicy, _out, _indent + 1);
            _diff = _diff && displayElementArrayDiff("memberGrants", memberGrants,
    ...
    public static class MemberGrant extends org.eigenbase.xom.ElementDef {
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("MemberGrant", new org.eigenbase.xom.XMLAttrVector().add("member", member)
                    .add("access", access));
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayAttributeDiff("member", member, _cother.member, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("access", access, _cother.access, _out,
                    _indent + 1);
            return _diff;
        }
    }
    ...
    public static class Union extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff =
                    displayElementArrayDiff("roleUsages", roleUsages, _cother.roleUsages, _out,
                            _indent + 1);
            return _diff;
        }
    }
    ...
    public static class UserDefinedFunction extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("className", className, _cother.className, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("script", script, _cother.script, _out,
                    _indent + 1);
            return _diff;
        }
    }
    ...
    public static class Parameter extends org.eigenbase.xom.ElementDef {
        ...
        public Parameter(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                ...
                description =
                        (String) _parser.getAttribute("description", "String", null, null, false);
                type = (String) _parser
                        .getAttribute("type", "String", "String", _type_values, true);
                modifiable = (Boolean) _parser
                        .getAttribute("modifiable", "Boolean", "true", null, false);
                defaultValue =
                        (String) _parser.getAttribute("defaultValue", "String", null, null, false);
            } catch (org.eigenbase.xom.XOMException _ex) {
                throw new org.eigenbase.xom.XOMException(
                        "In " + getName() + ": " + _ex.getMessage());
            }
        ...
        public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
            _out.beginTag("Parameter", new org.eigenbase.xom.XMLAttrVector().add("name", name)
                    .add("description", description).add("type", type).add("modifiable", modifiable)
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            _diff = _diff && displayAttributeDiff("description", description, _cother.description,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("type", type, _cother.type, _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("modifiable", modifiable, _cother.modifiable,
                    _out, _indent + 1);
            _diff = _diff && displayAttributeDiff("defaultValue", defaultValue,
    ...
    public static class Script extends org.eigenbase.xom.ElementDef {
        ...
        public Script(org.eigenbase.xom.DOMWrapper _def) throws org.eigenbase.xom.XOMException {
            try {
                org.eigenbase.xom.DOMElementParser _parser =
                        new org.eigenbase.xom.DOMElementParser(_def, "", MolapDef.class);
                language = (String) _parser
                        .getAttribute("language", "String", "JavaScript", null, false);
                cdata = _parser.getText();
            } catch (org.eigenbase.xom.XOMException _ex) {
                throw new org.eigenbase.xom.XOMException(
                        "In " + getName() + ": " + _ex.getMessage());
    ...
    public static class CellFormatter extends org.eigenbase.xom.ElementDef {
        ...
        public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out,
            ...
            boolean _diff = displayAttributeDiff("className", className, _cother.className, _out,
                    _indent + 1);
            _diff = _diff && displayElementDiff("script", script, _cother.script, _out,
                    _indent + 1);
            return _diff;
