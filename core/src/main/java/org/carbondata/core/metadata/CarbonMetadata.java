    ...
    private void updateMeasureAndDimensions(String table, Cube cube, CarbonDef.Schema schema,
        ...
        // Handle dimensions
            ...
            formDimensions(cube, levelList, levelNormalizedList, levelToColumnMap,
                    metaFactTableCols, nd, factTableName, ((CarbonDef.Dimension) nd).name);
            ...
            formDimensions(cube, levelList, levelNormalizedList, levelToColumnMap,
                    ...
                    ((CarbonDef.DimensionUsage) nd).name);
        }
        // Handle measures
            ...
            Measure measure2 =
                    new Measure(measure.column, ordinal, measure.aggregator, measure.aggClass,
                            measure.name, CarbonMetadata.makeSQLDataTye(measure.datatype), cube,
