...
@SuppressWarnings("deprecation") public final class MolapMetadata {
     ...
     */
    public static boolean hasNameColumn(MolapDef.Level level) {
        return level.getNameExp() != null;
    }

    public static boolean hasOrdinalColumn(MolapDef.Level level) {
    ...
    public void loadCube(MolapDef.Schema schema, String orginalSchemaName, String orginalCubeName,
        ...
        HashMap<String, Measure> measuresMap =
                new HashMap<String, Measure>(MolapCommonConstants.DEFAULT_COLLECTION_SIZE);
        ...
        for (MolapDef.AggTable aggTable : aggtables) {
     ...
     * load the cube metadata.
     */
    public void loadSchema(MolapDef.Schema schema) {
     ...
     * @param measuresMap
     */
    public void processAggregateTable(MolapDef.AggTable agg, Cube cube,
            Map<String, String> levelsToColMap, Map<String, Measure> measuresMap) {
        MolapDef.AggName aggTable = (MolapDef.AggName) agg;
        ...
        for (MolapDef.AggMeasure aggMeasure : aggTable.measures) {
    ...
    private Map<String, String> loadMetaToCube(String table, Cube cube, MolapDef.Schema schema) {
        ...
        MolapDef.Cube mondrianCube = MolapSchemaReader.getMondrianCube(schema, cube.getCubeName());
        ...
        for (MondrianLevelHolder levHolder : levelList) {
            ...
            MolapDef.Property[] properties = lev.properties;
    ...
    private void updateDimensionWithHighCardinalityVal(Dimension dimension,
            MolapDef.CubeDimension[] dimensions) {
        for (MolapDef.CubeDimension cubeDimension : dimensions) {
    ...
    private void updateMeasureAndDimensions(String table, Cube cube, MolapDef.Schema schema,
        ...
        // Handle measures
            ...
            if (null != measure.annotations) {
                MolapDef.Annotation[] array = measure.annotations.array;
     ...
     * @return
     */
    private MolapDef.Dimension getDimensionFromDimensionUsage(MolapDef.Schema schema, NodeDef nd) {
        MolapDef.Dimension[] globalDimensions = schema.dimensions;
     ...
     * @return
     */
    private MolapDef.Dimension formDimension(NodeDef nd, MolapDef.Dimension globalDimension) {
    ...
    public static class Cube implements Serializable {
        ...
        public Cube(MolapDef.Schema schema, MolapDef.Cube cube, String orginalSchemaName,
        ...
        public List<Dimension> getDimensions(String table) {
            List<Dimension> list = dimensions.get(table);
            if (list == null) {
                list = new ArrayList<Dimension>(MolapCommonConstants.CONSTANT_SIZE_TEN);
        ...
        public void addToHierarchiesMapping(String hierName, Dimension dimension) {
            ...
            if (null == listOfDims) {
                listOfDims = new ArrayList<Dimension>(MolapCommonConstants.CONSTANT_SIZE_TEN);
