...
public class ORCCarbonWriterTest {
  ...
  public void testORCFileLoadWithPrimitiveType() throws IOException, InvalidLoadOptionException {
    ...
    CarbonWriter carbonWriter = carbonWriterBuilder.withOrcPath(filePath).
        outputPath(outputPath).writtenBy("ORCCarbonWriter").build();
    carbonWriter.write();
    carbonWriter.close();
  ...
  @Test
  public void testORCFileLoadWithComplexSchema() throws IOException, InvalidLoadOptionException, InterruptedException {
  ...
  @Test
  public void testMultipleORCFileLoad() throws IOException, InvalidLoadOptionException, InterruptedException {
  ...
  @Test
  public void testOrcFileLoadAndCarbonRead() throws IOException, InterruptedException, InvalidLoadOptionException {
    String filePath = DATA_PATH + "orc_files";
    CarbonWriterBuilder carbonWriterBuilder = new CarbonWriterBuilder();
