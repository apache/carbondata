...
public class TimestampStreamReaderTest {
    private static TimestampStreamReader timeStampStreamReader;
    ...
    public static void setUp() {
        ...
        timeStampStreamReader = new TimestampStreamReader();
        timeStampStreamReader.setVector(columnVector);
        timeStampStreamReader.setStreamData(new Object[]{1L, 2L, 3L});
    ...
    public void testReadBlock() throws IOException {
        timeStampStreamReader.setVectorReader(true);
        timeStampStreamReader.setBatchSize(3);
        assertNotNull(timeStampStreamReader.readBlock(carbondataColumnHandle.getColumnType()));
        timeStampStreamReader.setVectorReader(false);
        assertNotNull(timeStampStreamReader.readBlock(carbondataColumnHandle.getColumnType()));
