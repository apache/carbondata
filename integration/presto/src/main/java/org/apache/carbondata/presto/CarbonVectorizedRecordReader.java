 ...
 *
 * TODO: abstract and consolidate VectorizedRecordReader into one, and share it for all integration modules
 */
class CarbonVectorizedRecordReader extends AbstractRecordReader<Object> {
  ...
  public CarbonVectorizedRecordReader(QueryExecutor queryExecutor, QueryModel queryModel,
