...
case class CarbonDatasourceHadoopRelation(
  ...
  def buildScan(requiredColumns: Array[String],
      ...
      complexColumnsReferenceList: Map[String, Seq[String]],
    ...
    val outputWithComplexReferences =
      requiredColumns.flatMap(col => complexColumnsReferenceList.getOrElse(col, Seq(col)))
    outputWithComplexReferences.foreach(projection.addColumn)
