 ...
 */
private[hive]
case class HiveTableHeaderCountScanExec(
  ...
  private[this] val hadoopReader =
    new HadoopTableHeaderCountReader(attributes, relation, sparkSession, hadoopConf)
  ...
  override def sameResult(plan: SparkPlan): Boolean = plan match {
    case other: HiveTableHeaderCountScanExec =>
