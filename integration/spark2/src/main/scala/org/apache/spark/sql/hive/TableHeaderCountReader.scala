 ...
 */
private[hive] sealed trait TableHeaderCountReader {
...
class HadoopTableHeaderCountReader(
  ...
  def makeRDDForTable(
    ...
    logError(s"======skipHeaderLineCount=$skipHeaderLineCount======")
...
private[hive] object HadoopTableHeaderCountReader extends HiveInspectors with Logging {
  /**
