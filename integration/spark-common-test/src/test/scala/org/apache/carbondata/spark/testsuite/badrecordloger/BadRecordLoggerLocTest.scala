 ...
 *
 */
class BadRecordLoggerLocTest extends QueryTest with BeforeAndAfterAll {
  ...
  def isFilesWrittenAtBadStoreLocation: Boolean = {
    var badStorePath = CarbonProperties.getInstance()
      .getProperty(CarbonCommonConstants.CARBON_BADRECORDS_LOC)
    badStorePath = badStorePath + "/default/salestest/0/0"
