...
class TestInExpression extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    sql(
      s"""LOAD DATA INPATH '$csvFilePath' into table uniqdata OPTIONS" +
        "('DELIMITER'=',' , 'QUOTECHAR'='\"','BAD_RECORDS_ACTION'='FORCE','FILEHEADER'='CUST_ID," +
    ...
    sql("CREATE TABLE uniqdataHive (CUST_ID int,CUST_NAME String,ACTIVE_EMUI_VERSION string, DOB " +
        "timestamp, DOJ timestamp, BIGINT_COLUMN1 bigint,BIGINT_COLUMN2 bigint,DECIMAL_COLUMN1 " +
        "decimal(30,10), DECIMAL_COLUMN2 decimal(36,10),Double_COLUMN1 double, Double_COLUMN2 " +
        "double,INTEGER_COLUMN1 int) ")
    sql(s"""LOAD DATA INPATH '$csvFilePath' into table uniqdataHive""")
  }

  test(
    "select CUST_ID,CUST_NAME,DOB,BIGINT_COLUMN1,DECIMAL_COLUMN1,Double_COLUMN1,INTEGER_COLUMN1 " +
    ...
    ".1234000000','12345679931.1234000000','12345679936.1234000000','',NULL,' ')")
  {
    checkAnswer(
      sql(
        "select CUST_ID,CUST_NAME,DOB,BIGINT_COLUMN1,DECIMAL_COLUMN1,Double_COLUMN1," +
      ...
      sql(
        ...
        "'10040','10060','',NULL,' ') or INTEGER_COLUMN1 in (1021,1031,1032,1033,'',NULL,' ') or " +
        "DECIMAL_COLUMN1 in ('12345679921.1234000000','12345679931.1234000000','12345679936" +
        ".1234000000','',NULL,' ')"))
  }
