...
import org.apache.carbondata.trino.readers.BooleanStreamReader;
import org.apache.carbondata.trino.readers.ByteStreamReader;
import org.apache.carbondata.trino.readers.ComplexTypeStreamReader;
import org.apache.carbondata.trino.readers.DecimalSliceStreamReader;
import org.apache.carbondata.trino.readers.DoubleStreamReader;
import org.apache.carbondata.trino.readers.FloatStreamReader;
import org.apache.carbondata.trino.readers.IntegerStreamReader;
import org.apache.carbondata.trino.readers.LongStreamReader;
import org.apache.carbondata.trino.readers.ShortStreamReader;
import org.apache.carbondata.trino.readers.SliceStreamReader;
import org.apache.carbondata.trino.readers.TimestampStreamReader;
...
public class CarbonVectorBatch {
  ...
  private CarbonVectorBatch(StructField[] schema, CarbonTrinoDecodeReadSupport readSupport,
      int maxRows) {
  ...
  public static CarbonVectorBatch allocate(StructField[] schema,
      CarbonTrinoDecodeReadSupport readSupport, boolean isDirectFill) {
    if (isDirectFill) {
