...
public class CarbonLocalInputSplit {
  ...
  // the start offset of the block in a carbondata file.
  private final long start;
  // the length of the block.
  private final long length;
  // locations are the locations for different replicas.
  private final List<String> locations;
  private final short version;
  private final String[] deleteDeltaFiles;
  private final String blockletId;
  ...
  public static CarbonInputSplit convertSplit(CarbonLocalInputSplit carbonLocalInputSplit) {
    ...
    if (FileFormat.COLUMNAR_V3.ordinal() == inputSplit.getFileFormat().ordinal()
        ...
        && !carbonLocalInputSplit.detailInfo.equalsIgnoreCase("null")) {
