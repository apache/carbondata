 ...
 */
public class ByteStreamReader extends CarbonColumnVectorImpl implements TrinoVectorBlockBuilder {
  ...
  public ByteStreamReader(int batchSize, DataType dataType) {
