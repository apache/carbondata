...
public class ColumnarVectorWrapperDirect implements CarbonColumnVector, SequentialFill {
  ...
  private static final Logger LOGGER =
          LogServiceFactory.getLogService(ColumnarVectorWrapperDirect.class.getName());

  private final CarbonColumnVector dictionaryVector;
  /**
   * It is adapter class of complete ColumnarBatch.
   */
  protected CarbonColumnVectorImpl columnVector;
  /**
   * It is current block file datatype used for alter table scenarios when
   * datatype changes.
   */
  ...
  public void setPositionCount(int positionCount) {
    CarbonColumnVector.super.setPositionCount(positionCount);
  }

  @Override
  public void setIsLocalDictEnabledForComplextype(boolean value) {
    CarbonColumnVector.super.setIsLocalDictEnabledForComplextype(value);
  }
  ...
  public void setCarbonDataFileWrittenVersion(String carbonDataFileWrittenVersion) {
    // do nothing here,Print the carbonDataFileWrittenVersion
    LOGGER.info("carbonDataFileWrittenVersion" + carbonDataFileWrittenVersion);
  }
