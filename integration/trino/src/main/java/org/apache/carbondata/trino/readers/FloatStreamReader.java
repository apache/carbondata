 ...
 */
public class FloatStreamReader extends CarbonColumnVectorImpl implements TrinoVectorBlockBuilder {
  ...
  public void putFloat(int rowId, float value) {
    type.writeLong(builder, Float.floatToRawIntBits(value));
  }

  @Override
  public void putFloats(int rowId, int count, float[] src, int srcIndex) {
    for (int i = srcIndex; i < count; i++) {
      type.writeLong(builder, Float.floatToRawIntBits(src[i]));
    }
  }
