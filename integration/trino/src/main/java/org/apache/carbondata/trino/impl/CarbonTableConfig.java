...
public class CarbonTableConfig {
  ...
  /**
   * Property to send load model from coordinator to worker in presto. This
   * is internal constant
   * and not exposed to user.
   */
  public static final String CARBON_TRINO_LOAD_MODEL = "carbondata.trino.encoded.loadmodel";
  //read from config
