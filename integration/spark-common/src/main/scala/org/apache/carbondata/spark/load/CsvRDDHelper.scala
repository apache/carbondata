...
import org.apache.carbondata.core.util.{CarbonConfiguration, ThreadLocalSessionInfo}
      ...
      override def apply(file: PartitionedFile): Iterator[InternalRow] = {
        new Iterator[InternalRow] {
          ...
          ThreadLocalSessionInfo.getOrCreateCarbonSessionInfo().getThreadParams
            .setExtraInfo("carbonConf", new CarbonConfiguration(serializableConfiguration.value))
