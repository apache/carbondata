...
object DataLoadingUtil {
  ...
  def getDataLoadingOptions(
    ...
    optionsFinal.put("sort_columns_bounds", options.getOrElse("sort_column_bounds", ""))
    optionsFinal
  }
  ...
  def buildCarbonLoadModel(
    ...
    val sortColumnBounds = optionsFinal.getOrElse("sort_columns_bounds", "")
    carbonLoadModel.setSortColumnsBoundsStr(sortColumnBounds)
  }
