...
case class ShowIndexCommand(
  ...
  override def processData(sparkSession: SparkSession): Seq[Row] = {
    ...
    getIndex(carbonTable) ++ getSI(sparkSession, carbonTable)
  }

  private def getIndex(carbonTable: CarbonTable): Seq[Row] = {
  ...
  private def getSI(sparkSession: SparkSession, carbonTable: CarbonTable): Seq[Row] = {
