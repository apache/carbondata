...
object TestHive {
  ...
  def main(args: Array[String]) {
    ...
    sparkConf.set("carbon.kettle.home", "E:/Spark_Olap/data_load/load_test/carbonplugins")
    ...
    sparkConf.set("carbon.tempstore.location", "E:/Spark_Olap/data_load/load_test/temp")
    ...
    //olap.sql("CREATE CUBE cube_include1 DIMENSIONS (value String) MEASURES (key Integer) WITH hivetable RELATION (fact.value = value) INCLUDE (value) OPTIONS (AGGREGATION [key = SUM], PARTITIONER [CLASS = 'com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl', COLUMNS = (value), PARTITION_COUNT=1])");
    ...
    //olap.loadSchema("E:/Spark_Olap/data_load/load_test/vishalschema_1.xml",false,false,Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl", Seq("imei").toArray, 1, null))
    ...
    //    olap.setConf("carbon.kettle.home", "D:/TestData/carbonplugins")
    //    olap.setConf("carbon.is.columnar.storage", "true")
    //    olap.loadSchema("D:/TestData/Vmall/schemal.xml",false,false, Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl", Seq("imei").toArray, 1, null))
    ...
    //
    //    olap.loadSchema("D:/VivoDemo/Vmall/upgrade_schema.xml",false,false, Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl", Seq("imei").toArray, 2, null))
    ...
    //    olap.loadSchema("D:/TestData/SmartCare_withoutAgg.xml",false,false, Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl", Seq("MSISDN").toArray, 2, null))
    ...
    //    olap.loadSchema("C:/Users/n00902756/Documents/HQ124/upgrade_schema.xml",false,false, Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl", Seq("imei").toArray, 2, null))
    ...
    //    olap.setConf("carbon.kettle.home", "G:/mavenlib/carbonplugins")
    //    olap.setConf("carbon.is.columnar.storage", "true")
    //    olap.setConf("carbon.kettle.home", "F:/TRPSVN/Carbon/Carbon-Data-Processor_vishal/carbonplugins/carbonplugins")
    //    olap.setConf("carbon.kettle.home", "/opt/spark-1.0.0-rc3/jars/carbonplugins")
    //    olap.loadSchema("G:/mavenlib/PCC_Slim_de_captions.xml",false,false,Partitioner("com.huawei.datasight.carbon.partition.api.impl.SampleDataPartitionerImpl",Seq("Msisdn").toArray, 1,null))
    ...
    //    olap.setConf("carbon.tempstore.location","D:/ff/ff/rr")
