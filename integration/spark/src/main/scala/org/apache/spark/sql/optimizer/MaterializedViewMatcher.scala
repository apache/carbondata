...
private abstract class MaterializedViewMatchMaker {

  /** Define a sequence of rules, to be overridden by the implementation. */
  protected val patterns: Seq[MaterializedViewMatchPattern]
...
private object MaterializedViewMatchMaker extends MaterializedViewMatchMaker {
  lazy val patterns: List[MaterializedViewMatchPattern] =
...
private abstract class MaterializedViewMatchPattern extends Logging {
...
private object SelectSelectNoChildDelta extends MaterializedViewMatchPattern with PredicateHelper {
...
private object GroupbyGroupbyNoChildDelta extends MaterializedViewMatchPattern {
  def apply(
      subsumer: ModularPlan,
      subsumee: ModularPlan,
      compensation: Option[ModularPlan],
...
private object GroupbyGroupbySelectOnlyChildDelta
  extends MaterializedViewMatchPattern with PredicateHelper {
  private def isDerivable(
      exprE: Expression,
      exprListR: Seq[Expression],
      subsumee: ModularPlan,
...
private object GroupbyGroupbyGroupbyChildDelta extends MaterializedViewMatchPattern {
  def apply(
      subsumer: ModularPlan,
      subsumee: ModularPlan,
      compensation: Option[ModularPlan],
...
private object SelectSelectSelectChildDelta extends MaterializedViewMatchPattern {
  def apply(
      subsumer: ModularPlan,
      subsumee: ModularPlan,
      compensation: Option[ModularPlan],
