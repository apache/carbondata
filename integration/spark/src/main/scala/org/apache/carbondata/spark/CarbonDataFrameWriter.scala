...
class CarbonDataFrameWriter(val dataFrame: DataFrame) {
   ...
   * @param options  CarbonOption that contains all options for Spark data source
   * @param cc  CarbonContext for runing sql
   */
   ...
   * @param options CarbonOption that contains all options for Spark data source
   * @param cc CarbonContext for runing related operation
   */
