...
public class MolapMeasure implements MolapColumn, Serializable {
    ...
    public enum AggregatorType {
        SUM("SUM"), COUNT("COUNT"), AVG("AVG"), MAX("MAX"), MIN("MIN"), DISTINCT_COUNT(
                "DISTINCT-COUNT"), SUM_DISTINCT("SUM-DISTINCT"), INSTANCE("INSTANCE"), CUSTOM(
                "CUSTOM");
        ...
        public AggregatorType getAggType(String aggType) {
            if ("summolap".equalsIgnoreCase(aggType) || "sum".equalsIgnoreCase(aggType)) {
                ...
                return AVG;
            } else if (aggType.equalsIgnoreCase("CountDistinctMolap") || aggType
                    .equalsIgnoreCase("distinct_count")) {
                return DISTINCT_COUNT;
            } else if (("MinMolap").equalsIgnoreCase(aggType) || ("min")
                    .equalsIgnoreCase(aggType)) {
                return MIN;
            } else if (("MaxMolap").equalsIgnoreCase(aggType) || ("max")
                    .equalsIgnoreCase(aggType)) {
                return MAX;
            } else if ("SumDistinctMolap".equalsIgnoreCase(aggType) || "sum-distinct"
                    .equalsIgnoreCase(aggType)) {
                return SUM_DISTINCT;
