 ...
 *
 */
package org.carbondata.integration.spark.splits;
...
public class LoadSplit implements Serializable, Writable {
    ...
    private static final LogService LOGGER =
            LogServiceFactory.getLogService(LoadSplit.class.getName());
    /**
     *
     */
    ...
    public LoadSplit(long jobId, BlockingQueue<String> filelistQueue, Cube cube, String tableName,
            int clientCount, List<String> locations) {
        this.jobId = jobId;
