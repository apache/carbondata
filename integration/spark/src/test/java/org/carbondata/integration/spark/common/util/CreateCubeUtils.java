...
public class CreateCubeUtils {
    public static void createCube(String schemaName, String cubeName, String partitionColumn)
        ...
        MolapMetadata.getInstance()
                .loadSchema(CommonUtils.createSchemaObjectFromXMLString(schemaXML));
        ...
        DataOutputStream out =
                FileFactory.getDataOutputStream(cubeMetaDataPath + "/" + "metadata", fileType);
        ...
        objStream.writeObject(new Partitioner(
                "com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl",
        ...
        System.out.println(
                "Cube " + cubeName + " for schema " + schemaName + " created successfully.");
    }
}
