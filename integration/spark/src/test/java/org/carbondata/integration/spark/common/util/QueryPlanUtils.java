...
public class QueryPlanUtils {
    ...
    public static void addDimensionWithSort(MolapQueryPlan plan, String dimensionName,
            SortOrderType sortOrderType, int queryOrder) {
    ...
    public static void addMeasureWithAgg(MolapQueryPlan plan, String measureName,
            MolapMeasure.AggregatorType aggregatorType, int queryOrder) {
        //Add Count Measure
    ...
    public static void addAggOnDimension(MolapQueryPlan plan, String measureName,
            String aggregatorType, int queryOrder) {
    ...
    public static void addInFilter(MolapQueryPlan plan, String columnName, List<Object> values,
            MolapMetadata.Dimension currDim, DataType dataType) {
        //Filter
        //Left Column
