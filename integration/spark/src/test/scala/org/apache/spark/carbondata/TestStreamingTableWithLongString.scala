...
class TestStreamingTableWithLongString extends QueryTest with BeforeAndAfterAll {
  ...
  test("[CARBONDATA-3497] Support to write long string for streaming table: " +
    ...
    val exceptedRow = Row(10, "name_10", "city_10", 100000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), "10" + longStrValue)
  ...
  test("[CARBONDATA-3497] Support to write long string for streaming table") {
    ...
    checkAnswer(
      ...
      Seq(Row(1, "name_1", "city_1", 10000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("1" + longStrValue))))

    checkAnswer(
      sql("select * from streaming_longstr.stream_table_longstr where id > 49 and id < 100000002"),
      Seq(Row(50, "name_50", "city_50", 500000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("50" + longStrValue)),
        Row(100000001, "batch_1", "city_1", 0.1f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("1" + longStrValue))))
  ...
  test("[CARBONDATA-3497] Support to write long string for streaming table: " +
    ...
    checkAnswer(
      ...
      Seq(Row(1, "name_1", "city_1", 10000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("1" + longStrValue), Row(wrap(Array("school_1", "school_11")), 1))))

    checkAnswer(
      sql("select * from streaming_longstr.stream_table_longstr_complex where id > 49 and id < 100000002"),
      Seq(Row(50, "name_50", "city_50", 500000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("50" + longStrValue), Row(wrap(Array("school_50", "school_5050")), 50)),
        Row(100000001, "batch_1", "city_1", 0.1f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("1" + longStrValue), Row(wrap(Array("school_1", "school_11")), 20))))
  ...
  test("[CARBONDATA-3497] Support to write long string for streaming table: StreamSQL") {
    ...
    val exceptedRow = Row(11, "name_11", "city_11", 110000.0f, BigDecimal.valueOf(0.01), 80.01, Date.valueOf("1990-01-01"), Timestamp.valueOf("2010-01-01 10:01:01.0"), Timestamp.valueOf("2010-01-01 10:01:01.0"), ("11" + longStrValue))
    assertResult(exceptedRow)(row)
  ...
  def generateCSVDataFile(
    ...
    val csvDataDF = {
      ...
      spark.createDataFrame(csvRDD).toDF("id", "name", "city", "salary", "tax", "percent", "birthday", "register", "updated", "longstr", "file")
    }
