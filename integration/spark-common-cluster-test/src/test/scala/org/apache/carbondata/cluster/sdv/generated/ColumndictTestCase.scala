...
class ColumndictTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC001", Include) {
   ...
   sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.dictionary')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  'country:resourcesPath/Data/columndict/country.csv')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC003", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/inValidData.dictionary')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC004", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'=
  'country:resourcesPath/Data/columndict/inValidData.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC005", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data1' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.dictionary')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC006", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data1' into table t3 options('COLUMNDICT'='country:resourcesPath/Data/columndict/country.csv')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC007", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.dat' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.dictionary')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC008", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.dat' into table t3 options('COLUMNDICT'=
  'country:resourcesPath/Data/columndict/country.csv')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC009", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.dat' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.dictionary','maxcolumns'='8')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC010", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.dat' into table t3 options('COLUMNDICT'=
  'country:resourcesPath/Data/columndict/country.csv','maxcolumns'='8')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC011", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.dictionary','BAD_RECORDS_LOGGER_ENABLE'='FALSE', 'BAD_RECORDS_ACTION'='FORCE')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC012", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'=
  'country:resourcesPath/Data/columndict/country.csv','BAD_RECORDS_LOGGER_ENABLE'='FALSE', 'BAD_RECORDS_ACTION'='FORCE')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC014", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
   sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'='country:$resourcesPath/Data/columndict/country.csv')""").collect
   sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'='country:$resourcesPath/Data/columndict/country.csv')""").collect
   sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'='country:$resourcesPath/Data/columndict/country.csv')""").collect
    sql(s"""select * from t3 where ID>=5""").collect
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC019", Include) {
    ...
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'=
  'salary:resourcesPath/Data/columndict/salary.csv')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC021", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata' TBLPROPERTIES ('TABLE_BLOCKSIZE'= '256 MB','DICTIONARY_EXCLUDE'='country')""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'='countries:resourcesPath/Data/columndict/country.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC022", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('COLUMNDICT'=
  'salary:/columndictionary/country.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC023", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/inValidData.dictionary')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC024", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('COLUMNDICT'=
  'country:'resourcesPath/Data/columndict/inValidData.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC025", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('ALL_DICTIONARY_PATH'=''resourcesPath/Data/*.dictionary')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC026", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/*.dictionary')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC027", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('COLUMNDICT'=
  'country:'resourcesPath/Data/columndict/*.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC028", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('ALL_DICTIONARY_PATH'=''resourcesPath/Data/columndict/wrongName.dictionary')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC029", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('COLUMNDICT'=
  'country:'resourcesPath/Data/columndict/wrongName.csv')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC030", Include) {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
    sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/data.csv' into table t3 options('ALL_DICTIONARY_PATH'='resourcesPath/Data/columndict/data.txt')""").collect
     sql(s"""drop table if exists t3""").collect
  }
  ...
  test("AR-Develop-Feature-columndict-001_PTS001_TC031", Include) {
    try {
     sql(s"""CREATE TABLE IF NOT EXISTS t3 (ID Int, country String, name String, phonetype String, serialname String, salary Int,floatField float) STORED BY 'carbondata'""").collect
      sql(s"""LOAD DATA LOCAL INPATH '$resourcesPath/Data/columndict/inValidData.csv' into table t3 options('COLUMNDICT'=
  'country:resourcesPath/Data/columndict/country.txt')""").collect
      assert(false)
    } catch {
      case _ => assert(true)
    }
