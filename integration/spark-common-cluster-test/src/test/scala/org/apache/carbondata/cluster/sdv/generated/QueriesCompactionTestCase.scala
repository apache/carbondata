...
class QueriesCompactionTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_051", Include) {
    ...
    checkAnswer(s"""select corr(contractNumber,contractNumber)  as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select corr(contractNumber,contractNumber)  as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_051")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_057", Include) {
    ...
    checkAnswer(s"""select contractNumber+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select contractNumber+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_057")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_058", Include) {
    ...
    checkAnswer(s"""select min(contractNumber), max(contractNumber+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE group by  channelsId order by Total""",
      s"""select min(contractNumber), max(contractNumber+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_058")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_060", Include) {
    ...
    checkAnswer(s"""select FIRST(contractNumber) a from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select FIRST(contractNumber) a from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_060")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_061", Include) {
    ...
    checkAnswer(s"""select contractNumber,count(contractNumber) a from Comp_VMALL_DICTIONARY_INCLUDE group by contractNumber order by contractNumber""",
      s"""select contractNumber,count(contractNumber) a from Comp_VMALL_DICTIONARY_INCLUDE_hive group by contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_061")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_062", Include) {
    ...
    checkAnswer(s"""select Lower(contractNumber) a  from Comp_VMALL_DICTIONARY_INCLUDE order by contractNumber""",
      s"""select Lower(contractNumber) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_062")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_063", Include) {
    ...
    checkAnswer(s"""select distinct contractNumber from Comp_VMALL_DICTIONARY_INCLUDE order by contractNumber""",
      s"""select distinct contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_063")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_064", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE order by contractNumber limit 101""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive order by contractNumber limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_064")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_065", Include) {
    ...
    checkAnswer(s"""select contractNumber as a from Comp_VMALL_DICTIONARY_INCLUDE  order by a asc limit 10""",
      s"""select contractNumber as a from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_065")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_066", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where  (contractNumber == 9223372047700) and (imei=='1AA100012')""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where  (contractNumber == 9223372047700) and (imei=='1AA100012')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_066")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_067", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber !=9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber !=9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_067")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_068", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color') order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color') order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_068")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_069", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber !=9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber !=9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_069")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_070", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber >9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber >9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_070")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_071", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber<>contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber<>contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_071")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_072", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber != Latest_areaId order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber != Latest_areaId order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_072")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_073", Include) {
    ...
    checkAnswer(s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where Latest_areaId<contractNumber order by contractNumber""",
      s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_areaId<contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_073")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_074", Include) {
    ...
    checkAnswer(s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY<=contractNumber order by contractNumber""",
      s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY<=contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_074")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_075", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber <1000 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber <1000 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_075")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_076", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber >1000 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber >1000 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_076")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_077", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber IS NULL order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber IS NULL order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_077")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_078", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY IS NOT NULL order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY IS NOT NULL order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_078")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_079", Include) {
    ...
    checkAnswer(s"""Select count(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""Select count(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_079")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_080", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT Latest_DAY) as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(DISTINCT Latest_DAY) as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_080")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_081", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)+10 as a ,Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE group by Latest_DAY order by a""",
      s"""select sum(Latest_DAY)+10 as a ,Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE_hive group by Latest_DAY order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_081")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_082", Include) {
    ...
    checkAnswer(s"""select max(Latest_DAY),min(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select max(Latest_DAY),min(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_082")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_083", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_083")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_084", Include) {
    ...
    checkAnswer(s"""select avg(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select avg(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_084")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_085", Include) {
    ...
    checkAnswer(s"""select min(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select min(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_085")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_093", Include) {
    ...
    checkAnswer(s"""select corr(Latest_DAY,Latest_DAY)  as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select corr(Latest_DAY,Latest_DAY)  as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_093")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_099", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select Latest_DAY, Latest_DAY+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_099")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_100", Include) {
    ...
    checkAnswer(s"""select min(Latest_DAY), max(Latest_DAY+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE group by  channelsId order by Total""",
      s"""select min(Latest_DAY), max(Latest_DAY+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_100")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_103", Include) {
    ...
    checkAnswer(s"""select Latest_DAY,count(Latest_DAY) a from Comp_VMALL_DICTIONARY_INCLUDE group by Latest_DAY order by Latest_DAY""",
      s"""select Latest_DAY,count(Latest_DAY) a from Comp_VMALL_DICTIONARY_INCLUDE_hive group by Latest_DAY order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_103")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_104", Include) {
    ...
    checkAnswer(s"""select Lower(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select Lower(Latest_DAY) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_104")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_105", Include) {
    ...
    checkAnswer(s"""select distinct Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE order by Latest_DAY""",
      s"""select distinct Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_105")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_106", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE order by Latest_DAY limit 101""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive order by Latest_DAY limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_106")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_107", Include) {
    ...
    checkAnswer(s"""select Latest_DAY as a from Comp_VMALL_DICTIONARY_INCLUDE  order by a asc limit 10""",
      s"""select Latest_DAY as a from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_107")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_108", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where  (Latest_DAY == 1234567890123450.0000000000)  and (imei=='1AA1')""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where  (Latest_DAY == 1234567890123450.0000000000)  and (imei=='1AA1')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_108")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_109", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_109")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_110", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_110")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_111", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_111")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_112", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY >1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY >1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_112")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_113", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY<>Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY<>Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_113")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_114", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY != Latest_areaId order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY != Latest_areaId order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_114")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_115", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_areaId<Latest_DAY order by Latest_DAY""",
      s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_areaId<Latest_DAY order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_115")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_116", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY<=Latest_DAY  order by Latest_DAY""",
      s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY<=Latest_DAY  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_116")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_117", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY <1000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY <1000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_117")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_118", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY >1000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY >1000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_118")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_119", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY IS NULL  order by Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY IS NULL  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_119")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_120", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY IS NOT NULL  order by Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY IS NOT NULL  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_120")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_121", Include) {
    ...
    checkAnswer(s"""Select count(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""Select count(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_121")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_122", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT gamePointId) as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(DISTINCT gamePointId) as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_122")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_124", Include) {
    ...
    checkAnswer(s"""select max(gamePointId),min(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select max(gamePointId),min(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_124")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_127", Include) {
    ...
    checkAnswer(s"""select min(gamePointId) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select min(gamePointId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_127")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_135", Include) {
    ...
    checkAnswer(s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_135")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_141", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select gamePointId, gamePointId+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_141")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_142", Include) {
    ...
    checkAnswer(s"""select min(gamePointId), max(gamePointId+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE group by  channelsId order by Total""",
      s"""select min(gamePointId), max(gamePointId+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_142")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_145", Include) {
    ...
    checkAnswer(s"""select gamePointId,count(gamePointId) a from Comp_VMALL_DICTIONARY_INCLUDE group by gamePointId order by gamePointId""",
      s"""select gamePointId,count(gamePointId) a from Comp_VMALL_DICTIONARY_INCLUDE_hive group by gamePointId order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_145")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_146", Include) {
    ...
    checkAnswer(s"""select Lower(gamePointId) a  from Comp_VMALL_DICTIONARY_INCLUDE order by gamePointId""",
      s"""select Lower(gamePointId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_146")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_147", Include) {
    ...
    checkAnswer(s"""select distinct gamePointId from Comp_VMALL_DICTIONARY_INCLUDE order by gamePointId""",
      s"""select distinct gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_147")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_148", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE  order by gamePointId limit 101""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by gamePointId limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_148")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_149", Include) {
    ...
    checkAnswer(s"""select gamePointId as a from Comp_VMALL_DICTIONARY_INCLUDE  order by a asc limit 10""",
      s"""select gamePointId as a from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_149")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_150", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where  (gamePointId == 4.70133553923674E43) and (imei=='1AA100084')""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where  (gamePointId == 4.70133553923674E43) and (imei=='1AA100084')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_150")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_151", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId !=4.70133553923674E43  order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId !=4.70133553923674E43  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_151")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_152", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_152")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_153", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId !=4.70133553923674E43""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId !=4.70133553923674E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_153")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_154", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId >4.70133553923674E43""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId >4.70133553923674E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_154")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_155", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId<>gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId<>gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_155")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_156", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId != Latest_areaId  order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId != Latest_areaId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_156")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_157", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where Latest_areaId<gamePointId  order by gamePointId""",
      s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_areaId<gamePointId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_157")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_158", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId<=gamePointId  order by gamePointId""",
      s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId<=gamePointId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_158")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_159", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId <1000 order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId <1000 order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_159")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_160", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId >1000 order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId >1000 order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_160")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_161", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId IS NULL order by gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId IS NULL order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_161")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_162", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId IS NOT NULL order by gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId IS NOT NULL order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_162")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_163", Include) {
    ...
    checkAnswer(s"""Select count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""Select count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_163")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_164", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT productionDate) as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(DISTINCT productionDate) as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_164")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_165", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)+10 as a ,productionDate  from Comp_VMALL_DICTIONARY_INCLUDE group by productionDate order by productionDate""",
      s"""select sum(productionDate)+10 as a ,productionDate  from Comp_VMALL_DICTIONARY_INCLUDE_hive group by productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_165")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_166", Include) {
    ...
    checkAnswer(s"""select max(productionDate),min(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select max(productionDate),min(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_166")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_167", Include) {
    ...
    checkAnswer(s"""select sum(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_167")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_168", Include) {
    ...
    checkAnswer(s"""select avg(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select avg(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_168")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_169", Include) {
    ...
    checkAnswer(s"""select min(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select min(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_169")

  }


  //Comp_VMALL_DICTIONARY_INCLUDE_170
  test("Comp_VMALL_DICTIONARY_INCLUDE_170", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_171
  test("Comp_VMALL_DICTIONARY_INCLUDE_171", Include) {

    sql(s"""select var_pop(gamePointId)  as a from Comp_VMALL_DICTIONARY_INCLUDE""").collect

  }


  //Comp_VMALL_DICTIONARY_INCLUDE_172
  test("Comp_VMALL_DICTIONARY_INCLUDE_172", Include) {

    sql(s"""select var_samp(gamePointId) as a  from Comp_VMALL_DICTIONARY_INCLUDE""").collect

  }


  //Comp_VMALL_DICTIONARY_INCLUDE_173
  test("Comp_VMALL_DICTIONARY_INCLUDE_173", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_174
  test("Comp_VMALL_DICTIONARY_INCLUDE_174", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_175
  test("Comp_VMALL_DICTIONARY_INCLUDE_175", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_176
  test("Comp_VMALL_DICTIONARY_INCLUDE_176", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_177
  test("Comp_VMALL_DICTIONARY_INCLUDE_177", Include) {

    checkAnswer(s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_177")

  }


  //Comp_VMALL_DICTIONARY_INCLUDE_178
  test("Comp_VMALL_DICTIONARY_INCLUDE_178", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_179
  test("Comp_VMALL_DICTIONARY_INCLUDE_179", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_180
  test("Comp_VMALL_DICTIONARY_INCLUDE_180", Include) {
  ...
  //Comp_VMALL_DICTIONARY_INCLUDE_181
  test("Comp_VMALL_DICTIONARY_INCLUDE_181", Include) {
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_183", Include) {
    ...
    checkAnswer(s"""select last(productionDate) a from Comp_VMALL_DICTIONARY_INCLUDE order by a""",
      s"""select last(productionDate) a from Comp_VMALL_DICTIONARY_INCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_183")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_185", Include) {
    ...
    checkAnswer(s"""select productionDate,count(productionDate) a from Comp_VMALL_DICTIONARY_INCLUDE group by productionDate order by productionDate""",
      s"""select productionDate,count(productionDate) a from Comp_VMALL_DICTIONARY_INCLUDE_hive group by productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_185")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_186", Include) {
    ...
    checkAnswer(s"""select Lower(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE order by productionDate""",
      s"""select Lower(productionDate) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_186")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_187", Include) {
    ...
    checkAnswer(s"""select distinct productionDate from Comp_VMALL_DICTIONARY_INCLUDE order by productionDate""",
      s"""select distinct productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_187")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_188", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE order by productionDate limit 101""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive order by productionDate limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_188")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_189", Include) {
    ...
    checkAnswer(s"""select productionDate as a from Comp_VMALL_DICTIONARY_INCLUDE  order by a asc limit 10""",
      s"""select productionDate as a from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_189")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_190", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where  (productionDate == '2015-07-01 12:07:28.0') and (productionDate=='2015-07-01 12:07:28.0')""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where  (productionDate == '2015-07-01 12:07:28.0') and (productionDate=='2015-07-01 12:07:28.0')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_190")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_191", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate !='2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate !='2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_191")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_192", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_192")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_193", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate !='2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate !='2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_193")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_194", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate >'2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate >'2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_194")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_195", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE where productionDate<>productionDate order by productionDate""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate<>productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_195")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_196", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate != Latest_areaId order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate != Latest_areaId order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_196")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_197", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where Latest_areaId<productionDate order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_areaId<productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_197")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_198", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate<=productionDate order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate<=productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_198")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_199", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate <cast('2015-07-01 12:07:28.0' as timestamp) order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate <cast('2015-07-01 12:07:28.0' as timestamp) order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_199")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_200", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE where productionDate IS NULL""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate IS NULL""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_200")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_201", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE where productionDate IS NOT NULL order by productionDate""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate IS NOT NULL order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_201")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_202", Include) {
    ...
    checkAnswer(s"""Select count(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""Select count(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_202")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_203", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT deviceInformationId) as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(DISTINCT deviceInformationId) as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_203")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_204", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)+10 as a ,deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE group by deviceInformationId order by deviceInformationId""",
      s"""select sum(deviceInformationId)+10 as a ,deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE_hive group by deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_204")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_205", Include) {
    ...
    checkAnswer(s"""select max(deviceInformationId),min(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select max(deviceInformationId),min(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_205")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_206", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_206")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_207", Include) {
    ...
    checkAnswer(s"""select avg(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select avg(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_207")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_208", Include) {
    ...
    checkAnswer(s"""select min(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select min(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_208")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_216", Include) {
    ...
    checkAnswer(s"""select corr(deviceInformationId,deviceInformationId)  as a from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select corr(deviceInformationId,deviceInformationId)  as a from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_216")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_222", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId+ 10 as a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_222")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_223", Include) {
    ...
    checkAnswer(s"""select min(deviceInformationId), max(deviceInformationId+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE group by  channelsId order by Total""",
      s"""select min(deviceInformationId), max(deviceInformationId+ 10) Total from Comp_VMALL_DICTIONARY_INCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_223")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_226", Include) {
    ...
    checkAnswer(s"""select deviceInformationId,count(deviceInformationId) a from Comp_VMALL_DICTIONARY_INCLUDE group by deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId,count(deviceInformationId) a from Comp_VMALL_DICTIONARY_INCLUDE_hive group by deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_226")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_227", Include) {
    ...
    checkAnswer(s"""select Lower(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE order by deviceInformationId""",
      s"""select Lower(deviceInformationId) a  from Comp_VMALL_DICTIONARY_INCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_227")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_228", Include) {
    ...
    checkAnswer(s"""select distinct deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE order by deviceInformationId""",
      s"""select distinct deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_228")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_229", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE order by deviceInformationId limit 101""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive order by deviceInformationId limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_229")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_230", Include) {
    ...
    checkAnswer(s"""select deviceInformationId as a from Comp_VMALL_DICTIONARY_INCLUDE  order by a asc limit 10""",
      s"""select deviceInformationId as a from Comp_VMALL_DICTIONARY_INCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_230")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_231", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where  (deviceInformationId == 100084) and (deviceInformationId==100084)""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where  (deviceInformationId == 100084) and (deviceInformationId==100084)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_231")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_232", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId !='100084' order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId !='100084' order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_232")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_233", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_233")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_234", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId !=100084 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId !=100084 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_234")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_235", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId >100084 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId >100084 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_235")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_236", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId<>deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId<>deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_236")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_237", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId != Latest_areaId order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId != Latest_areaId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_237")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_238", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where Latest_areaId<deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_areaId<deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_238")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_239", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId<=deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId<=deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_239")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_240", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId <1000 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId <1000 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_240")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_241", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId >1000 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId >1000 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_241")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_242", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId IS NULL order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId IS NULL order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_242")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_243", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId IS NOT NULL order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId IS NOT NULL order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_243")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_244", Include) {
    ...
    checkAnswer(s"""select sum(imei)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(imei)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_244")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_245", Include) {
    ...
    checkAnswer(s"""select sum(imei)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(imei)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_245")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_246", Include) {
    ...
    checkAnswer(s"""select sum(imei)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(imei)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_246")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_247", Include) {
    ...
    checkAnswer(s"""select sum(imei)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(imei)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_247")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_248", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(contractNumber)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_248")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_249", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(contractNumber)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_249")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_250", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(contractNumber)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_250")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_251", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(contractNumber)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_251")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_252", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_DAY)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_252")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_253", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_DAY)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_253")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_254", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_DAY)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_254")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_255", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_DAY)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_255")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_260", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_260")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_261", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_261")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_262", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_262")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_263", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_263")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_264", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceInformationId)+10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_264")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_265", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceInformationId)*10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_265")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_266", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceInformationId)/10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_266")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_267", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceInformationId)-10 as a   from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_267")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_292", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate LIKE '2015-09-30%'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate LIKE '2015-09-30%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_292")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_293", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate LIKE '% %'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate LIKE '% %'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_293")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_294", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate LIKE '%12:07:28'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate LIKE '%12:07:28'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_294")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_295", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE where contractnumber like '922337204%' """,
      s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractnumber like '922337204%' """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_295")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_296", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE where contractnumber like '%047800'""",
      s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractnumber like '%047800'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_296")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_297", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE where contractnumber like '%720%'""",
      s"""select contractnumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractnumber like '%720%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_297")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_298", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY like '12345678%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY like '12345678%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_298")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_299", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY like '%5678%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY like '%5678%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_299")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_300", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY like '1234567%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY like '1234567%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_300")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_301", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE where gamepointID like '1.1098347722%'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointID like '1.1098347722%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_301")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_302", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE where gamepointID like '%8347722%'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointID like '%8347722%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_302")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_303", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE where gamepointID like '%7512E42'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointID like '%7512E42'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_303")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_304", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid like '1000%'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid like '1000%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_304")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_305", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid like '%00%'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid like '%00%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_305")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_306", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid like '%0084'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid like '%0084'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_306")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_307", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei like '1AA10%'""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei like '1AA10%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_307")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_308", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei like '%A10%'""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei like '%A10%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_308")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_309", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei like '%00084'""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei like '%00084'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_309")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_310", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei in ('1AA100074','1AA100075','1AA100077')""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei in ('1AA100074','1AA100075','1AA100077')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_310")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_311", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei not in ('1AA100074','1AA100075','1AA100077')""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei not in ('1AA100074','1AA100075','1AA100077')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_311")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_312", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid in (100081,100078,10008)""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid in (100081,100078,10008)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_312")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_313", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid not in (100081,100078,10008)""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid not in (100081,100078,10008)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_313")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_314", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate in ('2015-10-04 12:07:28','2015-10-07%','2015-10-07 12:07:28')""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate in ('2015-10-04 12:07:28','2015-10-07%','2015-10-07 12:07:28')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_314")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_315", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate not in (cast('2015-10-04 12:07:28' as timestamp),cast('2015-10-07 12:07:28' as timestamp))""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate not in (cast('2015-10-04 12:07:28' as timestamp),cast('2015-10-07 12:07:28' as timestamp))""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_315")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_316", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE where gamepointid in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointid in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_316")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_317", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE where gamepointid not in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointid not in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_317")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_318", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY in (1234567890123530.0000000000,1234567890123520.0000000000)""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY in (1234567890123530.0000000000,1234567890123520.0000000000)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_318")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_319", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY not in (1234567890123530.0000000000,1234567890123520.0000000000)""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY not in (1234567890123530.0000000000,1234567890123520.0000000000)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_319")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_322", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei !='1AA100077'""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei !='1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_322")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_323", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei NOT LIKE '1AA100077'""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei NOT LIKE '1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_323")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_324", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid !=100078""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid !=100078""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_324")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_325", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationid NOT LIKE 100079""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationid NOT LIKE 100079""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_325")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_326", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE where productiondate !='2015-10-07 12:07:28'""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productiondate !='2015-10-07 12:07:28'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_326")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_328", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE where gamepointid !=6.8591561117512E42""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointid !=6.8591561117512E42""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_328")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_329", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE where gamepointid NOT LIKE 6.8591561117512E43""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointid NOT LIKE 6.8591561117512E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_329")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_330", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY != 1234567890123520.0000000000""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY != 1234567890123520.0000000000""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_330")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_331", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY NOT LIKE 1234567890123520.0000000000""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY NOT LIKE 1234567890123520.0000000000""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_331")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_335", Include) {
    ...
    checkAnswer(s"""SELECT productiondate,IMEI from Comp_VMALL_DICTIONARY_INCLUDE where IMEI RLIKE '1AA100077'""",
      s"""SELECT productiondate,IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive where IMEI RLIKE '1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_335")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_336", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceinformationId RLIKE '100079'""",
      s"""SELECT deviceinformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceinformationId RLIKE '100079'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_336")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_337", Include) {
    ...
    checkAnswer(s"""SELECT gamepointid from Comp_VMALL_DICTIONARY_INCLUDE where gamepointid RLIKE '1.61922711065643E42'""",
      s"""SELECT gamepointid from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamepointid RLIKE '1.61922711065643E42'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_337")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_338", Include) {
    ...
    checkAnswer(s"""SELECT Latest_Day from Comp_VMALL_DICTIONARY_INCLUDE where Latest_Day RLIKE '1234567890123550.0000000000'""",
      s"""SELECT Latest_Day from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_Day RLIKE '1234567890123550.0000000000'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_338")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_339", Include) {
    ...
    checkAnswer(s"""SELECT contractnumber from Comp_VMALL_DICTIONARY_INCLUDE where contractnumber RLIKE '9223372047800'""",
      s"""SELECT contractnumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractnumber RLIKE '9223372047800'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_339")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_340", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.productiondate=b.productiondate""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.productiondate=b.productiondate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_340")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_341", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.deviceinformationid=b.deviceinformationid""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.deviceinformationid=b.deviceinformationid""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_341")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_342", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.imei=b.imei""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.imei=b.imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_342")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_343", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.gamepointid=b.gamepointid""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.gamepointid=b.gamepointid""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_343")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_344", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.Latest_Day=b.Latest_Day""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.Latest_Day=b.Latest_Day""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_344")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_345", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE a join Comp_VMALL_DICTIONARY_INCLUDE b on a.contractnumber=b.contractnumber""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_INCLUDE_hive a join Comp_VMALL_DICTIONARY_INCLUDE_hive b on a.contractnumber=b.contractnumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_345")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_346", Include) {
    ...
    checkAnswer(s"""select count( contractNumber ),sum( contractNumber ),count(distinct contractNumber ),avg( contractNumber ),max( contractNumber ),min( contractNumber ),1 from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count( contractNumber ),sum( contractNumber ),count(distinct contractNumber ),avg( contractNumber ),max( contractNumber ),min( contractNumber ),1 from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_346")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_347", Include) {
    ...
    checkAnswer(s"""select count( Latest_Day ),sum( Latest_Day ),count(distinct Latest_Day ),avg( Latest_Day ),max( Latest_Day ),min( Latest_Day ),1 from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count( Latest_Day ),sum( Latest_Day ),count(distinct Latest_Day ),avg( Latest_Day ),max( Latest_Day ),min( Latest_Day ),1 from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_347")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_349", Include) {
    ...
    checkAnswer(s"""select count(deviceInformationId),sum(deviceInformationId),count(deviceInformationId),avg(deviceInformationId),max(deviceInformationId),min(deviceInformationId),1 from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(deviceInformationId),sum(deviceInformationId),count(deviceInformationId),avg(deviceInformationId),max(deviceInformationId),min(deviceInformationId),1 from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_349")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_350", Include) {
    ...
    checkAnswer(s"""select count( productionDate),sum(  productionDate ),count(distinct  productionDate ),avg(  productionDate ),max(  productionDate),min(  productionDate ),1 from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count( productionDate),sum(  productionDate ),count(distinct  productionDate ),avg(  productionDate ),max(  productionDate),min(  productionDate ),1 from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_350")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_351", Include) {
    ...
    checkAnswer(s"""select count(IMEI ),sum(IMEI ),count(distinct IMEI ),avg(IMEI ),max(IMEI ),min(IMEI ),1 from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(IMEI ),sum(IMEI ),count(distinct IMEI ),avg(IMEI ),max(IMEI ),min(IMEI ),1 from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_351")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_352", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber),count(contractNumber),avg(contractNumber),sum(contractNumber)/count(contractNumber) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(contractNumber),count(contractNumber),avg(contractNumber),sum(contractNumber)/count(contractNumber) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_352")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_353", Include) {
    ...
    checkAnswer(s"""select sum(Latest_Day),count(Latest_Day),avg(Latest_Day),sum(Latest_Day)/count(Latest_Day) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(Latest_Day),count(Latest_Day),avg(Latest_Day),sum(Latest_Day)/count(Latest_Day) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_353")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_355", Include) {
    ...
    checkAnswer(s"""select sum(deviceinformationId),count(deviceinformationId),avg(deviceinformationId),sum(deviceinformationId)/count(deviceinformationId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(deviceinformationId),count(deviceinformationId),avg(deviceinformationId),sum(deviceinformationId)/count(deviceinformationId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_355")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_356", Include) {
    ...
    checkAnswer(s"""select sum(IMEI),count(IMEI),avg(IMEI),sum(IMEI)/count(IMEI) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(IMEI),count(IMEI),avg(IMEI),sum(IMEI)/count(IMEI) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_356")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_357", Include) {
    ...
    checkAnswer(s"""select sum(productionDate),count(productionDate),avg(productionDate),sum(productionDate)/count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select sum(productionDate),count(productionDate),avg(productionDate),sum(productionDate)/count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_357")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_358", Include) {
    ...
    checkAnswer(s"""select contractNumber,Latest_DAY,gamePointId,productionDate,deviceInformationId,IMEI  from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select contractNumber,Latest_DAY,gamePointId,productionDate,deviceInformationId,IMEI  from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_358")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_359", Include) {
    ...
    checkAnswer(s"""select count(MAC) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(MAC) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_359")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_360", Include) {
    ...
    checkAnswer(s"""select count(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(gamePointId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_360")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_361", Include) {
    ...
    checkAnswer(s"""select count(contractNumber) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(contractNumber) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_361")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_362", Include) {
    ...
    checkAnswer(s"""select count(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(Latest_DAY) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_362")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_363", Include) {
    ...
    checkAnswer(s"""select count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(productionDate) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_363")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_364", Include) {
    ...
    checkAnswer(s"""select count(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE""",
      s"""select count(deviceInformationId) from Comp_VMALL_DICTIONARY_INCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_364")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_365", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  contractNumber  != '9223372047700'""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  contractNumber  != '9223372047700'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_365")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_369", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  deviceInformationId  != '100075' order by imei """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  deviceInformationId  != '100075' order by imei """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_369")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_370", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  contractNumber  not like '9223372047700' order by  deviceInformationId """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  contractNumber  not like '9223372047700' order by  deviceInformationId """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_370")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_371", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  Latest_DAY  not like '1234567890123480.0000000000' order by deviceInformationId """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  Latest_DAY  not like '1234567890123480.0000000000' order by deviceInformationId """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_371")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_372", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  gamePointId  not like '2.27852521808948E36' order by imei""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  gamePointId  not like '2.27852521808948E36' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_372")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_373", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  productionDate  not like cast('2015-09-18 12:07:28.0' as timestamp) order by deviceInformationId""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  productionDate  not like cast('2015-09-18 12:07:28.0' as timestamp) order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_373")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_374", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE where  deviceInformationId  not like '100075' order by imei """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_INCLUDE_hive where  deviceInformationId  not like '100075' order by imei """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_374")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_375", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei is not null""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_375")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_376", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId is not null""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_376")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_377", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber is not null""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_377")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_378", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY is not null""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_378")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_379", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate is not null""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_379")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_380", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId is not null""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_380")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_381", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE where imei is  null""",
      s"""select imei from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_381")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_382", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE where gamePointId is  null""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_INCLUDE_hive where gamePointId is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_382")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_383", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE where contractNumber is  null""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_INCLUDE_hive where contractNumber is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_383")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_384", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE where Latest_DAY is  null""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_INCLUDE_hive where Latest_DAY is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_384")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_385", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE where productionDate is  null""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_INCLUDE_hive where productionDate is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_385")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_386", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE where deviceInformationId is  null""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_INCLUDE_hive where deviceInformationId is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_386")
  ...
  test("Comp_VMALL_DICTIONARY_INCLUDE_387", Include) {
    ...
    checkAnswer(s"""select count(*) from Comp_VMALL_DICTIONARY_INCLUDE where imei = '1AA1'""",
      s"""select count(*) from Comp_VMALL_DICTIONARY_INCLUDE_hive where imei = '1AA1'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_INCLUDE_387")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_002", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT imei) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(DISTINCT imei) as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_002")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_003", Include) {
    ...
    checkAnswer(s"""select sum(Latest_month)+10 as a ,imei  from Comp_VMALL_DICTIONARY_EXCLUDE group by imei order by imei""",
      s"""select sum(Latest_month)+10 as a ,imei  from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by imei order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_003")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_004", Include) {
    ...
    checkAnswer(s"""select max(imei),min(imei) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(imei),min(imei) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_004")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_005", Include) {
    ...
    checkAnswer(s"""select min(imei), max(imei) Total from Comp_VMALL_DICTIONARY_EXCLUDE group by  channelsId order by Total""",
      s"""select min(imei), max(imei) Total from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_005")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_006", Include) {
    ...
    checkAnswer(s"""select last(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE  group by imei order by imei limit 1""",
      s"""select last(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  group by imei order by imei limit 1""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_006")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_008", Include) {
    ...
    checkAnswer(s"""select imei,count(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE group by imei order by imei""",
      s"""select imei,count(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by imei order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_008")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_009", Include) {
    ...
    checkAnswer(s"""select Lower(imei) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by imei""",
      s"""select Lower(imei) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_009")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_010", Include) {
    ...
    checkAnswer(s"""select distinct imei from Comp_VMALL_DICTIONARY_EXCLUDE order by imei""",
      s"""select distinct imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_010")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_011", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE order by imei limit 101 """,
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by imei limit 101 """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_011")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_012", Include) {
    ...
    checkAnswer(s"""select imei as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select imei as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_012")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_013", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where  (contractNumber == 9223372047700) and (imei=='1AA100004')""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (contractNumber == 9223372047700) and (imei=='1AA100004')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_013")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_014", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei !='1AA100064' order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei !='1AA100064' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_014")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_015", Include) {
    ...
    checkAnswer(s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_015")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_016", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei !='1AA100012' order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei !='1AA100012' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_016")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_017", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei >'1AA100012' order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei >'1AA100012' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_017")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_018", Include) {
    ...
    checkAnswer(s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE where imei<>imei""",
      s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei<>imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_018")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_019", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei != Latest_areaId order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei != Latest_areaId order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_019")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_020", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<imei order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<imei order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_020")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_021", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY<=imei order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY<=imei order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_021")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_022", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei <'1AA10002' order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei <'1AA10002' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_022")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_023", Include) {
    ...
    checkAnswer(s"""select Latest_day  from Comp_VMALL_DICTIONARY_EXCLUDE where imei IS NULL""",
      s"""select Latest_day  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei IS NULL""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_023")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_024", Include) {
    ...
    checkAnswer(s"""select Latest_day  from Comp_VMALL_DICTIONARY_EXCLUDE where imei IS NOT NULL order by imei""",
      s"""select Latest_day  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei IS NOT NULL order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_024")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_025", Include) {
    ...
    checkAnswer(s"""Select count(imei),min(imei) from Comp_VMALL_DICTIONARY_EXCLUDE """,
      s"""Select count(imei),min(imei) from Comp_VMALL_DICTIONARY_EXCLUDE_hive """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_025")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_026", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT imei,latest_day) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(DISTINCT imei,latest_day) as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_026")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_027", Include) {
    ...
    checkAnswer(s"""select max(imei),min(imei),count(imei) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(imei),min(imei),count(imei) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_027")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_028", Include) {
    ...
    checkAnswer(s"""select sum(imei),avg(imei),count(imei) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(imei),avg(imei),count(imei) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_028")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_031", Include) {
    ...
    checkAnswer(s"""select imei,count(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE group by imei order by imei""",
      s"""select imei,count(imei) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by imei order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_031")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_032", Include) {
    ...
    checkAnswer(s"""select Lower(imei),upper(imei)  a  from Comp_VMALL_DICTIONARY_EXCLUDE order by imei""",
      s"""select Lower(imei),upper(imei)  a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_032")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_033", Include) {
    ...
    checkAnswer(s"""select imei as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select imei as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_033")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_034", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where  (contractNumber == 9223372047700) and (imei=='1AA100012')""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (contractNumber == 9223372047700) and (imei=='1AA100012')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_034")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_035", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei !='8imei' order by imei""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei !='8imei' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_035")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_036", Include) {
    ...
    checkAnswer(s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select imei  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_036")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_037", Include) {
    ...
    checkAnswer(s"""Select count(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""Select count(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_037")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_038", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT contractNumber) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(DISTINCT contractNumber) as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_038")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_039", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)+10 as a ,contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE group by contractNumber""",
      s"""select sum(contractNumber)+10 as a ,contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_039")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_040", Include) {
    ...
    checkAnswer(s"""select max(contractNumber),min(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(contractNumber),min(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_040")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_041", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_041")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_042", Include) {
    ...
    checkAnswer(s"""select avg(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select avg(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_042")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_043", Include) {
    ...
    checkAnswer(s"""select min(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select min(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_043")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_045", Include) {
    ...
    checkAnswer(s"""select var_pop(contractNumber) as a from (select * from Comp_VMALL_DICTIONARY_EXCLUDE order by contractNumber) t""",
      s"""select var_pop(contractNumber) as a from (select * from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by contractNumber) t""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_045")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_046", Include) {
    ...
    checkAnswer(s"""select var_samp(contractNumber) as a from (select * from Comp_VMALL_DICTIONARY_EXCLUDE order by contractNumber) t""",
      s"""select var_samp(contractNumber) as a from (select * from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by contractNumber) t""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_046")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_051", Include) {
    ...
    checkAnswer(s"""select corr(contractNumber,contractNumber)  as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select corr(contractNumber,contractNumber)  as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_051")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_057", Include) {
    ...
    checkAnswer(s"""select contractNumber+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE order by a""",
      s"""select contractNumber+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_057")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_058", Include) {
    ...
    checkAnswer(s"""select min(contractNumber), max(contractNumber+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE group by  channelsId order by Total""",
      s"""select min(contractNumber), max(contractNumber+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_058")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_060", Include) {
    ...
    checkAnswer(s"""select FIRST(contractNumber) a from Comp_VMALL_DICTIONARY_EXCLUDE order by a""",
      s"""select FIRST(contractNumber) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_060")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_061", Include) {
    ...
    checkAnswer(s"""select contractNumber,count(contractNumber) a from Comp_VMALL_DICTIONARY_EXCLUDE group by contractNumber order by contractNumber""",
      s"""select contractNumber,count(contractNumber) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_061")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_062", Include) {
    ...
    checkAnswer(s"""select Lower(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by contractNumber""",
      s"""select Lower(contractNumber) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_062")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_063", Include) {
    ...
    checkAnswer(s"""select distinct contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE order by contractNumber""",
      s"""select distinct contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_063")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_064", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE order by contractNumber limit 101""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by contractNumber limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_064")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_065", Include) {
    ...
    checkAnswer(s"""select contractNumber as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select contractNumber as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_065")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_066", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where  (contractNumber == 9223372047700) and (imei=='1AA100012')""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (contractNumber == 9223372047700) and (imei=='1AA100012')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_066")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_067", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber !=9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber !=9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_067")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_068", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color') order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color') order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_068")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_069", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber !=9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber !=9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_069")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_070", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber >9223372047700 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber >9223372047700 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_070")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_071", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber<>contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber<>contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_071")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_072", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber != Latest_areaId order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber != Latest_areaId order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_072")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_073", Include) {
    ...
    checkAnswer(s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<contractNumber order by contractNumber""",
      s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_073")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_074", Include) {
    ...
    checkAnswer(s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY<=contractNumber order by contractNumber""",
      s"""select contractNumber, contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY<=contractNumber order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_074")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_075", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber <1000 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber <1000 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_075")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_076", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber >1000 order by contractNumber""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber >1000 order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_076")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_077", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber IS NULL order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber IS NULL order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_077")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_078", Include) {
    ...
    checkAnswer(s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY IS NOT NULL order by contractNumber""",
      s"""select contractNumber  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY IS NOT NULL order by contractNumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_078")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_080", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT Latest_DAY) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(DISTINCT Latest_DAY) as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_080")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_081", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)+10 as a ,Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE group by Latest_DAY order by a""",
      s"""select sum(Latest_DAY)+10 as a ,Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by Latest_DAY order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_081")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_082", Include) {
    ...
    checkAnswer(s"""select max(Latest_DAY),min(Latest_DAY) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(Latest_DAY),min(Latest_DAY) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_082")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_083", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_083")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_084", Include) {
    ...
    checkAnswer(s"""select avg(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select avg(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_084")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_099", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE order by a""",
      s"""select Latest_DAY, Latest_DAY+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_099")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_100", Include) {
    ...
    checkAnswer(s"""select min(Latest_DAY), max(Latest_DAY+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE group by  channelsId order by Total""",
      s"""select min(Latest_DAY), max(Latest_DAY+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_100")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_103", Include) {
    ...
    checkAnswer(s"""select Latest_DAY,count(Latest_DAY) a from Comp_VMALL_DICTIONARY_EXCLUDE group by Latest_DAY order by Latest_DAY""",
      s"""select Latest_DAY,count(Latest_DAY) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by Latest_DAY order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_103")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_104", Include) {
    ...
    checkAnswer(s"""select Lower(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by a""",
      s"""select Lower(Latest_DAY) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_104")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_105", Include) {
    ...
    checkAnswer(s"""select distinct Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE order by Latest_DAY""",
      s"""select distinct Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_105")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_106", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE order by Latest_DAY limit 101""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by Latest_DAY limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_106")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_107", Include) {
    ...
    checkAnswer(s"""select Latest_DAY as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select Latest_DAY as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_107")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_108", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where  (Latest_DAY == 1234567890123450.0000000000)  and (imei=='1AA1')""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (Latest_DAY == 1234567890123450.0000000000)  and (imei=='1AA1')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_108")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_109", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_109")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_110", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_110")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_111", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY !=1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_111")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_112", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY >1234567890123450.0000000000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY >1234567890123450.0000000000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_112")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_113", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY<>Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY<>Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_113")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_114", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY != Latest_areaId order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY != Latest_areaId order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_114")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_115", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<Latest_DAY order by Latest_DAY""",
      s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<Latest_DAY order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_115")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_116", Include) {
    ...
    checkAnswer(s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY<=Latest_DAY  order by Latest_DAY""",
      s"""select Latest_DAY, Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY<=Latest_DAY  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_116")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_117", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY <1000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY <1000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_117")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_118", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY >1000  order by Latest_DAY""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY >1000  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_118")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_119", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY IS NULL  order by Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY IS NULL  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_119")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_120", Include) {
    ...
    checkAnswer(s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY IS NOT NULL  order by Latest_DAY""",
      s"""select Latest_DAY  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY IS NOT NULL  order by Latest_DAY""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_120")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_122", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT gamePointId) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_124", Include) {
    ...
    checkAnswer(s"""select max(gamePointId),min(gamePointId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(gamePointId),min(gamePointId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_124")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_127", Include) {
    ...
    checkAnswer(s"""select min(gamePointId) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select min(gamePointId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_127")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_135", Include) {
    ...
    checkAnswer(s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select corr(gamePointId,gamePointId)  as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_135")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_141", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE order by a""",
      s"""select gamePointId, gamePointId+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by a""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_141")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_142", Include) {
    ...
    checkAnswer(s"""select min(gamePointId), max(gamePointId+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE group by  channelsId order by Total""",
      s"""select min(gamePointId), max(gamePointId+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_142")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_145", Include) {
    ...
    checkAnswer(s"""select gamePointId,count(gamePointId) a from Comp_VMALL_DICTIONARY_EXCLUDE group by gamePointId order by gamePointId""",
      s"""select gamePointId,count(gamePointId) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by gamePointId order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_145")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_146", Include) {
    ...
    checkAnswer(s"""select Lower(gamePointId) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by gamePointId""",
      s"""select Lower(gamePointId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_146")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_147", Include) {
    ...
    checkAnswer(s"""select distinct gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE order by gamePointId""",
      s"""select distinct gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_147")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_148", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE  order by gamePointId limit 101""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by gamePointId limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_148")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_149", Include) {
    ...
    checkAnswer(s"""select gamePointId as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select gamePointId as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_149")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_150", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where  (gamePointId == 4.70133553923674E43) and (imei=='1AA100084')""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (gamePointId == 4.70133553923674E43) and (imei=='1AA100084')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_150")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_151", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId !=4.70133553923674E43  order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId !=4.70133553923674E43  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_151")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_152", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_152")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_153", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId !=4.70133553923674E43""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId !=4.70133553923674E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_153")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_154", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId >4.70133553923674E43""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId >4.70133553923674E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_154")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_155", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId<>gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId<>gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_155")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_156", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId != Latest_areaId  order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId != Latest_areaId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_156")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_157", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<gamePointId  order by gamePointId""",
      s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<gamePointId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_157")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_158", Include) {
    ...
    checkAnswer(s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId<=gamePointId  order by gamePointId""",
      s"""select gamePointId, gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId<=gamePointId  order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_158")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_159", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId <1000 order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId <1000 order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_159")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_160", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId >1000 order by gamePointId""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId >1000 order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_160")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_161", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId IS NULL order by gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId IS NULL order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_161")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_162", Include) {
    ...
    checkAnswer(s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId IS NOT NULL order by gamePointId""",
      s"""select gamePointId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId IS NOT NULL order by gamePointId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_162")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_163", Include) {
    ...
    checkAnswer(s"""Select count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""Select count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_163")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_165", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)+10 as a ,productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE group by productionDate order by productionDate""",
      s"""select sum(productionDate)+10 as a ,productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_165")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_166", Include) {
    ...
    checkAnswer(s"""select max(productionDate),min(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(productionDate),min(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_166")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_167", Include) {
    ...
    checkAnswer(s"""select sum(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_167")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_169", Include) {
    ...
    checkAnswer(s"""select min(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select min(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_169")

  }


  //Comp_VMALL_DICTIONARY_EXCLUDE_170
  test("Comp_VMALL_DICTIONARY_EXCLUDE_170", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_171
  test("Comp_VMALL_DICTIONARY_EXCLUDE_171", Include) {

    sql(s"""select var_pop(gamePointId)  as a from Comp_VMALL_DICTIONARY_EXCLUDE""").collect

  }


  //Comp_VMALL_DICTIONARY_EXCLUDE_172
  test("Comp_VMALL_DICTIONARY_EXCLUDE_172", Include) {

    sql(s"""select var_samp(gamePointId) as a  from Comp_VMALL_DICTIONARY_EXCLUDE""").collect

  }


  //Comp_VMALL_DICTIONARY_EXCLUDE_173
  test("Comp_VMALL_DICTIONARY_EXCLUDE_173", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_174
  test("Comp_VMALL_DICTIONARY_EXCLUDE_174", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_175
  test("Comp_VMALL_DICTIONARY_EXCLUDE_175", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_176
  test("Comp_VMALL_DICTIONARY_EXCLUDE_176", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_177
  test("Comp_VMALL_DICTIONARY_EXCLUDE_177", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_178
  test("Comp_VMALL_DICTIONARY_EXCLUDE_178", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_179
  test("Comp_VMALL_DICTIONARY_EXCLUDE_179", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_180
  test("Comp_VMALL_DICTIONARY_EXCLUDE_180", Include) {
  ...
  //Comp_VMALL_DICTIONARY_EXCLUDE_181
  test("Comp_VMALL_DICTIONARY_EXCLUDE_181", Include) {
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_183", Include) {
    ...
    sql(s"""select last(productionDate) a from Comp_VMALL_DICTIONARY_EXCLUDE order by a""").collect
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_185", Include) {
    ...
    checkAnswer(s"""select productionDate,count(productionDate) a from Comp_VMALL_DICTIONARY_EXCLUDE group by productionDate order by productionDate""",
      s"""select productionDate,count(productionDate) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_185")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_186", Include) {
    ...
    checkAnswer(s"""select Lower(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by productionDate""",
      s"""select Lower(productionDate) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_186")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_187", Include) {
    ...
    checkAnswer(s"""select distinct productionDate from Comp_VMALL_DICTIONARY_EXCLUDE order by productionDate""",
      s"""select distinct productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_187")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_188", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE order by productionDate limit 101""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by productionDate limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_188")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_189", Include) {
    ...
    checkAnswer(s"""select productionDate as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select productionDate as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_189")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_190", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where  (productionDate == '2015-07-01 12:07:28.0') and (productionDate=='2015-07-01 12:07:28.0')""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (productionDate == '2015-07-01 12:07:28.0') and (productionDate=='2015-07-01 12:07:28.0')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_190")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_191", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate !='2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate !='2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_191")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_192", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_192")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_193", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate !='2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate !='2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_193")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_194", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate >'2015-07-01 12:07:28.0' order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate >'2015-07-01 12:07:28.0' order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_194")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_195", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate<>productionDate order by productionDate""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate<>productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_195")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_196", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate != Latest_areaId order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate != Latest_areaId order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_196")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_197", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<productionDate order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_197")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_198", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate<=productionDate order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate<=productionDate order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_198")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_199", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate <cast('2015-07-01 12:07:28.0' as timestamp) order by productionDate""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate <cast('2015-07-01 12:07:28.0' as timestamp) order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_199")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_200", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate IS NULL""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate IS NULL""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_200")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_201", Include) {
    ...
    checkAnswer(s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate IS NOT NULL order by productionDate""",
      s"""select productionDate  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate IS NOT NULL order by productionDate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_201")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_202", Include) {
    ...
    checkAnswer(s"""Select count(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""Select count(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_202")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_203", Include) {
    ...
    checkAnswer(s"""select count(DISTINCT deviceInformationId) as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(DISTINCT deviceInformationId) as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_203")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_204", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)+10 as a ,deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE group by deviceInformationId order by deviceInformationId""",
      s"""select sum(deviceInformationId)+10 as a ,deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_204")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_205", Include) {
    ...
    checkAnswer(s"""select max(deviceInformationId),min(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select max(deviceInformationId),min(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_205")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_206", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_206")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_207", Include) {
    ...
    checkAnswer(s"""select avg(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select avg(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_207")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_208", Include) {
    ...
    checkAnswer(s"""select min(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select min(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_208")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_216", Include) {
    ...
    checkAnswer(s"""select corr(deviceInformationId,deviceInformationId)  as a from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select corr(deviceInformationId,deviceInformationId)  as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_216")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_222", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId+ 10 as a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_222")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_223", Include) {
    ...
    checkAnswer(s"""select min(deviceInformationId), max(deviceInformationId+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE group by  channelsId order by Total""",
      s"""select min(deviceInformationId), max(deviceInformationId+ 10) Total from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by  channelsId order by Total""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_223")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_226", Include) {
    ...
    checkAnswer(s"""select deviceInformationId,count(deviceInformationId) a from Comp_VMALL_DICTIONARY_EXCLUDE group by deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId,count(deviceInformationId) a from Comp_VMALL_DICTIONARY_EXCLUDE_hive group by deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_226")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_227", Include) {
    ...
    checkAnswer(s"""select Lower(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE order by deviceInformationId""",
      s"""select Lower(deviceInformationId) a  from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_227")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_228", Include) {
    ...
    checkAnswer(s"""select distinct deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE order by deviceInformationId""",
      s"""select distinct deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_228")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_229", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE order by deviceInformationId limit 101""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive order by deviceInformationId limit 101""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_229")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_230", Include) {
    ...
    checkAnswer(s"""select deviceInformationId as a from Comp_VMALL_DICTIONARY_EXCLUDE  order by a asc limit 10""",
      s"""select deviceInformationId as a from Comp_VMALL_DICTIONARY_EXCLUDE_hive  order by a asc limit 10""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_230")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_231", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where  (deviceInformationId == 100084) and (deviceInformationId==100084)""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  (deviceInformationId == 100084) and (deviceInformationId==100084)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_231")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_232", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId !='100084' order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId !='100084' order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_232")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_233", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_233")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_234", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId !=100084 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId !=100084 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_234")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_235", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId >'100084' order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId >'100084' order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_235")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_236", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId<>deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId<>deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_236")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_237", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId != Latest_areaId order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId != Latest_areaId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_237")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_238", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_areaId<deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_areaId<deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_238")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_239", Include) {
    ...
    checkAnswer(s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId<=deviceInformationId order by deviceInformationId""",
      s"""select deviceInformationId, deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId<=deviceInformationId order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_239")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_240", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId <1000 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId <1000 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_240")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_241", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId >1000 order by deviceInformationId""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId >1000 order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_241")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_242", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId IS NULL order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId IS NULL order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_242")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_243", Include) {
    ...
    checkAnswer(s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId IS NOT NULL order by deviceInformationId""",
      s"""select deviceInformationId  from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId IS NOT NULL order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_243")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_244", Include) {
    ...
    checkAnswer(s"""select sum(imei)+10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(imei)+10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_244")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_245", Include) {
    ...
    checkAnswer(s"""select sum(imei)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(imei)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_245")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_246", Include) {
    ...
    checkAnswer(s"""select sum(imei)/10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(imei)/10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_246")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_247", Include) {
    ...
    checkAnswer(s"""select sum(imei)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(imei)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_247")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_249", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(contractNumber)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_249")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_253", Include) {
    ...
    checkAnswer(s"""select sum(Latest_DAY)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(Latest_DAY)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_253")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_261", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(productionDate)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_261")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_262", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)/10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(productionDate)/10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_262")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_263", Include) {
    ...
    checkAnswer(s"""select sum(productionDate)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(productionDate)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_263")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_264", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)+10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(deviceInformationId)+10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_264")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_265", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(deviceInformationId)*10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_265")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_267", Include) {
    ...
    checkAnswer(s"""select sum(deviceInformationId)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(deviceInformationId)-10 as a   from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_267")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_292", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate LIKE '2015-09-30%'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate LIKE '2015-09-30%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_292")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_293", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate LIKE '% %'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate LIKE '% %'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_293")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_294", Include) {
    ...
    checkAnswer(s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate LIKE '%12:07:28'""",
      s"""SELECT productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate LIKE '%12:07:28'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_294")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_295", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractnumber like '922337204%' """,
      s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractnumber like '922337204%' """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_295")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_296", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractnumber like '%047800'""",
      s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractnumber like '%047800'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_296")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_297", Include) {
    ...
    checkAnswer(s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractnumber like '%720%'""",
      s"""select contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractnumber like '%720%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_297")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_298", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY like '12345678%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY like '12345678%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_298")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_299", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY like '%5678%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY like '%5678%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_299")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_300", Include) {
    ...
    checkAnswer(s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY like '1234567%'""",
      s"""SELECT Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY like '1234567%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_300")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_301", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointID like '1.1098347722%'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointID like '1.1098347722%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_301")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_302", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointID like '%8347722%'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointID like '%8347722%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_302")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_303", Include) {
    ...
    checkAnswer(s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointID like '%7512E42'""",
      s"""SELECT gamepointID from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointID like '%7512E42'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_303")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_304", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid like '1000%'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid like '1000%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_304")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_305", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid like '%00%'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid like '%00%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_305")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_306", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid like '%0084'""",
      s"""SELECT deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid like '%0084'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_306")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_307", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei like '1AA10%'""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei like '1AA10%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_307")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_308", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei like '%A10%'""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei like '%A10%'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_308")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_309", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei like '%00084'""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei like '%00084'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_309")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_310", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei in ('1AA100074','1AA100075','1AA100077')""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei in ('1AA100074','1AA100075','1AA100077')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_310")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_311", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei not in ('1AA100074','1AA100075','1AA100077')""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei not in ('1AA100074','1AA100075','1AA100077')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_311")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_312", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid in (100081,100078,10008)""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid in (100081,100078,10008)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_312")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_313", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid not in (100081,100078,10008)""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid not in (100081,100078,10008)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_313")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_314", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate in ('2015-10-04 12:07:28','2015-10-07%','2015-10-07 12:07:28')""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate in ('2015-10-04 12:07:28','2015-10-07%','2015-10-07 12:07:28')""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_314")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_315", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate not in (cast('2015-10-04 12:07:28' as timestamp),cast('2015-10-07 12:07:28' as timestamp))""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate not in (cast('2015-10-04 12:07:28' as timestamp),cast('2015-10-07 12:07:28' as timestamp))""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_315")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_316", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointid in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointid in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_316")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_317", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointid not in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointid not in (5.02870412391492E39,3.82247669125491E41,6.8591561117512E42)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_317")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_318", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY in (1234567890123530.0000000000,1234567890123520.0000000000)""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY in (1234567890123530.0000000000,1234567890123520.0000000000)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_318")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_319", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY not in (1234567890123530.0000000000,1234567890123520.0000000000)""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY not in (1234567890123530.0000000000,1234567890123520.0000000000)""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_319")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_322", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei !='1AA100077'""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei !='1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_322")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_323", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei NOT LIKE '1AA100077'""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei NOT LIKE '1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_323")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_324", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid !=100078""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid !=100078""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_324")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_325", Include) {
    ...
    checkAnswer(s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationid NOT LIKE 100079""",
      s"""select deviceinformationid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationid NOT LIKE 100079""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_325")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_326", Include) {
    ...
    checkAnswer(s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE where productiondate !='2015-10-07 12:07:28'""",
      s"""select productiondate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productiondate !='2015-10-07 12:07:28'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_326")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_328", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointid !=6.8591561117512E42""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointid !=6.8591561117512E42""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_328")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_329", Include) {
    ...
    checkAnswer(s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointid NOT LIKE 6.8591561117512E43""",
      s"""select gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointid NOT LIKE 6.8591561117512E43""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_329")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_330", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY != 1234567890123520.0000000000""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY != 1234567890123520.0000000000""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_330")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_331", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY NOT LIKE 1234567890123520.0000000000""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY NOT LIKE 1234567890123520.0000000000""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_331")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_335", Include) {
    ...
    checkAnswer(s"""SELECT productiondate,IMEI from Comp_VMALL_DICTIONARY_EXCLUDE where IMEI RLIKE '1AA100077'""",
      s"""SELECT productiondate,IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive where IMEI RLIKE '1AA100077'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_335")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_336", Include) {
    ...
    checkAnswer(s"""SELECT deviceinformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceinformationId RLIKE '100079'""",
      s"""SELECT deviceinformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceinformationId RLIKE '100079'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_336")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_337", Include) {
    ...
    checkAnswer(s"""SELECT gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE where gamepointid RLIKE '1.61922711065643E42'""",
      s"""SELECT gamepointid from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamepointid RLIKE '1.61922711065643E42'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_337")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_338", Include) {
    ...
    checkAnswer(s"""SELECT Latest_Day from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_Day RLIKE '1234567890123550.0000000000'""",
      s"""SELECT Latest_Day from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_Day RLIKE '1234567890123550.0000000000'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_338")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_339", Include) {
    ...
    checkAnswer(s"""SELECT contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractnumber RLIKE '9223372047800'""",
      s"""SELECT contractnumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractnumber RLIKE '9223372047800'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_339")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_340", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.productiondate=b.productiondate""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.productiondate=b.productiondate""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_340")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_341", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.deviceinformationid=b.deviceinformationid""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.deviceinformationid=b.deviceinformationid""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_341")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_342", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.imei=b.imei""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.imei=b.imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_342")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_343", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.gamepointid=b.gamepointid""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.gamepointid=b.gamepointid""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_343")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_344", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.Latest_Day=b.Latest_Day""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.Latest_Day=b.Latest_Day""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_344")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_345", Include) {
    ...
    checkAnswer(s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE a join Comp_VMALL_DICTIONARY_EXCLUDE b on a.contractnumber=b.contractnumber""",
      s"""select  b.contractNumber,b.Latest_DAY,b.gamePointId,b.productionDate,b.deviceInformationId,b.IMEI from Comp_VMALL_DICTIONARY_EXCLUDE_hive a join Comp_VMALL_DICTIONARY_EXCLUDE_hive b on a.contractnumber=b.contractnumber""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_345")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_346", Include) {
    ...
    checkAnswer(s"""select count( contractNumber ),sum( contractNumber ),count(distinct contractNumber ),avg( contractNumber ),max( contractNumber ),min( contractNumber ),1 from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count( contractNumber ),sum( contractNumber ),count(distinct contractNumber ),avg( contractNumber ),max( contractNumber ),min( contractNumber ),1 from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_346")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_347", Include) {
    ...
    checkAnswer(s"""select count( Latest_Day ),sum( Latest_Day ),count(distinct Latest_Day ),avg( Latest_Day ),max( Latest_Day ),min( Latest_Day ),1 from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count( Latest_Day ),sum( Latest_Day ),count(distinct Latest_Day ),avg( Latest_Day ),max( Latest_Day ),min( Latest_Day ),1 from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_347")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_349", Include) {
    ...
    checkAnswer(s"""select count(deviceInformationId),sum(deviceInformationId),count(deviceInformationId),avg(deviceInformationId),max(deviceInformationId),min(deviceInformationId),1 from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(deviceInformationId),sum(deviceInformationId),count(deviceInformationId),avg(deviceInformationId),max(deviceInformationId),min(deviceInformationId),1 from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_349")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_350", Include) {
    ...
    checkAnswer(s"""select count( productionDate),sum(  productionDate ),count(distinct  productionDate ),avg(  productionDate ),max(  productionDate),min(  productionDate ),1 from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count( productionDate),sum(  productionDate ),count(distinct  productionDate ),avg(  productionDate ),max(  productionDate),min(  productionDate ),1 from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_350")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_352", Include) {
    ...
    checkAnswer(s"""select sum(contractNumber),count(contractNumber),avg(contractNumber),sum(contractNumber)/count(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(contractNumber),count(contractNumber),avg(contractNumber),sum(contractNumber)/count(contractNumber) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_352")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_353", Include) {
    ...
    checkAnswer(s"""select sum(Latest_Day),count(Latest_Day),avg(Latest_Day),sum(Latest_Day)/count(Latest_Day) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(Latest_Day),count(Latest_Day),avg(Latest_Day),sum(Latest_Day)/count(Latest_Day) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_353")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_355", Include) {
    ...
    checkAnswer(s"""select sum(deviceinformationId),count(deviceinformationId),avg(deviceinformationId),sum(deviceinformationId)/count(deviceinformationId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(deviceinformationId),count(deviceinformationId),avg(deviceinformationId),sum(deviceinformationId)/count(deviceinformationId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_355")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_357", Include) {
    ...
    checkAnswer(s"""select sum(productionDate),count(productionDate),avg(productionDate),sum(productionDate)/count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select sum(productionDate),count(productionDate),avg(productionDate),sum(productionDate)/count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_357")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_358", Include) {
    ...
    checkAnswer(s"""select contractNumber,Latest_DAY,gamePointId,productionDate,deviceInformationId,IMEI  from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select contractNumber,Latest_DAY,gamePointId,productionDate,deviceInformationId,IMEI  from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_358")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_359", Include) {
    ...
    checkAnswer(s"""select count(MAC) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(MAC) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_359")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_360", Include) {
    ...
    checkAnswer(s"""select count(gamePointId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(gamePointId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_360")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_362", Include) {
    ...
    checkAnswer(s"""select count(Latest_DAY) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(Latest_DAY) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_362")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_363", Include) {
    ...
    checkAnswer(s"""select count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(productionDate) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_363")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_364", Include) {
    ...
    checkAnswer(s"""select count(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE""",
      s"""select count(deviceInformationId) from Comp_VMALL_DICTIONARY_EXCLUDE_hive""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_364")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_365", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  contractNumber  != '9223372047700'""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  contractNumber  != '9223372047700'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_365")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_366", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  Latest_DAY  != '1234567890123480.0000000000' order by deviceInformationId """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  Latest_DAY  != '1234567890123480.0000000000' order by deviceInformationId """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_366")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_367", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  gamePointId  != '2.27852521808948E36' order by imei """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  gamePointId  != '2.27852521808948E36' order by imei """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_367")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_368", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  productionDate  != '2015-09-18 12:07:28.0' order by imei""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  productionDate  != '2015-09-18 12:07:28.0' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_368")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_369", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  deviceInformationId  != '100075' order by imei """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  deviceInformationId  != '100075' order by imei """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_369")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_370", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  contractNumber  not like '9223372047700' order by  deviceInformationId """,
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  contractNumber  not like '9223372047700' order by  deviceInformationId """, "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_370")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_371", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  Latest_DAY  not like '1234567890123480.0000000000' order by deviceInformationId""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  Latest_DAY  not like '1234567890123480.0000000000' order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_371")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_372", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  gamePointId  not like '2.27852521808948E36' order by imei""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  gamePointId  not like '2.27852521808948E36' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_372")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_373", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  productionDate  not like cast('2015-09-18 12:07:28.0' as timestamp) order by deviceInformationId""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  productionDate  not like cast('2015-09-18 12:07:28.0' as timestamp) order by deviceInformationId""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_373")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_374", Include) {
    ...
    checkAnswer(s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE where  deviceInformationId  not like '100075' order by imei""",
      s"""select imei,deviceInformationId,MAC,deviceColor from Comp_VMALL_DICTIONARY_EXCLUDE_hive where  deviceInformationId  not like '100075' order by imei""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_374")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_375", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei is not null""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_375")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_376", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId is not null""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_376")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_377", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber is not null""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_377")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_378", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY is not null""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_378")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_379", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate is not null""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_379")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_380", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId is not null""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId is not null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_380")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_381", Include) {
    ...
    checkAnswer(s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE where imei is  null""",
      s"""select imei from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_381")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_382", Include) {
    ...
    checkAnswer(s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE where gamePointId is  null""",
      s"""select gamePointId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where gamePointId is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_382")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_383", Include) {
    ...
    checkAnswer(s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE where contractNumber is  null""",
      s"""select contractNumber from Comp_VMALL_DICTIONARY_EXCLUDE_hive where contractNumber is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_383")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_384", Include) {
    ...
    checkAnswer(s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE where Latest_DAY is  null""",
      s"""select Latest_DAY from Comp_VMALL_DICTIONARY_EXCLUDE_hive where Latest_DAY is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_384")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_385", Include) {
    ...
    checkAnswer(s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE where productionDate is  null""",
      s"""select productionDate from Comp_VMALL_DICTIONARY_EXCLUDE_hive where productionDate is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_385")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_386", Include) {
    ...
    checkAnswer(s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE where deviceInformationId is  null""",
      s"""select deviceInformationId from Comp_VMALL_DICTIONARY_EXCLUDE_hive where deviceInformationId is  null""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_386")
  ...
  test("Comp_VMALL_DICTIONARY_EXCLUDE_387", Include) {
    ...
    checkAnswer(s"""select count(*) from Comp_VMALL_DICTIONARY_EXCLUDE where imei = '1AA1'""",
      s"""select count(*) from Comp_VMALL_DICTIONARY_EXCLUDE_hive where imei = '1AA1'""", "QueriesCompactionTestCase_Comp_VMALL_DICTIONARY_EXCLUDE_387")
