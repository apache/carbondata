...
class SortColumnTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC001", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable1 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC002", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable2 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC003", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable3 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC004", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_offheap_safe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC005", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_offheap_unsafe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC006", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_offheap_inmemory OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC007", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_heap_safe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC008", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_heap_unsafe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC009", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable4_heap_inmemory OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC010", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE origintable2 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE origintable2 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE origintable2 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE origintable2 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable5 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable5 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable5 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable5 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC011", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable6 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC014", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE unsortedtable_heap_safe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC016", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE unsortedtable_heap_unsafe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC018", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE unsortedtable_offheap_safe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC020", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE unsortedtable_offheap_unsafe OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC022", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE unsortedtable_offheap_inmemory OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC024", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/newdata.csv' INTO TABLE sorttable OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC027", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/dataString.csv' INTO TABLE sorttable OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
    sql(s"""select doj from sorttable""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC028", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/dataInt.csv' INTO TABLE sorttable OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
    sql(s"""select doj from sorttable""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC035", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/dataDrop.csv' INTO TABLE sorttable OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC037", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/dataFloat.csv' INTO TABLE sorttable1 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
    sql(s"""select * from sorttable""").collect
  ...
  test("AR-Develop-Feature-sortcolumn-001_PTS001_TC038", Include) {
   ...
   sql(s"""LOAD DATA local inpath '$resourcesPath/Data/dataDecimal.csv' INTO TABLE sorttable1 OPTIONS('DELIMITER'= ',', 'QUOTECHAR'= '\"')""").collect
    sql(s"""select * from sorttable""").collect
