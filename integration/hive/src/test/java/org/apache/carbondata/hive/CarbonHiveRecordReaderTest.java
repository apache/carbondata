...
public class CarbonHiveRecordReaderTest {
  ...
  private static CarbonReadSupport<ArrayWritable> readSupport =
  ...
  @BeforeClass public static void setUp() throws Exception {
    ...
    Path mockPath = new Path(
        "carbondata/integration/hive/target/store/database/Fact/Part0/Segment_0/part-0-0_batchno0-0-1502197243476.carbondata");
    inputSplitInstanceOfHiveInputSplit =
        new CarbonHiveInputSplit("20", mockPath, 1235L, 235L, array, columnarFormatVersion);
    ...
    queryModel.setAbsoluteTableIdentifier(mockAbsoluteTableIdentifier);
    ...
    new MockUp<DetailQueryExecutor>() {
      @Mock public CarbonIterator<BatchResult> execute(QueryModel queryModel)
          throws QueryExecutionException, IOException {
        return carbonIteratorObject;
      }
    };
    new MockUp<DetailQueryResultIterator>() {
      @Mock private BatchResult getBatchResult() {
        return batchResult;
      }
    };

    new MockUp<CarbonDictionaryDecodeReadSupport>() {
      @Mock public Object readRow(Object[] data) {
  ...
  @Test(expected = RuntimeException.class) public void testUnsupportedInputSplitTypeException()
      throws IOException {
  ...
  @Test(expected = IOException.class) public void testQueryExecutionException() throws IOException {
  ...
  @Test public void testNullColumnProperty() throws IOException {
  ...
  @Test public void testNextNullColumnId() throws IOException {
  ...
  @Test public void testNextFalseCase() throws IOException {
  ...
  @Test public void testCreateKey() throws IOException {
    carbonHiveRecordReaderObj =
        new CarbonHiveRecordReader(queryModel, readSupport, inputSplitInstanceOfHiveInputSplit,
            jobConf);
  ...
  @Test public void testCreateValue() throws IOException {
    carbonHiveRecordReaderObj =
        new CarbonHiveRecordReader(queryModel, readSupport, inputSplitInstanceOfHiveInputSplit,
            jobConf);
  ...
  @Test public void testGetPos() throws IOException {
    carbonHiveRecordReaderObj =
        new CarbonHiveRecordReader(queryModel, readSupport, inputSplitInstanceOfHiveInputSplit,
            jobConf);
  ...
  @Test public void testGetProgress() throws IOException {
    carbonHiveRecordReaderObj =
        new CarbonHiveRecordReader(queryModel, readSupport, inputSplitInstanceOfHiveInputSplit,
            jobConf);
