...
public class TestCarbonSerde extends TestCase {
    ...
    private void deserializeAndSerializeLazySimple(final CarbonHiveSerDe serDe, final ArrayWritable t) throws SerDeException {
    ...
    private Properties createProperties() {
        ...
        tbl.setProperty("columns.types",
            "smallint:int:bigint:double:decimal:string:array<string>");
